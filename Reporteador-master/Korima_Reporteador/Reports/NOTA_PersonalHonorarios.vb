...
Public Class NOTA_PersonalHonorarios
    ...
    Private Sub lbl_Nota4_EvaluateBinding(sender As System.Object, e As DevExpress.XtraReports.UI.BindingEventArgs) Handles lbl_Nota4.EvaluateBinding
        If (MdluserCtrl Is Nothing) Then
            Exit Sub
        End If
        If e.Value.ToString.Contains("Click") Then
    ...
    Private Sub lbl_Nota4_PreviewClick(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs) Handles lbl_Nota4.PreviewClick
        If isOpenNotes Then
            Exit Sub
        End If
