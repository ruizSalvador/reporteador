...
Public Class NOTA_ESF_BMII_BMI
    ...
    Private Sub XrLabel18_EvaluateBinding(sender As System.Object, e As DevExpress.XtraReports.UI.BindingEventArgs) Handles XrLabel18.EvaluateBinding
        If (MdluserCtrl Is Nothing) Then
            Exit Sub
        End If
        If e.Value.ToString.Contains("Click") Then
    ...
    Private Sub XrLabel18_PreviewClick(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs) Handles XrLabel18.PreviewClick
        If isOpenNotes Then
            Exit Sub
        End If
    ...
    Private Sub XrLabel24_EvaluateBinding(sender As System.Object, e As DevExpress.XtraReports.UI.BindingEventArgs) Handles lbl_prmFecha.EvaluateBinding
        If (MdluserCtrl Is Nothing) Then
            Exit Sub
        End If
        If e.Value.ToString.Contains("Click") Then
    ...
    Private Sub lbl_prmFecha_PreviewClick(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs) Handles lbl_prmFecha.PreviewClick
        If isOpenNotes Then
            Exit Sub
        End If
