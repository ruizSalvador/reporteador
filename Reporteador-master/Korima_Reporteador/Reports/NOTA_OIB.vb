...
Public Class NOTA_OIB

    Private Sub lbl_Notas_PreviewClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.PreviewMouseEventArgs) Handles lbl_Notas.PreviewClick
        If isOpenNotes Then
            Exit Sub
        End If
    ...
    Private Sub lbl_Notas_EvaluateBinding(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.BindingEventArgs) Handles lbl_Notas.EvaluateBinding
