...
Partial Public Class RPT_EstadoEjercicio_PresupuestoDetallado
    ...
    Private Sub InitializeComponent()
        ...
        Me.XrLabel12.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_EstadoEjercicio_PresupuestoEgresosDetallado.Concepto")})
    ...
    "'  "
        ...
        '
        'RPT_EstadoEjercicio_PresupuestoDetallado
        '
