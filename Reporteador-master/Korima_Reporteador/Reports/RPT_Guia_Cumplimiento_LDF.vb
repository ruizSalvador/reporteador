...
Public Class RPT_Guia_Cumplimiento_LDF
...
#End Region
    ...
    Private Sub lbl_prmTipo_PreviewMouseMove(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        MdluserCtrl.Cursor = Cursors.Hand
    End Sub

    Private Sub lbl_prmTipo_PreviewClick_1(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        If isOpenNotes Then
            Exit Sub
        End If
    ...
    Private Sub lbl_prmNaturaleza_PreviewMouseMove(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        MdluserCtrl.Cursor = Cursors.Hand
    End Sub

    Private Sub lbl_prmNaturaleza_PreviewClick_1(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        If isOpenNotes Then
            Exit Sub
        End If
    ...
    Private Sub lbl_XrLabel18_PreviewMouseMove(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        MdluserCtrl.Cursor = Cursors.Hand
    End Sub

    Private Sub lbl_XrLabel18_PreviewClick(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        If isOpenNotes Then
            Exit Sub
        End If
    ...
    Private Sub XrLabel19_PreviewMouseMove(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        MdluserCtrl.Cursor = Cursors.Hand
    End Sub

    Private Sub XrLabel19_PreviewClick(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        If isOpenNotes Then
            Exit Sub
        End If
    ...
    Private Sub XrLabel20_PreviewMouseMove(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        MdluserCtrl.Cursor = Cursors.Hand
    End Sub

    Private Sub XrLabel20_PreviewClick(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        If isOpenNotes Then
            Exit Sub
        End If
    ...
    Private Sub XrLabel21_PreviewMouseMove(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        MdluserCtrl.Cursor = Cursors.Hand
    End Sub

    Private Sub XrLabel21_PreviewClick(sender As System.Object, e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        If isOpenNotes Then
            Exit Sub
        End If
