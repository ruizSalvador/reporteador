...
Public Class NOTA_if_fideicomisos

    Private Sub XrLabel2_PreviewClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
        If isOpenNotes Then
            Exit Sub
        End If
    ...
    Private Sub XrLabel2_EvaluateBinding(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.BindingEventArgs)
    ...
    Private Sub XrLabel2_EvaluateBinding_1(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.BindingEventArgs) Handles XrLabel2.EvaluateBinding
        If (MdluserCtrl Is Nothing) Then
            Exit Sub
        End If
        If e.Value.ToString.Contains("Click") Then
    ...
    Private Sub XrLabel2_PreviewClick_1(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.PreviewMouseEventArgs) Handles XrLabel2.PreviewClick
        If isOpenNotes Then
            Exit Sub
        End If
