...
=======================================================================================================  
*/      
 /****** Object:  StoredProcedure [dbo].[SP_RPT_K2_AuxiliarMayorPorConcepto] ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_RPT_K2_AuxiliarMayorPorConcepto]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_RPT_K2_AuxiliarMayorPorConcepto]
GO
...
GO 
Create PROCEDURE [dbo].[SP_RPT_K2_AuxiliarMayorPorConcepto]     
@NumeroCuenta varchar(max),    
@CuentaAcumulable varchar(max),    
@Ejercicio smallint,    
@MesInicio smallint,    
@MesFin smallint,    
@MuestraVacios bit,    
@CuentaInicio varchar(max),    
@CuentaFin varchar(max),    
@MuestraSinSaldo bit    
AS    
BEGIN     
