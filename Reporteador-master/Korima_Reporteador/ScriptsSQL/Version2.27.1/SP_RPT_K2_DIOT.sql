...
ON T_Cheques.IdSolicitudCheque =T_SolicitudCheques.IdSolicitudCheques  
 ...
 UNION ALL --DM 20180414 Incluir los GxC
 Select D_Viaticos.IdProveedor, D_Viaticos.Importe from T_Viaticos 
inner join D_Viaticos On
T_Viaticos.IdViaticos = D_Viaticos.IdViatico
Where (MONTH(T_Viaticos.Fecha)=4 and YEAR(T_Viaticos.Fecha)=2018)  
