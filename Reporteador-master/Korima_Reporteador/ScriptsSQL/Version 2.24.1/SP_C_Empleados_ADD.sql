...
@LugarReside as varchar(100),
@LugarNacio as varchar(100),
@FecAsignacionPlaza as datetime = Null,
@IdNombramiento as int = Null,
@IdSubFuncion as varchar(255) = Null,
@IdClasGeografico as varchar(255) = Null,
@IdTipoGasto as varchar(255) = Null,
...
-- Tabla de Plazas 
 If @PorHonorarios is null or @PorHonorarios=0
 Begin
...
,0
,0
,(Select Top 1 IdSubFuncion From C_SubFunciones Where Clave = @IdSubFuncion)
,(Select Top 1 IdClasificadorGeografico From C_ClasificadorGeograficoPresupuestal Where Clave = @IdClasGeografico)
,(Select Top 1 IdtipoGasto From C_TipoGasto Where Clave = @IdTipoGasto)
)
...
(
  ...
  ,@IdPuesto
  ,Null
  ,(Select IdCategoria from C_Puestos where IdPuesto = @IdPuesto)
  ,1
  ,@VarIdMovimientoAlta
  ,Null
)
...
EXEC SP_CFG_LogScripts 'SP_C_Empleados_ADD'
GO