...
/****** Object:  StoredProcedure [dbo].[SP_RPT_K2_RelacionBienesPatrimonioPeriodoFiltrado]    Script Date: 10/25/2013 17:14:38 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_RPT_K2_RelacionBienesPatrimonioPeriodoFiltrado]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_RPT_K2_RelacionBienesPatrimonioPeriodoFiltrado]
GO
...
--EXEC SP_RPT_K2_RelacionBienesPatrimonioPeriodoFiltrado 1,10,2016,2016,0,1,0
CREATE PROCEDURE [dbo].[SP_RPT_K2_RelacionBienesPatrimonioPeriodoFiltrado]
@mesInicio int,
@mesFin int,
@EjercicioInicio int,
@EjercicioFin int,
...
GO
EXEC SP_CFG_LogScripts 'SP_RPT_K2_RelacionBienesPatrimonioPeriodoFiltrado'
GO
