...
begin
Insert Into @T_Datos
select vista.Prog as programa, C_EP_Ramo.Nombre, CCP.Capitulo, CCP.DesCapitulo,  
...
EXEC SP_FirmasReporte 'Formato Gral. de Aplicación de Recursos a Seguridad Pública'
GO

--SP_RPT_Formato_Gral_SP 0,0,2014,''
