...
NumeroCuenta,
NombreCuenta,
cast((CargosSinFlujo/1000)as decimal (18,2)) as CargosSinFlujo,
cast((AbonosSinFlujo/1000)as decimal (18,2)) as AbonosSinFlujo,
cast((TotalCargos/1000)as decimal (18,2)) as TotalCargos,
cast((TotalAbonos/1000)as decimal (18,2)) as TotalAbonos,
cast((SaldoDeudor/1000)as decimal (18,2)) as SaldoDeudor,
cast((SaldoAcreedor/1000)as decimal (18,2)) as SaldoAcreedor,
TipoCuenta,  
MaskNumeroCuenta,
Total, 
Mes, 
...
MaskNombreCuenta,
NumeroCuentaAnt, 
cast((SaldoDeudorAnt/1000)as decimal (18,2)) as SaldoDeudorAnt,
cast((SaldoAcreedorAnt/1000)as decimal (18,2)) as SaldoAcreedorAnt,
MesAnt,
AñoAnt,
Agrupador
