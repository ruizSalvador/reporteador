...
GO 
--Exec SP_RPT_Ramo_Programa_Objeto_Gasto_Capitulo 1,5,13,2019,'','','',0,0,0,'',0
...
ClaveProy varchar(200), Proyecto varchar(250), idClave varchar(100), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(200), idClave2 varchar(100),
...
Exec SP_CFG_LogScripts 'SP_RPT_Ramo_Programa_Objeto_Gasto_Capitulo','2.29'
GO
