...
--Exec SP_RPT_AnaliticoPorProveedorContable '20181001','20181031',0,147,0,1
...
LEFT JOIN T_Cheques TCH  
    on TCH.IdSolicitudCheque= TSC1.IdSolicitudCheques
...
TC.IdPolizaPresupuestoPagado, TC.Entregado, TP.Anticipo,TCH.IdCheques,TPOL.Fecha--TRF.IdObraPago
...
LEFT JOIN T_Cheques TCH  
    on TCH.IdSolicitudCheque= TSC1.IdSolicitudCheques and TCH.IdChequesAgrupador = 0
...
TSC.Fecha, TSC.FolioPorTipo, TSC.IdPolizaPresupuestoEjercido, TSC.FolioDesconcentrado, TC.FolioCheque, TC.Status, TC.IdCheques,
TC.IdPolizaPresupuestoPagado, TC.Entregado, TOS.Anticipo,TCH.IdCheques,TPOL.Fecha--TRF.IdObraPago
...
GO
Exec SP_CFG_LogScripts 'SP_RPT_AnaliticoPorProveedorContable','2.29'
GO
