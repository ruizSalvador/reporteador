...
LEFT OUTER JOIN dbo.RPT_Balanza_Comprobacio_Anterior_Periodos(@mes, @mes2, @año - 1) AS RPT_Balanza_Comprobacio_Anterior_1 
...
0,
0,
0,convert(int,SUBSTRING(NumeroCuenta,1,1)),NumeroCuenta,Total,@Mes,@Año,Nombre,NumeroCuenta,0,0,0,0,@Mes,@Año-1,1
