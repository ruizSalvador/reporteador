...
update @titulos set Abonos = (isnull(Abonos,0) + (Select ISNULL(TotalAbonos,0) from @valores where Cuenta = '43110'+REPLICATE('0',@Estructura1-5)+'-'+@CerosEstructura)) where orden = 7
...
GO
Exec SP_CFG_LogScripts 'SP_RPT_K2_ConciliacionIngresos'
GO
