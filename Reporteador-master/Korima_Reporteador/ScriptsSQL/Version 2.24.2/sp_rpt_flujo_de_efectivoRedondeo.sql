...
-- EXEC sp_rpt_flujo_de_efectivoRedondeo 2016,11,0,1,0
...
(Select ISNULL(SUM(0),0) as TotalAbonos from @eAcumuladoActual Where SUBSTRING(nocuenta ,1,4) = '8150'
And (SUBSTRING(nocuenta ,CHARINDEX('-', nocuenta) + 1 ,3) In ( '523')OR SUBSTRING(nocuenta ,CHARINDEX('-', nocuenta) + 1 ,4) In ('0524', '0523'))),
(Select ISNULL(SUM(0),0) as TotalAbonos from @eAcumuladoAnterior Where SUBSTRING(nocuenta ,1,4) = '8150'
...
Exec SP_CFG_LogScripts 'sp_rpt_flujo_de_efectivoRedondeo'
GO


-- EXEC sp_rpt_flujo_de_efectivoRedondeo 2016,1,0,1,0