...
EXEC SP_FirmasReporte 'Informe Analitico de Obligaciones Diferentes de Financiamientos LDF'
GO

Exec SP_CFG_LogScripts 'SP_RPT_InformeAnaliticoObligacionesDifFinanciamientos'
GO