...
select 
19,
(Select sum(isnull(T_SaldosInicialesCont.TotalCargos,0)) From T_SaldosInicialesCont JOIN c_contable on C_Contable.IdCuentaContable=T_SaldosInicialesCont.IdCuentaContable 
Where (Mes between @MesInicio and @MesFin) and Year =@Ejercicio and NumeroCuenta in('81'+REPLICATE('0',@Estructura1-2)+'-'+@CerosEstructura)), 
(Select sum(isnull(T_SaldosInicialesCont.TotalCargos,0)) From T_SaldosInicialesCont JOIN c_contable on C_Contable.IdCuentaContable=T_SaldosInicialesCont.IdCuentaContable 
Where (Mes between @MesInicio and @MesFin) and Year =@Ejercicio and NumeroCuenta in('814'+REPLICATE('0',@Estructura1-3)+'-'+@CerosEstructura)), 
(Select sum(isnull(T_SaldosInicialesCont.TotalAbonos,0)) From T_SaldosInicialesCont JOIN c_contable on C_Contable.IdCuentaContable=T_SaldosInicialesCont.IdCuentaContable 
Where (Mes between @MesInicio and @MesFin) and Year =@Ejercicio and NumeroCuenta in('815'+REPLICATE('0',@Estructura1-3)+'-'+@CerosEstructura))

insert into @Valores
select 
21,
(Select sum(isnull(T_SaldosInicialesCont.TotalAbonos,0)) From T_SaldosInicialesCont JOIN c_contable on C_Contable.IdCuentaContable=T_SaldosInicialesCont.IdCuentaContable 
Where (Mes between @MesInicio and @MesFin) and Year =@Ejercicio and NumeroCuenta in('821'+REPLICATE('0',@Estructura1-3)+'-'+@CerosEstructura)), 
(Select sum(isnull(T_SaldosInicialesCont.TotalAbonos,0)) From T_SaldosInicialesCont JOIN c_contable on C_Contable.IdCuentaContable=T_SaldosInicialesCont.IdCuentaContable 
Where (Mes between @MesInicio and @MesFin) and Year =@Ejercicio and NumeroCuenta in('825'+REPLICATE('0',@Estructura1-3)+'-'+@CerosEstructura)), 
(Select sum(isnull(T_SaldosInicialesCont.TotalCargos,0)) From T_SaldosInicialesCont JOIN c_contable on C_Contable.IdCuentaContable=T_SaldosInicialesCont.IdCuentaContable 
Where (Mes between @MesInicio and @MesFin) and Year =@Ejercicio and NumeroCuenta in('827'+REPLICATE('0',@Estructura1-3)+'-'+@CerosEstructura))
