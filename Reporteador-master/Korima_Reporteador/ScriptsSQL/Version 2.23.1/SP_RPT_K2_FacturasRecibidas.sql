...
group by T_RecepcionFacturas.Fecha, T_RecepcionFacturas.SubTotal, T_RecepcionFacturas.IVA, T_RecepcionFacturas.Total, T_RecepcionFacturas.Folio, T_RecepcionFacturas.Observaciones,
		C_Proveedores.RazonSocial, C_Proveedores.RFC, T_RecepcionFacturas.Factura, T_Cheques.Status, T_Cheques.Entregado, T_SolicitudCheques.Estatus, T_Cheques.IdChequesAgrupador
...
C_Proveedores.RazonSocial,'R.F.C. '+C_Proveedores.RFC as RFC,D_Viaticos.Referencia as Factura, 'Pagado' as Status, SUM(isnull(D_Viaticos.Retenciones,0)) as Retenciones
FROM T_Viaticos
...
group By T_Viaticos.IdViaticos,T_Viaticos.Fecha,T_Viaticos.Total,D_Viaticos.Referencia,T_Viaticos.Justificacion,C_Proveedores.RazonSocial,C_Proveedores.RFC,T_Viaticos.Folio, D_Viaticos.Retenciones
END
...
UNION
Select T_Viaticos.Fecha, SUM(isnull(D_Viaticos.Importe,0)) as SubTotal, SUM(isnull(D_Viaticos.IVA,0)) as IVA,SUM(isnull(D_Viaticos.Importe,0))+SUM(isnull(D_Viaticos.IVA,0))as Total,T_Viaticos.Folio,T_Viaticos.Justificacion as Observaciones,
C_Proveedores.RazonSocial,'R.F.C. '+C_Proveedores.RFC as RFC,D_Viaticos.Referencia as Factura, 'Pagado' as Status, SUM(isnull(D_Viaticos.Retenciones,0))
FROM T_Viaticos
