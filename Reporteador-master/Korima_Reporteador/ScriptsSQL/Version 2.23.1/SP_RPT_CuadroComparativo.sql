...
--Exec SP_RPT_CuadroComparativo 11
...
Insert into @Todo
Select TC.Fecha, Cantidad, CostoUnitario, Importe, DC.IVA, (Importe + DC.IVA) as TotalGral, CodigoCambs, DescripcionGenerica, RazonSocial,
...
Select
	   ...
	   FROM @Data1 D1
	   LEFT JOIN @Data2 D2
	   ON D1.CodigoCambs = D2.CodigoCambs
	   LEFT JOIN @Data3 D3
	   ON D1.CodigoCambs = D3.CodigoCambs
	   LEFT JOIN @Data4 D4
	   ON D1.CodigoCambs = D4.CodigoCambs
	   LEFT JOIN @Data5 D5
	   ON D1.CodigoCambs = D5.CodigoCambs
	   LEFT JOIN @Data6 D6
	   ON D1.CodigoCambs = D6.CodigoCambs
	   LEFT JOIN @Data7 D7
	   ON D1.CodigoCambs = D7.CodigoCambs
