...
--Exec SP_RPT_InformeProgramaEstadoEjercicioPresupuestoEGR 1,2,2020,'','','','',4,1,0,1,''
...
BEGIN
	...
	-- Valores Absolutos
		...
		(SELECT  tabla2.Clave
		FROM
		(select * from C_EP_Ramo where Id = T_SellosPresupuestales.IdProyecto and Nivel = 5) tablaID
		inner join
		...
		ON tabla3.IdPadre = tabla2.Id) AS Clave3, 
		...
		inner join 
		(select * from C_EP_Ramo where  Nivel = 2) tabla2
		ON tabla3.IdPadre = tabla2.Id)	as Descripcion3,
		...
		GROUP BY C_RamoPresupuestal.CLAVE ,C_RamoPresupuestal.DESCRIPCION , C_EP_Ramo.Clave, C_EP_Ramo.ID, C_EP_Ramo.Nombre, C_Funciones.Clave, C_Funciones.Nombre, T_SellosPresupuestales.IdProyecto 
...
BEGIN 
	...
	-- Valores Absolutos
		...
		inner join
		(select * from C_EP_Ramo where  Nivel = 4) tablaAI
		ON tablaID.IdPadre = tablaAI.Id) as Descripcion3a,
		
		C_CapitulosNEP.IdCapitulo as Clave4, 
		C_EP_Ramo.Id, 
		C_CapitulosNEP.Descripcion as Descripcion4,
		C_ConceptosNEP.IdConcepto  as Clave5, 
		C_ConceptosNEP.Descripcion as NombreAI,  
		...
		Group by  C_CapitulosNEP.IdCapitulo, C_CapitulosNEP.Descripcion, C_ConceptosNEP.IdConcepto, C_ConceptosNEP.Descripcion, C_ConceptosNEP.IdCapitulo,C_AreaResponsabilidad.Clave  , C_AreaResponsabilidad.Nombre,C_EP_Ramo.Clave,C_EP_Ramo.Id, C_EP_Ramo.Nombre,C_RamoPresupuestal.CLAVE,C_RamoPresupuestal.DESCRIPCION, T_SellosPresupuestales.IdProyecto 
	...
	Insert into @Final2
		...
		A.Clave4, A.Descripcion4, A.Clave5, A.NombreAI,
		ISNULL(A.Autorizado,0) as Autorizado,		
		CASE @AmpAnual
		WHEN 1 THEN ISNULL(A.TransferenciaAmp,0)
		ELSE ISNULL(T.TransferenciaAmp,0)
...
BEGIN 
	...
	BEGIN
		...
		Clave6 varchar(200), Descripcion6 varchar(max), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), TransferenciaRed decimal(15,2), 
		Modificado decimal(15,2), PreComprometido decimal(15,2), PresVigSinPreComp decimal(15,2), Comprometido decimal(15,2), PreCompSinComp decimal(15,2), 
		PresDispComp decimal(15,2), Devengado decimal(15,2), CompSinDev decimal(15,2), PresSinDev decimal(15,2), Ejercido decimal(15,2), DevSinEjer decimal(15,2), 
		...
		inner join 	(select * from C_EP_Ramo where  Nivel = 4) tablaAI
		ON tablaID.IdPadre = tablaAI.Id)*/  
		C_PartidasGenericasPres.DescripcionPartida as NombreAI,
		C_PartidasGenericasPres.IdPartidaGenerica as Clave5 , 
		(SELECT tablaID.Nombre  
		FROM (select * from C_EP_Ramo as T1 where T1.id = C_EP_Ramo.ID and Nivel = 5) tablaID
		inner join 	(select * from C_EP_Ramo where  Nivel = 4) tablaAI 	ON tablaID.IdPadre = tablaAI.Id) as Descripcion4,
		--C_PartidasGenericasPres.DescripcionPartida  as Descripcion4,  
		...
		C_FuenteFinanciamiento.DESCRIPCION , C_EP_Ramo.Clave, C_EP_Ramo.Nombre, C_EP_Ramo.Id, T_SellosPresupuestales.IdProyecto  
		...
		Insert into @Todo4
		Select Clave1, Descripcion, TResultadoFinal.Clave2, Descripcion2, Clave3, Descripcion3, Clave4, Clave5, Descripcion4, Clave6, Descripcion6, 
		Sum(Autorizado)Autorizado, SUM(TransferenciaAmp)TransferenciaAmp, Sum(TransferenciaRed)TransferenciaRed, Sum(Modificado)Modificado, 
		Sum(PreComprometido)PreComprometido, Sum(PresVigSinPreComp)PresVigSinPreComp, Sum(Comprometido)Comprometido, Sum(PreCompSinComp)PreCompSinComp, 
		sum(PresDispComp)PresDispComp, Sum(Devengado)Devengado, Sum(CompSinDev)CompSinDev, Sum(PresSinDev)PresSinDev, Sum(Ejercido)Ejercido, 
		Sum(DevSinEjer)DevSinEjer, Sum(Pagado)Pagado, Sum(EjerSinPagar)EjerSinPagar, Sum(Deuda)Deuda,
		...
		group by Clave1, Descripcion, TResultadoFinal.Clave2, Descripcion2, Clave3, Descripcion3, Clave4, Clave5, Descripcion4, Clave6, Descripcion6
	...
	BEGIN
		...
		A.Clave5, A.NombreAI, A.Descripcion6, A.Clave6,
		ISNULL(A.Autorizado,0) as Autorizado,		
		CASE @AmpAnual
		WHEN 1 THEN ISNULL(A.TransferenciaAmp,0)
		ELSE ISNULL(T.TransferenciaAmp,0)
...
BEGIN 
	...
	BEGIN	
		...
		Descripcion6 varchar(max), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), TransferenciaRed decimal(15,2))
		...
		Descripcion6 varchar(max), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), TransferenciaRed decimal(15,2), Modificado decimal(15,2), 
		...
		FROM (select * from C_EP_Ramo as T1 where T1.id = C_EP_Ramo.Id and Nivel = 5) tablaID
		inner join (select * from C_EP_Ramo where  Nivel = 4) tablaAI
		ON tablaID.IdPadre = tablaAI.Id)  as Descripcion4, 
		C_ClasificadorGeograficoPresupuestal.Clave AS Clave6, 
		C_ClasificadorGeograficoPresupuestal.Descripcion as Descripcion6,
		 sum(isnull(TP.Autorizado,0)) as Autorizado,  
		(sum(ISNULL(TP.Ampliaciones,0)) + sum(ISNULL(TP.TransferenciaAmp,0))) as TransferenciaAmp, 
		(sum(ISNULL(TP.Reducciones,0)) + sum(ISNULL(TP.TransferenciaRed,0))) as TransferenciaRed,   
		(sum(ISNULL(TP.Autorizado,0)) + (sum(ISNULL(TP.Ampliaciones,0)) + sum(ISNULL(TP.TransferenciaAmp,0))) - (sum(ISNULL(TP.Reducciones,0)) + sum(ISNULL(TP.TransferenciaRed,0)))) as Modificado,
...
BEGIN 
	...
	BEGIN
		...
		Insert into @Todo13
		Select Clave1, Descripcion, TResultadoFinal.Clave2, Descripcion2, Clave3, Clave4, Clave5, Descripcion4, Clave6, Descripcion6, 
		Sum(Autorizado)Autorizado, SUM(TransferenciaAmp)TransferenciaAmp, Sum(TransferenciaRed)TransferenciaRed, Sum(Modificado)Modificado, 
		Sum(PreComprometido)PreComprometido, Sum(PresVigSinPreComp)PresVigSinPreComp, Sum(Comprometido)Comprometido, Sum(PreCompSinComp)PreCompSinComp, 
		sum(PresDispComp)PresDispComp, Sum(Devengado)Devengado, Sum(CompSinDev)CompSinDev, Sum(PresSinDev)PresSinDev, Sum(Ejercido)Ejercido, 
		Sum(DevSinEjer)DevSinEjer, Sum(Pagado)Pagado, Sum(EjerSinPagar)EjerSinPagar, Sum(Deuda)Deuda,
		...
		group by Clave1, Descripcion, TResultadoFinal.Clave2, Descripcion2, Clave3, Clave4, Clave5, Descripcion4, Clave6, Descripcion6
...
BEGIN 
	...
	BEGIN	
		...
		C_ClasificadorGeograficoPresupuestal.Clave , C_ClasificadorGeograficoPresupuestal.Descripcion, T_SellosPresupuestales.IdProyecto  
		Order By C_AreaResponsabilidad.Clave ,C_PartidasGenericasPres.IdPartidaGenerica , C_PartidasGenericasPres.DescripcionPartida,C_RamoPresupuestal.CLAVE 
