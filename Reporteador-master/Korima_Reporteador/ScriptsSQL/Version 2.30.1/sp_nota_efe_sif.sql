...
Insert @Titulos values('11110', 'EFECTIVO')
Insert @Titulos values('11120', 'BANCOS/TESORERÍA')
Insert @Titulos values('11130', 'BANCOS/DEPENDENCIAS Y OTROS')
...
Insert @Titulos values('11190', 'OTROS EFECTIVOS EQUIVALENTES')
--Insert @Titulos values('', 'TOTAL EFECTIVO Y EQUIVALENTES')
...
Insert Into @tablaRpt 
Select '', 'TOTAL EFECTIVO Y EQUIVALENTES', 0, 0, 0, 0, @ejercicio   
...
UPDATE @tablaRpt  
set SaldoInicial=(Select SUM(SaldoInicial) FROM @tablaRpt 
					Where Cuenta in( '1111'+REPLICATE('0',@Estructura1-4)+'-'+@CerosEstructura,
									 '1112'+REPLICATE('0',@Estructura1-4)+'-'+@CerosEstructura, 
									 '1113'+REPLICATE('0',@Estructura1-4)+'-'+@CerosEstructura,
									 '1114'+REPLICATE('0',@Estructura1-4)+'-'+@CerosEstructura,
									 '1115'+REPLICATE('0',@Estructura1-4)+'-'+@CerosEstructura,
...
Select SUBSTRING(Cuenta,1,5) as Cuenta, Nombre, SaldoInicial/@Division as SaldoInicial,
SaldoFinal/@Division as SaldoFinal, SaldoInicialAnt/@Division as SaldoInicialAnt, SaldoFinalAnt/@Division as SaldoFinalAnt,anio 
From @tablaRpt 
Where Cuenta IN (
...
GO
Exec SP_CFG_LogScripts 'sp_nota_efe_sif','2.30.1'
GO
