...
IF @Tipo=0 BEGIN
	...
	'Cheque' as TipoMovimiento, 'No Generados' as Estatus, a.IdSolicitudCheque,a.IdChequesAgrupador,a.FechaImpresion, a.NumPoliza
	from @tabla a Where (PorDeposito=0 or IdSolicitudCheque=0)AND status= 'G'
	
	INSERT INTO @TablaResultado SELECT a.PorDeposito,a.Fecha,a.Foliocheque,a.Beneficiario,a.ImporteCheque,a.Factura,a.NoPoliza,a.SolicitudEgreso,a.status,a.CuentaBancaria,a.Entregado,	
	'Cheque' as TipoMovimiento, 'Por Imprimir' as Estatus, a.IdSolicitudCheque,a.IdChequesAgrupador,a.FechaImpresion, a.NumPoliza 
	from @tabla a Where (PorDeposito=0 or IdSolicitudCheque=0)AND status= 'C' AND IdChequesAgrupador=0 

	INSERT INTO @TablaResultado Select a.PorDeposito,a.Fecha,a.Foliocheque,a.Beneficiario,a.ImporteCheque,a.Factura,a.NoPoliza,a.SolicitudEgreso,a.status,a.CuentaBancaria,a.Entregado,	
	'Cheque' as TipoMovimiento, 'Impresos No Entregados' as Estatus, a.IdSolicitudCheque,a.IdChequesAgrupador,a.FechaImpresion, a.NumPoliza 
	from @tabla a Where (status= 'I') and Foliocheque>0 and Entregado=0 

	INSERT INTO @TablaResultado Select a.PorDeposito,a.Fecha,a.Foliocheque,a.Beneficiario,a.ImporteCheque,a.Factura,a.NoPoliza,a.SolicitudEgreso,a.status,a.CuentaBancaria,a.Entregado,	
	'Cheque' as TipoMovimiento, 'Impresos Entregados' as Estatus, a.IdSolicitudCheque,a.IdChequesAgrupador,a.FechaImpresion, a.NumPoliza 
	from @tabla a Where (status= 'I') and Entregado=1 and Foliocheque>0 

	INSERT INTO @TablaResultado Select a.PorDeposito,a.Fecha,a.Foliocheque,a.Beneficiario,a.ImporteCheque,a.Factura,a.NoPoliza,a.SolicitudEgreso,a.status,a.CuentaBancaria,a.Entregado,	
	'Cheque' as TipoMovimiento, 'Cancelados' as Estatus, a.IdSolicitudCheque,a.IdChequesAgrupador,a.FechaImpresion, a.NumPoliza 
...
IF @Tipo=1 BEGIN
	...
	IF @Estatus='' begin 
	INSERT INTO @TablaResultado Select a.PorDeposito,a.Fecha,a.Foliocheque,a.Beneficiario,a.ImporteCheque,a.Factura,a.NoPoliza,a.SolicitudEgreso,a.status,a.CuentaBancaria,a.Entregado,	
	'Transferencia Electrónica' as TipoMovimiento, 'Pendientes' as Estatus, a.IdSolicitudCheque,a.IdChequesAgrupador,a.FechaImpresion, a.NumPoliza 
	...
	INSERT INTO @TablaResultado Select a.PorDeposito,a.Fecha,a.Foliocheque,a.Beneficiario,a.ImporteCheque,a.Factura,a.NoPoliza,a.SolicitudEgreso,a.status,a.CuentaBancaria,a.Entregado,	
	'Transferencia Electrónica' as TipoMovimiento, 'Aplicados' as Estatus, a.IdSolicitudCheque,a.IdChequesAgrupador,a.FechaImpresion, a.NumPoliza 
	from @tabla a where status= 'D' and YEAR(FechaImpresion)=year(@FechaInicio)

	INSERT INTO @TablaResultado Select a.PorDeposito,a.Fecha,a.Foliocheque,a.Beneficiario,a.ImporteCheque,a.Factura,a.NoPoliza,a.SolicitudEgreso,a.status,a.CuentaBancaria,a.Entregado,	
	'Transferencia Electrónica' as TipoMovimiento, 'Cancelados' as Estatus, a.IdSolicitudCheque,a.IdChequesAgrupador,a.FechaImpresion, a.NumPoliza 
	from @tabla a where status= 'N' and Foliocheque=0 order by CuentaBancaria, Fecha
