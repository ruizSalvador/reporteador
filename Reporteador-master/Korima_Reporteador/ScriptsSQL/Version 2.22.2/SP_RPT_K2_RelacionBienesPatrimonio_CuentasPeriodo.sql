...
--	where T_AltaActivos.Importe>0 and T_Activos.FechaUA >=@dateini and T_Activos.FechaUA <=@datefin and T_Activos.Estatus <> 'B'
	...
	Insert @TablaTodos 
	Select 0 As Total, contable.NumeroCuenta, contable.nombreCuenta, isnull(@totalBienes,0)as TotalBienes, null as Fin
		From C_Contable contable  
		Where  TipoCuenta <> 'X' 
...
Else
 ...
 End
 GO
  --EXEC SP_RPT_K2_RelacionBienesPatrimonio_CuentasPeriodo 1,3,1900,2016,1,0
