...
--Por Recaudar
Insert @TablaTodos 
Select Tf.Folio , Tf.Fecha , CC.RazonSocial as Cliente, df.Importe ,df.Concepto  as Concepto, 'Por Recaudar' as Tipo,df.IdTarifa, C_PartidasGastosIngresos.Clave AS CLAVE, Tf.[status], idpoliza
...
--Recaudados
Insert @TablaTodos 
Select TRC.Folio , TRC.Fecha, CC.RazonSocial as Cliente, dr.Importe ,dr.Descripcion as Concepto,  'Recaudados' as Tipo, dr.IdTarifa, C_PartidasGastosIngresos.Clave,TRC.status, idpoliza
FROM c_clientes as cc
JOIN
...
Insert @TablaTodos 
Select TNC.Folio as Folio ,TNC.Fecha as Fecha, CC.RazonSocial as Cliente, dnc.Importe as Importe ,dnc.Concepto as Concepto,'Devoluciones y Compensaciones' as Tipo, dnc.IdTarifa, C_PartidasGastosIngresos.Clave, tnc.Estatus, IdPoliza
FROM c_clientes as cc
JOIN
...
BEGIN
	Select Folio,Fecha,Cliente, Importe, Concepto, Tipo, Idtarifa, Clave, 
	Case Estatus
...
ELSE	
BEGIN
	Select Folio,Fecha,Cliente, Importe, Concepto, Tipo, Idtarifa, Clave, 'Activo' as Estatus, idpoliza as IdPoliza
	from @TablaTodos 
