...
--EXEC RPT_SP_K2_Balanza_Comprobacion_ASEJ 2020,6,0,0,0,0,0,0,0,0
...
--Select * from #Balanza
 ...
 Where IdCuenta = 253
    ...
    Update C_BalanzaASEJ set
 CargosSinFlujo = (Select ISNULL(SUM(CargosSinFlujo),0) FROM #BalanzaAcu Where NumeroCuenta in ('41620-61105','41620-61106') ),
 AbonosSinFlujo = (Select ISNULL(SUM(AbonosSinFlujo),0) FROM #BalanzaAcu Where NumeroCuenta in ('41620-61105','41620-61106') ),
 TotalCargos = (Select ISNULL(SUM(TotalCargos),0) FROM #BalanzaAcu Where NumeroCuenta in ('41620-61105','41620-61106') ),
 TotalAbonos = (Select ISNULL(SUM(TotalAbonos),0) FROM #BalanzaAcu Where NumeroCuenta in ('41620-61105','41620-61106') ),
 SaldoDeudor = (Select ISNULL(SUM(SaldoDeudor),0) FROM #BalanzaAcu Where NumeroCuenta in ('41620-61105','41620-61106') ),
 SaldoAcreedor = (Select ISNULL(SUM(SaldoAcreedor),0) FROM #BalanzaAcu Where NumeroCuenta in ('41620-61105','41620-61106') )
 Where IdCuenta = 272
 ...
 Where IdCuenta = 615
     ...
     Update C_BalanzaASEJ set
 CargosSinFlujo = (Select ISNULL(SUM(CargosSinFlujo),0) FROM #BalanzaAcu Where NumeroCuenta in ('52510-04511','52520-04521') ),
 AbonosSinFlujo = (Select ISNULL(SUM(AbonosSinFlujo),0) FROM #BalanzaAcu Where NumeroCuenta in ('52510-04511','52520-04521') ),
 TotalCargos = (Select ISNULL(SUM(TotalCargos),0) FROM #BalanzaAcu Where NumeroCuenta in ('52510-04511','52520-04521') ),
 TotalAbonos = (Select ISNULL(SUM(TotalAbonos),0) FROM #BalanzaAcu Where NumeroCuenta in ('52510-04511','52520-04521') ),
 SaldoDeudor = (Select ISNULL(SUM(SaldoDeudor),0) FROM #BalanzaAcu Where NumeroCuenta in ('52510-04511','52520-04521') ),
 SaldoAcreedor = (Select ISNULL(SUM(SaldoAcreedor),0) FROM #BalanzaAcu Where NumeroCuenta in ('52510-04511','52520-04521') )
 Where IdCuenta = 622
