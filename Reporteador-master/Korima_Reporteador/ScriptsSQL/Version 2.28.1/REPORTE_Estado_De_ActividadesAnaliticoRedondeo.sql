 /****** Object:  StoredProcedure [dbo].[REPORTE_Estado_De_ActividadesAnaliticoRedondeo]   ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[REPORTE_Estado_De_ActividadesAnaliticoRedondeo]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[REPORTE_Estado_De_ActividadesAnaliticoRedondeo]
GO
...
CREATE PROCEDURE [dbo].[REPORTE_Estado_De_ActividadesAnaliticoRedondeo]  
@mes smallint,  
@mes2 smallint,  
@año smallint,  
@Miles bit,  
...
AñoAnt int,  
Agrupador int,  
TotalAbonos2 decimal(15,2),  
TotalCargos2 decimal(15,2),  
TotalAbonos3 decimal(15,2),  
TotalCargos3 decimal(15,2),  
TotalAbonos4 decimal(15,2),  
TotalCargos4 decimal(15,2),  
TotalAbonos5 decimal(15,2),  
TotalCargos5 decimal(15,2),   
TotalAbonos6 decimal(15,2),  
TotalCargos6 decimal(15,2),   
TotalAbonos7 decimal(15,2),  
TotalCargos7 decimal(15,2),  
TotalAbonos8 decimal(15,2),  
TotalCargos8 decimal(15,2),  
TotalAbonos9 decimal(15,2),  
TotalCargos9 decimal(15,2),  
TotalAbonos10 decimal(15,2),  
TotalCargos10 decimal(15,2),  
TotalAbonos11 decimal(15,2),  
TotalCargos11 decimal(15,2),  
TotalAbonos12 decimal(15,2),  
TotalCargos12 decimal(15,2),  
...
END  
  ...
  --exec REPORTE_Estado_De_ActividadesAnaliticoRedondeo @Mes=1,@Mes2=7,@Año=2017,@Miles=0,@MostrarVacios=1,@Redondeo=0