...
--Exec SP_RPT_InformeProgramaEstadoEjercicioPresupuestoEGR 1,12,2019,'','','','',18,1
...
BEGIN
	...
	-- Valores Absolutos
		...
		DECLARE @resultadoFinal as table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Id varchar(8), Descripcion3 varchar(150), Clave4 varchar(8), NombreAI varchar(150), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), 
		...
		DECLARE @Todo as table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Id varchar(8), Descripcion3 varchar(150), Clave4 varchar(8), NombreAI varchar(150), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), 
		TransferenciaRed decimal(15,2), Modificado decimal(15,2), PreComprometido decimal(15,2), PresVigSinPreComp decimal(15,2), Comprometido decimal(15,2), 
		PreCompSinComp decimal(15,2), PresDispComp decimal(15,2), Devengado decimal(15,2), CompSinDev decimal(15,2), PresSinDev decimal(15,2),
		Ejercido decimal(15,2), DevSinEjer decimal(15,2), Pagado decimal(15,2), EjerSinPagar decimal(15,2), Deuda decimal(15,2), PorcAprobAnual decimal(15,2),
		...
		--Anual
		declare @AprobAnual as Table(Autorizado decimal(18,2), Clave int, ID int)
		...
		where  (Mes BETWEEN 1 and 12) AND LYear=@Ejercicio and (C_RamoPresupuestal.CLAVE >= case when @Clave = '' then C_RamoPresupuestal.CLAVE else @Clave end 
		...
		If @AprAnual = 1
		Begin
			update r set r.Autorizado = a.Autorizado FROM @AprobAnual a, @Todo r Where a.Id = r.Id
		End
	...
	-- Valores Absolutos
		...
		Clave5 varchar(8), NombreAI varchar(150), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), TransferenciaRed decimal(15,2), Modificado decimal(15,2), 
		...
		Descripcion3 varchar(150), Clave3a varchar(8), Descripcion3a varchar(150), Clave4 varchar(8), Id varchar(8), Descripcion4 varchar(150), 
		Clave5 varchar(8), NombreAI varchar(150), Autorizado decimal(15,2))
	...
	If @AprAnual = 1
		...
		update r set r.Autorizado = a.Autorizado FROM @AprAnual2 a JOIN @Todo2 r ON a.Clave1 = r.Clave1 and a.Clave2 = r.Clave2 and a.Clave3 = r.Clave3 and  a.Clave4 = r.Clave4 and a.Clave5 = r.Clave5 and a.Id = r.Id
		END
		Select * from @Todo2 order by clave1, clave2, clave3, clave3a, clave5
	END
	...
	BEGIN
		...
		Clave3 varchar(8), NombreAI varchar(150), Clave3a varchar(8), Descripcion3a varchar(150), Clave4 varchar(8), Descripcion4 varchar(150),
	...
	BEGIN
		...
		Descripcion3 varchar(200), Clave4 varchar(20), Id varchar(20), NombreAI varchar(200), Clave5 varchar(20), Descripcion4 varchar(200),
		Clave6 varchar(20), Descripcion5 varchar(200), Autorizado decimal(15,2))
	...
	Insert into @AprAnual4
		...
		update r set r.Autorizado = a.Autorizado FROM @AprAnual4 a JOIN @Todo4 r ON a.Clave1 = r.Clave1 and a.Clave2 = r.Clave2 and a.Clave3 = r.Clave3 and  a.Clave4 = r.Clave4 and a.Clave5 = r.Clave5 and a.Clave6 = r.Clave6
	END

		Select * from @Todo4 order by Clave1, Clave2, Clave3, Clave4, Clave5, Clave6
	...
	BEGIN	
		...
		--Valores Absolutos
		DECLARE @AprAnual5 as table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Descripcion3 varchar(150), Clave4 varchar(8), Id varchar(8), NombreAI varchar(150), Clave5 varchar(8), Descripcion4 varchar(150), Clave6 varchar(8),
		Descripcion5 varchar(150), Autorizado decimal(15,2))

		DECLARE @Todo5 as table (Id int, Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Descripcion3 varchar(150), Clave4 varchar(8), NombreAI varchar(150), Clave5 varchar(8), Descripcion4 varchar(150), Clave6 varchar(8),
	...
	Insert into @AprAnual5
		...
		INNER JOIN C_EP_Ramo ON C_EP_Ramo.Id    = T_SellosPresupuestales.IdProyecto    
		INNER JOIN C_ConceptosNEP ON C_ConceptosNEP.IdConcepto = C_PartidasGenericasPres.IdConcepto  
		where  (Mes BETWEEN 1 and 12) AND LYear=@Ejercicio and (C_RamoPresupuestal.CLAVE >= case when @Clave = '' then C_RamoPresupuestal.CLAVE else @Clave end and C_RamoPresupuestal.CLAVE <= case when @Clave2 = '' then C_RamoPresupuestal.CLAVE else @Clave2 end ) AND C_AreaResponsabilidad.Clave  = CASE WHEN @ClaveUR = '' THEN C_AreaResponsabilidad.Clave ELSE @ClaveUR END  AND C_EP_Ramo.Id = case when @IdEP = '' then C_EP_Ramo.id else @IdEP end    
		group by C_PartidasGenericasPres.IdPartidaGenerica , C_PartidasGenericasPres.DescripcionPartida , C_AreaResponsabilidad.Clave  , C_AreaResponsabilidad.Nombre, C_RamoPresupuestal.CLAVE , C_RamoPresupuestal.DESCRIPCION ,  C_EP_Ramo.Clave, C_EP_Ramo.Nombre, C_EP_Ramo.Id, C_ClasificadorGeograficoPresupuestal.Clave , C_ClasificadorGeograficoPresupuestal.Descripcion  
		Order By C_AreaResponsabilidad.Clave ,C_PartidasGenericasPres.IdPartidaGenerica , C_PartidasGenericasPres.DescripcionPartida,C_RamoPresupuestal.CLAVE 
	...
	BEGIN
		...
		--Valores Absolutos
		DECLARE @Todo6 as table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Descripcion3 varchar(150), Clave4 varchar(max), Id varchar(8), Descripcion4 varchar(150), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), 
		TransferenciaRed decimal(15,2), Modificado decimal(15,2), PreComprometido decimal(15,2), PresVigSinPreComp decimal(15,2),Comprometido decimal(15,2), 
		PreCompSinComp decimal(15,2), PresDispComp decimal(15,2), Devengado decimal(15,2), CompSinDev decimal(15,2), PresSinDev decimal(15,2),
		Ejercido decimal(15,2), DevSinEjer decimal(15,2), Pagado decimal(15,2), EjerSinPagar decimal(15,2),	Deuda decimal(15,2), PorcAprobAnual decimal(15,2),
		PorcAprobadocAnt decimal(15,2), NomAprobado decimal(15,2), PorcPVigenteAnual decimal(15,2),	PorcPVigenteAnt decimal(15,2), NomPVigente decimal(15,2))

		DECLARE @AprAnual6 as table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Id varchar(8), Descripcion3 varchar(150), Clave4 varchar(max), Descripcion4 varchar(150), Autorizado decimal(15,2))
...
--- Red/Amp Acumuladas
		...
		IF @AprAnual = 1
			BEGIN
				Declare @AcumAnual_7_ABS as Table (Autorizado decimal(15,1), Clave int, Clave4 varchar(Max), ID Int)
				insert into @AcumAnual_7_ABS
				Select sum(isnull(TP.Autorizado,0)) as Autorizado, cr.CLAVE , ca.Clave, cepr.ID 
				FROM T_SellosPresupuestales INNER JOIN T_PRESUPUESTONW TP ON T_SellosPresupuestales.IdSelloPresupuestal = TP.IdSelloPresupuestal
				INNER JOIN C_RamoPresupuestal CR ON CR.IDRAMOPRESUPUESTAL = T_SellosPresupuestales.IdRamoPresupuestal  INNER JOIN C_EP_Ramo cepr
				ON cepr.Id  = T_SellosPresupuestales.IdProyecto INNER JOIN C_ProyectosInversion ON C_ProyectosInversion.PROYECTO = T_SellosPresupuestales.Proyecto 
				INNER JOIN C_AreaResponsabilidad CA ON (CA.IdAreaResp  = T_SellosPresupuestales.IdAreaResp) and  (CA.IdRamoPresupuestal = T_SellosPresupuestales.IdRamoPresupuestal)
				...
				UPDATE r set r.Autorizado = a.Autorizado FROM @AcumAnual_7_ABS a, @TResultadoFinal_7 r WHERE a.Clave4 = r.Clave2 AND a.ID = r.Id
...
--- Red/Amp Acumuladas
		...
		IF @AprAnual = 1
			BEGIN
				Declare @AcumAnual_8_ABS as Table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
				Descripcion3 varchar(150), Clave4 varchar(MAx), Descripcion4 varchar(150), Clave5 varchar(8), Id varchar(8), Descripcion5 varchar(150),
				Clave6 varchar(8), Descripcion6 varchar(150), Autorizado decimal(15,2))
		Insert into @AcumAnual_8_ABS
				Select  C_RamoPresupuestal.CLAVE as Clave1, C_RamoPresupuestal.DESCRIPCION AS Descripcion, 
		C_AreaResponsabilidad.Clave as Clave2 , C_AreaResponsabilidad.Nombre as Descripcion2 , 
		C_EP_Ramo.Clave AS Clave3, C_EP_Ramo.Nombre as Descripcion3,
		C_ProyectosInversion.CLAVE as Clave4, C_ProyectosInversion.NOMBRE  as Descripcion4,
		...
		UPDATE r set r.Autorizado = a.Autorizado FROM @AcumAnual_8_ABS a, @TResultadoFinal_8 r WHERE a.Clave1 = r.Clave1 AND a.Clave2 = r.Clave2 and a.Clave3 = r.Clave3 and a.Clave4 = r.Clave4 and a.Clave5 = r.Clave5 and a.ID = r.Id
	...
	BEGIN
		...
		IF @AprAnual = 1
			BEGIN
				Declare @AcumAnual_9_ABS as Table (Autorizado decimal(15,2), Clave varchar(8), Clave4 varchar(Max), ID Int, Clave2 varchar(8))
				insert into @AcumAnual_9_ABS
				Select  sum(isnull(TP.Autorizado,0)) as Autorizado, cr.CLAVE, cpi.clave, cepr.Id , cgp.Clave 
				FROM T_SellosPresupuestales INNER JOIN T_PRESUPUESTONW TP ON T_SellosPresupuestales.IdSelloPresupuestal = TP.IdSelloPresupuestal
				INNER JOIN C_RamoPresupuestal  CR ON CR.IDRAMOPRESUPUESTAL = T_SellosPresupuestales.IdRamoPresupuestal  INNER JOIN C_EP_Ramo cepr
				ON cepr.Id    = T_SellosPresupuestales.IdProyecto INNER JOIN C_ProyectosInversion cpi ON cpi.PROYECTO = T_SellosPresupuestales.Proyecto  
				left JOIN C_PartidasPres  ON C_PartidasPres.IdPartida   = T_SellosPresupuestales.IdPartida  left JOIN C_ClasificadorGeograficoPresupuestal cgp 
				...
				LEFT JOIN @TResultadoFinal_9 as T9 ON T9.ID = cepr.ID and Clave1 = cr.CLAVE and Clave2= cgp.Clave and Clave3= cepr.Clave and cpi.CLAVE = Clave4
				where  Mes = 0 AND LYear=@Ejercicio and (cr.CLAVE >= case when @Clave = '' then cr.CLAVE else @Clave end and cr.CLAVE <= case when @Clave2 = '' then cr.CLAVE else @Clave2 end ) AND cepr.Id = case when @IdEP = '' then cepr.id else @IdEP end
				group by cr.CLAVE, cpi.clave, cepr.Id, cgp.Clave

				UPDATE r set r.Autorizado = a.Autorizado FROM @AcumAnual_9_ABS a, @TResultadoFinal_9 r WHERE a.Clave = r.Clave1 AND a.ID = r.Id AND a.Clave2 = r.Clave2
	...
	BEGIN
		...
		DECLARE @TResultadoFinalR_11 as table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Descripcion3 varchar(150), Clave3a varchar(8), Descripcion3a varchar(150), Clave4 varchar(8), Id varchar(8), Descripcion4 varchar(150), Clave5 varchar(8),
		NombreAI varchar(150), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), TransferenciaRed decimal(15,2), Modificado decimal(15,2), 
		PreComprometido decimal(15,2), PresVigSinPreComp decimal(15,2),	Comprometido decimal(15,2), PreCompSinComp decimal(15,2), PresDispComp decimal(15,2), 
		Devengado decimal(15,2), CompSinDev decimal(15,2), PresSinDev decimal(15,2), Ejercido decimal(15,2), DevSinEjer decimal(15,2), Pagado decimal(15,2), 
		EjerSinPagar decimal(15,2),	Deuda decimal(15,2), PorcAprobAnual decimal(15,2), PorcAprobadocAnt decimal(15,2), NomAprobado decimal(15,2),
		PorcPVigenteAnual decimal(15,2), PorcPVigenteAnt decimal(15,2),	NomPVigente decimal(15,2))
	...
	BEGIN
		...
		case when @IdEP = '' then C_EP_Ramo.id else @IdEP end 
 		...
 		C_FuenteFinanciamiento.DESCRIPCION , C_EP_Ramo.Clave, C_EP_Ramo.Nombre, C_EP_Ramo.Id  
		Order By C_AreaResponsabilidad.Clave ,C_PartidasGenericasPres.IdPartidaGenerica , C_PartidasGenericasPres.DescripcionPartida,C_RamoPresupuestal.CLAVE
		update r set r.Autorizado = a.Autorizado FROM @AprAnual13 a JOIN @Todo13 r ON a.Clave1 = r.Clave1 and a.Clave2 = r.Clave2 and a.Clave3 = r.Clave3 and  a.Clave4 = r.Clave4 and a.Clave5 = r.Clave5 and a.Clave6 = r.Clave6
	END
	...
	BEGIN	
		--Ramo o Dependencia / Unidad Responsable / Programa Presupuestario / Actividad Institucional / Objeto del Gasto por Partida Genérica / Distribución Geográfica
		--Valores Relativos
		DECLARE @AprAnual14 as table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Descripcion3 varchar(150), Clave4 varchar(8), Id varchar(8), NombreAI varchar(150), Clave5 varchar(8), Descripcion4 varchar(150), Clave6 varchar(8),
		Descripcion5 varchar(150), Autorizado decimal(15,2))

		DECLARE @Todo14 as table (Id int, Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Descripcion3 varchar(150), Clave4 varchar(8), NombreAI varchar(150), Clave5 varchar(8), Descripcion4 varchar(150), Clave6 varchar(8),
		Descripcion5 varchar(150), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), TransferenciaRed decimal(15,2), Modificado decimal(15,2), 
		PreComprometido decimal(15,2), PresVigSinPreComp decimal(15,2), Comprometido decimal(15,2), PreCompSinComp decimal(15,2), PresDispComp decimal(15,2), 
		Devengado decimal(15,2), CompSinDev decimal(15,2), PresSinDev decimal(15,2), Ejercido decimal(15,2), DevSinEjer decimal(15,2), Pagado decimal(15,2), 
		...
		DECLARE @TResultadoFinalR_14 as table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Descripcion3 varchar(150), Clave4 varchar(8), Id varchar(8), NombreAI varchar(150), Clave5 varchar(8), Descripcion4 varchar(150), Clave6 varchar(8),
		Descripcion5 varchar(150), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), TransferenciaRed decimal(15,2), Modificado decimal(15,2), 
		PreComprometido decimal(15,2), PresVigSinPreComp decimal(15,2), Comprometido decimal(15,2), PreCompSinComp decimal(15,2), PresDispComp decimal(15,2), 
		Devengado decimal(15,2), CompSinDev decimal(15,2), PresSinDev decimal(15,2), Ejercido decimal(15,2), DevSinEjer decimal(15,2), Pagado decimal(15,2), 
...
If @AprAnual = 1
	...
	Insert into @AprAnual15
		...
		ON C_ProyectosInversion.PROYECTO = T_SellosPresupuestales.Proyecto  left JOIN C_SubFunciones  
		ON C_SubFunciones.IdSubFuncion  = T_SellosPresupuestales.IdSubFuncion left JOIN C_Funciones ON C_Funciones.IdFuncion = C_SubFunciones.IdFuncion  
		where   (Mes BETWEEN 1 and 12) AND LYear=@Ejercicio  and (C_RamoPresupuestal.CLAVE >= case when @Clave = '' then C_RamoPresupuestal.CLAVE else @Clave end and C_RamoPresupuestal.CLAVE <= case when @Clave2 = '' then C_RamoPresupuestal.CLAVE else @Clave2 end ) AND C_EP_Ramo.Id = case when @IdEP = '' then C_EP_Ramo.id else @IdEP end
		group by C_funciones.Clave, C_funciones.Nombre,  C_funciones.IdFuncion ,C_EP_Ramo.Nombre,C_RamoPresupuestal.CLAVE ,C_RamoPresupuestal.DESCRIPCION,C_EP_Ramo.Clave,C_EP_Ramo.Id,T_SellosPresupuestales.IdProyecto ,C_ProyectosInversion.CLAVE,C_ProyectosInversion.NOMBRE 
		Order By C_RamoPresupuestal.CLAVE,C_funciones.Clave
...
--- Red/Amp Acumuladas
		...
		IF @AprAnual = 1
			BEGIN
				Declare @AcumAnual_16 as Table (Autorizado decimal(15,1), Clave int, Clave4 varchar(Max), ID Int)
				insert into @AcumAnual_16
				Select  sum(isnull(TP.Autorizado,0)) as Autorizado, cr.CLAVE, ca.Clave, cepr.id
				FROM T_SellosPresupuestales INNER JOIN T_PRESUPUESTONW TP ON T_SellosPresupuestales.IdSelloPresupuestal = TP.IdSelloPresupuestal 
				INNER JOIN C_RamoPresupuestal CR ON CR.IDRAMOPRESUPUESTAL = T_SellosPresupuestales.IdRamoPresupuestal  INNER JOIN C_EP_Ramo cepr
				ON cepr.Id  = T_SellosPresupuestales.IdProyecto INNER JOIN C_ProyectosInversion ON C_ProyectosInversion.PROYECTO = T_SellosPresupuestales.Proyecto 
				...
				UPDATE r set r.Autorizado = a.Autorizado FROM @AcumAnual_16 a, @TResultadoFinalR_16 r WHERE a.Clave4 = r.Clave2 AND a.ID = r.Id
	...
	BEGIN
		...
		DECLARE @TResultadoFinalR_17 as table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
		Descripcion3 varchar(150), Clave4 varchar(MAx), Descripcion4 varchar(150), Clave5 varchar(8), Id varchar(8), Descripcion5 varchar(150),
		Clave6 varchar(8), Descripcion6 varchar(150), Autorizado decimal(15,2), TransferenciaAmp decimal(15,2), TransferenciaRed decimal(15,2), 
		Modificado decimal(15,2), PreComprometido decimal(15,2), PresVigSinPreComp decimal(15,2), Comprometido decimal(15,2), PreCompSinComp decimal(15,2), 
		PresDispComp decimal(15,2), Devengado decimal(15,2), CompSinDev decimal(15,2), PresSinDev decimal(15,2), Ejercido decimal(15,2), DevSinEjer decimal(15,2), 
		...
		IF @AprAnual = 1
			BEGIN
				Declare @AcumAnual_17 as Table (Clave1 varchar(8), Descripcion varchar(150), Clave2 varchar(8), Descripcion2 varchar(150), Clave3 varchar(8),
				Descripcion3 varchar(150), Clave4 varchar(MAx), Descripcion4 varchar(150), Clave5 varchar(8), Id varchar(8), Descripcion5 varchar(150),
				Clave6 varchar(8), Descripcion6 varchar(150), Autorizado decimal(15,2))	
				Insert into @AcumAnual_17
				Select  C_RamoPresupuestal.CLAVE as Clave1, C_RamoPresupuestal.DESCRIPCION AS Descripcion, 
		C_AreaResponsabilidad.Clave as Clave2 , C_AreaResponsabilidad.Nombre as Descripcion2 , 
		C_EP_Ramo.Clave AS Clave3, C_EP_Ramo.Nombre as Descripcion3,
		C_ProyectosInversion.CLAVE as Clave4, C_ProyectosInversion.NOMBRE  as Descripcion4,
		...
		UPDATE r set r.Autorizado = a.Autorizado FROM @AcumAnual_17 a, @TResultadoFinalR_17 r WHERE a.Clave1 = r.Clave1 AND a.Clave2 = r.Clave2 and a.Clave3 = r.Clave3 and a.Clave4 = r.Clave4 and a.Clave5 = r.Clave5 and a.ID = r.Id
...
--- Red/Amp Acumuladas
		...
		IF @AprAnual = 1
			BEGIN
				Declare @AcumAnual_18 as Table (Autorizado decimal(15,2), Clave varchar(8), Clave4 varchar(Max), ID Int, Clave2 varchar(8))
				insert into @AcumAnual_18
				Select  sum(isnull(TP.Autorizado,0)) as Autorizado, cr.CLAVE, cpi.clave, cepr.Id , cgp.Clave 
				FROM T_SellosPresupuestales INNER JOIN T_PRESUPUESTONW TP ON T_SellosPresupuestales.IdSelloPresupuestal = TP.IdSelloPresupuestal
				INNER JOIN C_RamoPresupuestal  CR ON CR.IDRAMOPRESUPUESTAL = T_SellosPresupuestales.IdRamoPresupuestal  INNER JOIN C_EP_Ramo cepr
				ON cepr.Id  = T_SellosPresupuestales.IdProyecto INNER JOIN C_ProyectosInversion cpi ON cpi.PROYECTO = T_SellosPresupuestales.Proyecto  
				...
				UPDATE r set r.Autorizado = a.Autorizado FROM @AcumAnual_18 a, @TResultadoFinalR_18 r WHERE a.Clave = r.Clave1 AND a.ID = r.Id AND a.Clave2 = r.Clave2
