...
IF @TipoBien <>'' BEGIN
	IF @EstatusBien <>'' BEGIN
		 ...
		 left JOIN T_BajaActivos on T_BajaActivos.Folio= D_BajasActivos.FolioBaja
				...
				Where  C_TipoBien.DescripcionTipoBien= @TipoBien AND YEAR(T_Activos.FechaUA)=@Ejercicio AND (MONTH(T_Activos.FechaUA )between 1 and @Periodo ) AND T_Activos.Estatus='A' AND T_Activos.EstadoDelBien in(@EstadoBien)
		 ...
		 left JOIN T_BajaActivos on T_BajaActivos.Folio= D_BajasActivos.FolioBaja
				...
				Where  C_TipoBien.DescripcionTipoBien= @TipoBien AND YEAR(T_Activos.FechaUA)=@Ejercicio AND (MONTH(T_Activos.FechaUA )between 1 and @Periodo ) AND T_Activos.Estatus='A'
				ORDER BY T_Activos.NumeroEconomico
			 END
			END
		 ...
		 left JOIN T_BajaActivos on T_BajaActivos.Folio= D_BajasActivos.FolioBaja
				...
				Where  C_TipoBien.DescripcionTipoBien= @TipoBien AND YEAR(T_Activos.FechaUA)=@Ejercicio AND (MONTH(T_Activos.FechaUA )between 1 and @Periodo ) AND T_Activos.Estatus='B' and T_Activos.EstadoDelBien in (@EstadoBien)
				ORDER BY T_Activos.NumeroEconomico
			 END
			 ELSE BEGIN 
				SELECT C_TipoBien.DescripcionTipoBien,
		 ...
		 left JOIN T_BajaActivos on T_BajaActivos.Folio= D_BajasActivos.FolioBaja
				...
				Where  C_TipoBien.DescripcionTipoBien= @TipoBien AND YEAR(T_Activos.FechaUA)=@Ejercicio AND (MONTH(T_Activos.FechaUA )between 1 and @Periodo ) AND T_Activos.Estatus='B'
				ORDER BY T_Activos.NumeroEconomico
			 END
		 ...
		 left JOIN T_BajaActivos on T_BajaActivos.Folio= D_BajasActivos.FolioBaja
				...
				Where  C_TipoBien.DescripcionTipoBien= @TipoBien AND YEAR(T_Activos.FechaUA)=@Ejercicio AND (MONTH(T_Activos.FechaUA )between 1 and @Periodo ) and T_Activos.EstadoDelBien in(@EstadoBien)
				ORDER BY T_Activos.NumeroEconomico
			 END
			 ELSE BEGIN 
				SELECT C_TipoBien.DescripcionTipoBien,
...
IF @TipoBien ='' BEGIN
	IF @EstatusBien ='' BEGIN
	 IF @EstadoBien ='' BEGIN
      ...
      Where YEAR(T_Activos.FechaUA)=@Ejercicio 
	        AND (MONTH(T_Activos.FechaUA ) between 1 and @Periodo )
...
Where YEAR(T_Activos.FechaUA)=@Ejercicio AND (MONTH(T_Activos.FechaUA ) between 1 and @Periodo ) and T_Activos.EstadoDelBien in (@EstadoBien)
ORDER BY C_TipoBien.DescripcionTipoBien, T_Activos.NumeroEconomico	
     END
...
ORDER BY C_TipoBien.DescripcionTipoBien, T_Activos.NumeroEconomico	
    ...
    IF @EstatusBien <>'' BEGIN
		...
		LEFT OUTER JOIN C_Maestro ON C_Maestro.IdCodigoProducto = T_Activos.CodigoProducto and C_Maestro.IdGrupo = T_Activos.CodigoGrupo and  C_Maestro.IdSubGrupo = T_Activos.CodigoSubGrupo
		Where YEAR(T_Activos.FechaUA)=@Ejercicio AND (MONTH(T_Activos.FechaUA ) between 1 and @Periodo ) AND T_Activos.Estatus='A' and T_Activos.EstadoDelBien in (@EstadoBien)
		ORDER BY C_TipoBien.DescripcionTipoBien, T_Activos.NumeroEconomico
			 END
			 ELSE BEGIN 
				SELECT C_TipoBien.DescripcionTipoBien,
		...
		FROM T_Activos
		 ...
		 left JOIN T_BajaActivos on T_BajaActivos.Folio= D_BajasActivos.FolioBaja
		LEFT OUTER JOIN C_Maestro ON C_Maestro.IdCodigoProducto = T_Activos.CodigoProducto and C_Maestro.IdGrupo = T_Activos.CodigoGrupo and  C_Maestro.IdSubGrupo = T_Activos.CodigoSubGrupo
		Where YEAR(T_Activos.FechaUA)=@Ejercicio AND (MONTH(T_Activos.FechaUA ) between 1 and @Periodo ) AND T_Activos.Estatus='A'
		ORDER BY C_TipoBien.DescripcionTipoBien, T_Activos.NumeroEconomico
			 END
		END
		ELSE IF @EstatusBien ='Inactivo' BEGIN
		...
		FROM T_Activos
		 ...
		 left JOIN T_BajaActivos on T_BajaActivos.Folio= D_BajasActivos.FolioBaja
		LEFT OUTER JOIN C_Maestro ON C_Maestro.IdCodigoProducto = T_Activos.CodigoProducto and C_Maestro.IdGrupo = T_Activos.CodigoGrupo and  C_Maestro.IdSubGrupo = T_Activos.CodigoSubGrupo
		Where YEAR(T_Activos.FechaUA)=@Ejercicio AND (MONTH(T_Activos.FechaUA ) between 1 and @Periodo ) AND T_Activos.Estatus='B' and T_Activos.EstadoDelBien in (@EstadoBien)
		ORDER BY C_TipoBien.DescripcionTipoBien, T_Activos.NumeroEconomico 
			 END
			 ELSE BEGIN 
				SELECT C_TipoBien.DescripcionTipoBien,
		...
		LEFT OUTER JOIN C_Maestro ON C_Maestro.IdCodigoProducto = T_Activos.CodigoProducto and C_Maestro.IdGrupo = T_Activos.CodigoGrupo and  C_Maestro.IdSubGrupo = T_Activos.CodigoSubGrupo
		Where YEAR(T_Activos.FechaUA)=@Ejercicio AND (MONTH(T_Activos.FechaUA ) between 1 and @Periodo ) AND T_Activos.Estatus='B'
		ORDER BY C_TipoBien.DescripcionTipoBien, T_Activos.NumeroEconomico 
			 END
		END
		ELSE IF @EstatusBien ='Todos' BEGIN
