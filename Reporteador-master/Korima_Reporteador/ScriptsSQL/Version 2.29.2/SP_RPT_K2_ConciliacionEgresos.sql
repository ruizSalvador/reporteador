...
--Exec SP_RPT_K2_ConciliacionEgresos 1,4,2019
...
insert into @titulos values ('23000', '2.1  Materias Primas y Materiales de Producción y Comercialización',null,0,1,3,null)
insert into @titulos values ('20000', '2.2  Materiales y Suministros',null,0,1,4,null)
insert into @titulos values ('51000', '2.3  Mobiliario y equipo de Administración',null,0,1,5,null)
insert into @titulos values ('52000', '2.4  Mobiliario y equipo educacional y recreativo',null,0,1,6,null)
insert into @titulos values ('53000', '2.5  Equipo e instrumental médico y de laboratorio',null,0,1,7,null)
insert into @titulos values ('54000', '2.6  Vehículos y equipos de transporte',null,0,1,8,null)
insert into @titulos values ('55000', '2.7  Equipo de Defensa y seguridad',null,0,1,9,null)
insert into @titulos values ('56000', '2.8  Maquinaria, otros equipo y herramientas',null,0,1,10,null)
insert into @titulos values ('57000', '2.9  Activos biológicos',null,0,1,11,null)
insert into @titulos values ('58000', '2.10  Bienes inmuebles',null,0,1,12,null)
insert into @titulos values ('59000', '2.11  Activos intangibles',null,0,1,13,null)
insert into @titulos values ('61000', '2.12  Obra Pública en Bienes de Dominio Público',null,0,1,14,null)
insert into @titulos values ('62000', '2.13  Obra pública en bienes propios',null,0,1,15,null)
insert into @titulos values ('72000', '2.14  Acciones y participaciones de capital',null,0,1,16,null)
insert into @titulos values ('73000', '2.15  Compra de títulos y valores',null,0,1,17,null)
insert into @titulos values ('74000', '2.16  Concesión de Préstamos',null,0,1,18,null)
insert into @titulos values ('75000', '2.17  Inversiones en fideicomisos, mandatos y otros análogos',null,0,1,19,null)
insert into @titulos values ('79000', '2.18  Provisiones para contingencias y otras erogaciones especiales',null,0,1,20,null)
insert into @titulos values ('91000', '2.19  Amortización de la deuda publica',null,0,1,21,null)
insert into @titulos values ('99000', '2.20  Adeudos de ejercicios fiscales anteriores (ADEFAS)',null,0,1,22,null)
insert into @titulos values ('', '2.21  Otros Egresos Presupuestales No Contables',null,0,1,23,null)
...
update @titulos set t.Cargos = isnull(v.Devengado,0) from @titulos t  join @rpt v on v.Clave= CAST(t.numero as int) Where t.Orden >= 3 and t.Orden <=22
...
Update @titulos set Cargos = (Select SUM(Devengado) from @rpt) Where Orden=1 --isnull(Cargos,0) where Orden=1
--update @titulos set Cargos=null where Orden=1
Update @titulos Set Cargos = (Select SUM(Devengado) from @rpt Where Clave in (21000, 22000, 24000, 25000, 26000, 27000, 28000, 29000)) Where Orden = 4
