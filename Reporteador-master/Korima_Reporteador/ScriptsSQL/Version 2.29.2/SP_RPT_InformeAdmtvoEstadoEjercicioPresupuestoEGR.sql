...
GO 
-- Exec SP_RPT_InformeAdmtvoEstadoEjercicioPresupuestoEGR 1,6,8,2020,'','','',0,0,0,'',0,1,0
...
declare @rptt1 as table(CveRamo varchar(200), DescripcionRamo varchar(max),CLAVE varchar(100), DESCRIPCION varchar(max),
...
declare @Anual1 as table(CveRamo varchar(200), DescripcionRamo varchar(max), CLAVE varchar(100), DESCRIPCION varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
---------------------------------------------------------------------------------------------
Insert into @Anual1
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual1 a, @rptt1 r Where a.CveRamo = r.CveRamo and a.Clave = r.Clave
	End
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual2 a, @rptt2 r Where a.Clave = r.Clave
	End
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual3 a, @rptt3 r Where a.Clave = r.Clave and a.IdCapitulo = r.IdCapitulo
	End
...
--Valores Absolutos
declare @rptt4 as table(IdClave int, Descripcion varchar(max), Clave int, Descripcion2 varchar(max), IdClave2 int, IdPartida int, Descripcion3 varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual4 as table(IdClave int, Descripcion varchar(max), Clave int, Descripcion2 varchar(max), IdClave2 int, IdPartida int, Descripcion3 varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
------------------------------------------------------------------------------------------------
Insert into @Anual4
...
--If @AmpRedAnual = 1
--	Begin
--		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual4 a, @rptt4 r Where a.IdPartida = r.IdPartida
--	End

IF @AprAnual = 1
	BEGIN
		Select A.IdClave, A.Descripcion, A.Clave, A.Descripcion2, A.IdClave2, A.IdPartida, A.Descripcion3, 
		...
		FROM @Anual4 A LEFT JOIN @rptt4 t ON a.IdClave = t.IdClave and a.Clave = t.Clave and a.IdClave2 = t.IdClave2 and a.IdPartida = t.IdPartida
		Order by IdClave, Clave, IdClave2, IdPartida
	END
ELSE
BEGIN 
		Select A.IdClave, A.Descripcion, A.Clave, A.Descripcion2, A.IdClave2, A.IdPartida, A.Descripcion3, 
...
--Valores Absolutos
declare @rptt5 as table(IdClave int, Descripcion varchar(max), IdClave2 int, Descripcion2 varchar(max), IdComp2 int, IdCpmp2a int, IdClave3 int, Descripcion3 varchar(max), IdComp3 int,
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual5 as table(IdClave int, Descripcion varchar(max), IdClave2 int, Descripcion2 varchar(max), IdComp2 int, IdCpmp2a int, IdClave3 int, Descripcion3 varchar(max), IdComp3 int,
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual5 a, @rptt5 r Where a.IdClave3 = r.IdClave3
	End
...
declare @Anual6 as table(ClaveUR int, Nombre varchar(max), IdClave int, Descripcion varchar(max), Clave int,  Descripcion2 varchar(max), IdClave2 int, IdPartida int, Descripcion3 varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4)) 
...
AND TS.IdProyecto = CASE WHEN @ClaveProg = 0 THEN TS.IdProyecto else @ClaveProg end 
...
--If @AmpRedAnual = 1
--	Begin
--		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual6 a, @rptt6 r Where a.Clave = r.Clave and a.IdClave2 = r.IdClave2 and a.IdPartida = r.IdPartida
--	End
IF @AprAnual = 1
	BEGIN
		Select A.ClaveUR, A.Nombre, A.IdClave, A.Descripcion, A.Clave, A.Descripcion2, A.IdClave2, A.IdPartida, A.Descripcion3, 
		ISNULL(A.Autorizado,0) as Autorizado,		
		CASE @AmpRedAnual
		WHEN 1 THEN ISNULL(A.Ampliaciones,0)
		ELSE ISNULL(T.Ampliaciones,0)
		...
		ISNULL(Comprometido,0) as Comprometido,	ISNULL(PreCompSinComp,0) as PreCompSinComp, ISNULL(PresDispComp,0) as PresDispComp,	ISNULL(Devengado,0) as Devengado, ISNULL(CompSinDev,0) as CompSinDev,
		ISNULL(PresSinDev,0) as PresSinDev, ISNULL(Ejercido,0) as Ejercido, ISNULL(DevSinEjer,0) as DevSinEjer,	ISNULL(Pagado,0) as Pagado, ISNULL(EjerSinPagar,0) as EjerSinPagar, ISNULL(Deuda,0) as Deuda		
		FROM @Anual6 A LEFT JOIN @rptt6 t ON a.ClaveUR = t.ClaveUR and a.IdClave = t.IdClave and a.Clave = t.Clave and a.IdClave2 = t.IdClave2 and a.IdPartida = t.IdPartida
		Order by ClaveUR, IdClave, Clave, IdClave2, IdPartida
	END
ELSE
BEGIN 
	Select A.ClaveUR, A.Nombre, A.IdClave, A.Descripcion, A.Clave, A.Descripcion2, A.IdClave2, A.IdPartida, A.Descripcion3, 
...
--Valores Absolutos
declare @rptt7 as table(Clave varchar(250), Descripcion varchar(max), 
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual7 as table(Clave varchar(250), Descripcion varchar(max), 
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual7 a, @rptt7 r Where a.Clave = r.Clave
	End
...
--Valores Absolutos
declare @rptt8 as table(Clave varchar(250), Nombre varchar(max), Clave2 varchar(100), Descripcion varchar(max), 
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual8 as table(Clave varchar(250), Nombre varchar(max), Clave2 varchar(100), Descripcion varchar(max), 
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
If @AprAnual = 1
		Begin
			update r set r.Autorizado = a.Autorizado FROM @Anual8 a, @rptt8 r Where a.Clave = r.Clave and a.Clave2 = r.Clave2
		End

If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual8 a, @rptt8 r Where a.Clave = r.Clave and a.Clave2 = r.Clave2
	End
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual9 a, @rptt9 r Where a.Clave = r.Clave 
	End
...
--Valores Absolutos
declare @rptt10 as table(IdClave varchar(200), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual10 as table(IdClave varchar(200), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
Insert into @Anual10
	...
	IF @AprAnual = 1
	BEGIN
		Select A.IdClave, A.Descripcion, A.Clave, A.Descripcion2,
		ISNULL(A.Autorizado,0) as Autorizado,		
		CASE @AmpRedAnual
		WHEN 1 THEN ISNULL(A.Ampliaciones,0)
		ELSE ISNULL(T.Ampliaciones,0)
		...
		ISNULL(Comprometido,0) as Comprometido,	ISNULL(PreCompSinComp,0) as PreCompSinComp, ISNULL(PresDispComp,0) as PresDispComp,	ISNULL(Devengado,0) as Devengado, ISNULL(CompSinDev,0) as CompSinDev,
		ISNULL(PresSinDev,0) as PresSinDev, ISNULL(Ejercido,0) as Ejercido, ISNULL(DevSinEjer,0) as DevSinEjer,	ISNULL(Pagado,0) as Pagado, ISNULL(EjerSinPagar,0) as EjerSinPagar, ISNULL(Deuda,0) as Deuda		
		FROM @Anual10 A LEFT JOIN @rptt10 t ON a.IdClave = t.IdClave and a.Clave = t.Clave
		Order by IdClave, Clave
	END
ELSE
BEGIN 
		Select A.IdClave, A.Descripcion, A.Clave, A.Descripcion2,		
...
--Valores Absolutos
declare @rptt11 as table(ClaveUR varchar(200), Nombre varchar(max), Clave int, Descripcion varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual11 as table(ClaveUR varchar(200), Nombre varchar(max), Clave int, Descripcion varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual11 a, @rptt11 r Where a.ClaveUR = r.ClaveUR and a.Clave = r.Clave  
	End
...
--Valores Absolutos
declare @rptt12 as table(ClaveUR varchar(200), Nombre varchar(max), Clave int, Descripcion varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual12 as table(ClaveUR varchar(200), Nombre varchar(max), Clave int, Descripcion varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual12 a, @rptt12 r Where a.ClaveUR = r.ClaveUR and a.Clave = r.Clave  
	End
...
DECLARE @nombreAI varchar(max)
DECLARE @claveAI varchar(255)
declare @rptt13 as table(ClaveUR varchar(200), Nombre varchar(max), ClaveProy varchar(max), Proyecto varchar(max), idClave varchar(100), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(max), idClave2 varchar(100),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual13 as table(ClaveUR varchar(max), Nombre varchar(max), ClaveProy varchar(max), Proyecto varchar(max), idClave varchar(100), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(max), idClave2 varchar(100),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
/*
...
Insert into @Anual13
	...
	sum(ISNULL(T1.Ampliaciones,0)) as Ampliaciones, 
	sum(ISNULL(T1.Reducciones,0)) as Reducciones 
    from (
	Select top 100 PErcent CEPR.ID, CA.Clave as ClaveUR , CA.Nombre ,CEPR.Clave as ClaveProy , CEPR.Nombre as Proyecto,  
	CG.IdCapitulo as IdClave, CG.Descripcion as Descripcion, CN.IdConcepto  as Clave, CN.Descripcion as Descripcion2, CN.IdCapitulo as IdClave2,  
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual13 a, @rptt13 r Where a.ClaveUR = r.ClaveUR and a.ClaveProy = r.ClaveProy and a.Clave = r.Clave and a.idClave = r.idClave and a.idClave2 = r.idClave2
	End
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual29 a, @rptt29 r Where a.Clave = r.Clave
	End
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual31 a, @rptt31 r Where a.Clave = r.Clave
	End
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO--Unidad Responsable
--Valores Relativos
declare @rptt14 as table(CveRamo varchar(max), DescripcionRamo varchar(max),CLAVE varchar(100), DESCRIPCION varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual14 as table(CveRamo varchar(max), DescripcionRamo varchar(max), CLAVE varchar(100), DESCRIPCION varchar(max),
Autorizado decimal(18,4))
------------------------------------------------------------------------------------------------
Insert into @Anual14
Select   CR.CLAVE as CveRamo , CR.DESCRIPCION as DescripcionRamo , CA.Clave as Clave , CA.Nombre  as Descripcion,
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO--Ramo - Clasificador Económico
--Valores Relativos
declare @rptt15 as table(CLAVE varchar(max), DESCRIPCION varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual15 as table(CLAVE varchar(max), DESCRIPCION varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
------------------------------------------------------------------------------------------
Insert into @Anual15
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual15 a, @rptt15 r Where a.Clave = r.Clave
	End
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO--Clasificación Económica - Capítulo del Gasto
--Valores Relativos
declare @rptt16 as table(CLAVE varchar(max),IdCapitulo int, DESCRIPCION varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual16 as table(CLAVE varchar(max),IdCapitulo int, DESCRIPCION varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
Order by CE.Clave, CG.IdCapitulo 
	...
	If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual16 a, @rptt16 r Where a.Clave = r.Clave and a.IdCapitulo = r.IdCapitulo
	End
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO --Capítulo del Gasto
--Valores Relativos
declare @rptt17 as table(IdClave int, Descripcion varchar(max), Clave int, Descripcion2 varchar(max), IdClave2 int, IdPartida int, Descripcion3 varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual17 as table(IdClave int, Descripcion varchar(max), Clave int, Descripcion2 varchar(max), IdClave2 int, IdPartida int, Descripcion3 varchar(max),
Autorizado decimal(18,4))
...
declare @Anual18 as table(IdClave int, Descripcion varchar(max), IdClave2 int, Descripcion2 varchar(max), IdComp2 int, IdCpmp2a int, IdClave3 int, Descripcion3 varchar(max), IdComp3 int,
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual18 a, @rptt18 r Where a.IdClave3 = r.IdClave3
	End
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO --Capítulo del Gasto -Unidad Responsable
--Valores Relativos
declare @rptt19 as table(ClaveUR int, Nombre varchar(max),IdClave int, Descripcion varchar(max), Clave int, Descripcion2 varchar(max), IdClave2 int, IdPartida int, Descripcion3 varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual19 as table(ClaveUR int, Nombre varchar(max),IdClave int, Descripcion varchar(max), Clave int, Descripcion2 varchar(max), IdClave2 int, IdPartida int, Descripcion3 varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
--If @AmpRedAnual = 1
--	Begin
--		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual19 a, @rptt19 r Where a.Clave = r.Clave and a.IdClave2 = r.IdClave2 and a.IdPartida = r.IdPartida
--	End
IF @AprAnual = 1
	BEGIN
		Select A.ClaveUR, A.Nombre, A.IdClave, A.Descripcion, A.Clave, A.Descripcion2, A.IdClave2, A.IdPartida, A.Descripcion3, 
		...
		ISNULL(Comprometido,0) as Comprometido,	ISNULL(PreCompSinComp,0) as PreCompSinComp, ISNULL(PresDispComp,0) as PresDispComp,	ISNULL(Devengado,0) as Devengado, ISNULL(CompSinDev,0) as CompSinDev,
		ISNULL(PresSinDev,0) as PresSinDev, ISNULL(Ejercido,0) as Ejercido, ISNULL(DevSinEjer,0) as DevSinEjer,	ISNULL(Pagado,0) as Pagado, ISNULL(EjerSinPagar,0) as EjerSinPagar, ISNULL(Deuda,0) as Deuda	
		FROM @Anual19 A LEFT JOIN @rptt19 t ON a.ClaveUR = t.ClaveUR and a.IdClave = t.IdClave and a.Clave = t.Clave and a.IdClave2 = t.IdClave2 and a.IdPartida = t.IdPartida
		Order by ClaveUR, IdClave, Clave, IdClave2, IdPartida
	END
ELSE
BEGIN 
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO --Programa
--Valores Relativos
declare @rptt20 as table(Clave varchar(max), Descripcion varchar(max), 
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual20 as table(Clave varchar(max), Descripcion varchar(max), 
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
Insert into @Anual20
	...
	Where   (Mes = 0) AND LYear=@Ejercicio  AND Year=@Ejercicio AND CR.CLAVE = CASE WHEN @Clave = '' THEN CR.CLAVE else @Clave end  AND CEPR.Nivel = '5' 
	GROUP BY CEPR.Clave, CEPR.Nombre
	ORDER BY CEPR.Clave
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual20 a, @rptt20 r Where a.Clave = r.Clave
	End
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO --Programa -Unidad Responsable
--Valores Relativos
declare @rptt21 as table(Clave varchar(250), Nombre varchar(max), Clave2 varchar(max), Descripcion varchar(max), 
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual21 as table(Clave varchar(250), Nombre varchar(max), Clave2 varchar(100), Descripcion varchar(max), 
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
If @AprAnual = 1
		Begin
			update r set r.Autorizado = a.Autorizado FROM @Anual21 a, @rptt21 r Where a.Clave = r.Clave and a.Clave2 = r.Clave2
		End

If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual21 a, @rptt21 r Where a.Clave = r.Clave and a.Clave2 = r.Clave2
	End
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO --Clasificación Geográfica
--Valores Relativos
declare @rptt22 as table(Clave varchar(max), Descripcion varchar(max), 
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual22 as table(Clave varchar(max), Descripcion varchar(max), 
Autorizado decimal(18,4), Ampliaciones decimal(18,2), Reducciones decimal(18,2))
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual22 a, @rptt22 r Where a.Clave = r.Clave
	End
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO --Clasificación Geográfica - Económica
--Valores Relativos
declare @rptt23 as table(IdClave varchar(200), Descripcion varchar(max), Clave varchar(max), Descripcion2 varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual23 as table(IdClave varchar(200), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
IF @AprAnual = 1
	BEGIN
		...
		ISNULL(Comprometido,0) as Comprometido,	ISNULL(PreCompSinComp,0) as PreCompSinComp, ISNULL(PresDispComp,0) as PresDispComp,	ISNULL(Devengado,0) as Devengado, ISNULL(CompSinDev,0) as CompSinDev,
		ISNULL(PresSinDev,0) as PresSinDev, ISNULL(Ejercido,0) as Ejercido, ISNULL(DevSinEjer,0) as DevSinEjer,	ISNULL(Pagado,0) as Pagado, ISNULL(EjerSinPagar,0) as EjerSinPagar, ISNULL(Deuda,0) as Deuda		
		FROM @Anual23 A LEFT JOIN @rptt23 t ON a.IdClave = t.IdClave and a.Clave = t.Clave
		Order by IdClave, Clave
	END
ELSE
BEGIN 
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO --Unidad Responsable - Partida Genérica 
--Valores Relativos
declare @rptt24 as table(ClaveUR varchar(max), Nombre varchar(max), Clave int, Descripcion varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual24 as table(ClaveUR varchar(200), Nombre varchar(max), Clave int, Descripcion varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual24 a, @rptt24 r Where a.ClaveUR = r.ClaveUR and a.Clave = r.Clave 
	End
...
--Consulta para INFORME ADMINISTRATIVO SOBRE EL ESTADO DEL EJERCICIO DEL PRESUPUESTO --Unidad Responsable - Partida Especifica 
--Valores Relativos
declare @rptt25 as table(ClaveUR varchar(200), Nombre varchar(max), Clave int, Descripcion varchar(max),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual25 as table(ClaveUR varchar(max), Nombre varchar(max), Clave int, Descripcion varchar(max),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual25 a, @rptt25 r Where a.ClaveUR = r.ClaveUR and a.Clave = r.Clave 
	End
...
declare @Anual26 as table(ClaveUR varchar(200), Nombre varchar(max), ClaveProy varchar(max), Proyecto varchar(max), idClave varchar(100), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(max), idClave2 varchar(100),
Autorizado decimal(18,4), Ampliaciones decimal(18,4), Reducciones decimal(18,4))
...
If @AprAnual = 1
	...
	If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual26 a, @rptt26 r Where a.ClaveUR = r.ClaveUR and a.ClaveProy = r.ClaveProy and a.Clave = r.Clave and a.idClave = r.idClave and a.idClave2 = r.idClave2
	End
...
declare @rptt27 as table(ClaveUR varchar(200), Nombre varchar(max), ClaveProy varchar(max), Proyecto varchar(max), idClave varchar(100), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(max), idClave2 varchar(100),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual27 as table(ClaveUR varchar(200), Nombre varchar(max), ClaveProy varchar(200), Proyecto varchar(max), idClave varchar(100), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(max), idClave2 varchar(100),
Autorizado decimal(18,4), Ampliaciones decimal(18,2), Reducciones decimal(18,2))
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual27 a, @rptt27 r Where a.ClaveUR = r.ClaveUR and a.ClaveProy = r.ClaveProy and a.Clave = r.Clave and a.idClave = r.idClave and a.idClave2 = r.idClave2
	End
...
declare @rptt28 as table(ClaveUR varchar(200), Nombre varchar(max), ClaveProy varchar(200), Proyecto varchar(max), idClave varchar(100), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(max), idClave2 varchar(100),
Autorizado decimal(18,4), 
Ampliaciones  decimal(18,4),
Reducciones  decimal(18,4),
Modificado  decimal(18,4),
...
declare @Anual28 as table(ClaveUR varchar(200), Nombre varchar(max), ClaveProy varchar(200), Proyecto varchar(max), idClave varchar(100), Descripcion varchar(max), Clave varchar(200), Descripcion2 varchar(max), idClave2 varchar(100),
Autorizado decimal(18,4), Ampliaciones decimal(18,2), Reducciones decimal(18,2))
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual28 a, @rptt28 r Where a.ClaveUR = r.ClaveUR and a.ClaveProy = r.ClaveProy and a.Clave = r.Clave and a.idClave = r.idClave and a.idClave2 = r.idClave2
	End
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual30 a, @rptt30 r Where a.Clave = r.Clave
	End
...
If @AmpRedAnual = 1
	Begin
		update r set r.Ampliaciones = a.Ampliaciones, r.Reducciones = a.Reducciones FROM @Anual32 a, @rptt32 r Where a.Clave = r.Clave
	End
...
Exec SP_CFG_LogScripts 'SP_RPT_InformeAdmtvoEstadoEjercicioPresupuestoEGR','2.29.1'
GO
