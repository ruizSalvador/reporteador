...
insert into @titulos values ('99'+REPLICATE('0',@Estructura1-2)+'-'+@CerosEstructura, 'Adeudos de ejercicios fiscales anteriores (ADEFAS)',null,0,1,18,null)
...
SET @variable = isnull(
	...
	On D_Polizas.IdPoliza = T_Polizas.IdPoliza
		inner join C_Contable 
	On C_Contable.IdCuentaContable = D_Polizas.IdCuentaContable
--Luis	Where (C_Contable.NumeroCuenta like '1231%' or C_Contable.NumeroCuenta like '1232%' or C_Contable.NumeroCuenta like '1233%' or C_Contable.NumeroCuenta like '1234%') and (T_Polizas.Concepto <> 'Alta Activos por inicialización')
	Where (C_Contable.NumeroCuenta like '1231%' or C_Contable.NumeroCuenta like '1232%' or C_Contable.NumeroCuenta like '1233%' or C_Contable.NumeroCuenta like '1234%' or C_Contable.NumeroCuenta like '1235%') and (T_Polizas.Concepto <> 'Alta Activos por inicialización')
...
SET @variable = isnull(
	...
	On D_Polizas.IdPoliza = T_Polizas.IdPoliza
		inner join C_Contable 
	On C_Contable.IdCuentaContable = D_Polizas.IdCuentaContable
--Luis--Where (C_Contable.NumeroCuenta like '1235%' or C_Contable.NumeroCuenta like '1236%') and (T_Polizas.Concepto <> 'Alta Activos por inicialización')
    Where (C_Contable.NumeroCuenta like '1236%') and (T_Polizas.Concepto <> 'Alta Activos por inicialización')
	and (T_Polizas.NoPoliza > 0) and (T_Polizas.TipoPoliza = 'D')
	and (T_Polizas.Ejercicio = @Ejercicio) and (T_Polizas.Periodo between @MesInicio and @MesFin)),0)
