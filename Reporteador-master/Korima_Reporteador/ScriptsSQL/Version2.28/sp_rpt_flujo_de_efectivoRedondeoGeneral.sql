...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_rpt_flujo_de_efectivoRedondeo]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_rpt_flujo_de_efectivoRedondeo]
GO
CREATE PROCEDURE [dbo].[sp_rpt_flujo_de_efectivoRedondeo]
...
Union All
Select a.nombre, a.totalabonos, b.totalabonos, 0, 'X',9
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
...
Union All
Select a.nombre, a.totalabonos, b.totalabonos, 0, 'X',13
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
...
/*
(select(select ISNULL(sum(importecargo),0) from d_polizas where idpoliza in ( select idpoliza from t_polizas where tipopoliza in('I','D','E') and Periodo = @periodo and Ejercicio = @ejercicio and idtipomovimiento <> 404   AND NOPOLIZA <> 0) and idcuentacontable in (select idcuentacontable from c_contable where numerocuenta like '111%')and ImporteCargo <> 0)
-(SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO) AND 
...
-(SELECT  isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @periodo AND Ejercicio = @ejercicio) 
...
(select(select ISNULL(sum(importecargo),0) from d_polizas where idpoliza in ( select idpoliza from t_polizas where tipopoliza in('I','D','E') and Periodo = @periodo and Ejercicio = @ejercicio-1 and idtipomovimiento <> 404  and idpolizacancelacion is null) and idcuentacontable in (select idcuentacontable from c_contable where numerocuenta like '111%')and ImporteCargo <> 0)
-(SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO-1) AND 
IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '81500-01%'))
-(SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO-1) AND 
IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '81500-02%'))
-(SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO-1) AND 
...
-(SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO-1) AND 
IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '81500-04%'))
-(SELECT  isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @periodo AND Ejercicio = @ejercicio-1) 
AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '81500-05%'))
-(SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO-1) AND 
IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '81500-06%'))
-(SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO-1) AND 
...
(Select SUM(ImporteCheque) from T_Cheques where IdTipoMovimiento in (415,140,143,408) and YEAR(Fecha) = @ejercicio and MONTH(Fecha) = @periodo and status <> 'N' and status <> 'C' and IdChequesAgrupador =0 and status <> 'G'),
(Select SUM(ImporteCheque) from T_Cheques where IdTipoMovimiento in (415,140,143,408) and YEAR(Fecha) = @ejercicio-1 and MONTH(Fecha) = @periodo and status <> 'N' and status <> 'C' and IdChequesAgrupador =0 and status <> 'G'), 
0, 'X', 21
UNION ALL
Select 'MATERIALES Y SUMINISTROS',
(SELECT(Select SUM(ImporteCheque) from T_Cheques where IdTipoMovimiento = 146 and YEAR(Fecha) = @ejercicio and MONTH(Fecha) = @periodo and idCHEQUESAGRUPADOR = 0 and status <> 'N' and status <> 'C')
-(Select isnull(SUM(importecargo),0) From d_polizas Where idpoliza in (select idpoliza from t_polizas where IdTipoMovimiento in (7) and YEAR(Fecha) = @ejercicio and MONTH(Fecha) =@PERIODO  and tipopoliza = 'D' and idpoliza <> 580 )and IdCuentaContable in (select idcuentacontable from c_Contable where numerocuenta like '82700-5%'))
-(select ISNULL(sum(importecargo),0) from d_polizas where idpoliza in (select idpoliza from t_polizas where MONTH(Fecha) = @PERIODO and YEAR(Fecha) = @ejercicio and IdTipoMovimiento = 146) and idcuentacontable in ( select idcuentacontable from  c_contable where numerocuenta like '82700-5%'))),
(Select SUM(ImporteCheque) from T_Cheques where IdTipoMovimiento = 146 and YEAR(Fecha) = @ejercicio-1 and MONTH(Fecha) = @periodo and idCHEQUESAGRUPADOR = 0 and status <> 'N' and status <> 'C'), 
0, 'X', 22
UNION ALL
Select 'SERVICIOS GENERALES',
(select(Select isnull(SUM(ImporteCheque),0) From T_Cheques Where IdTipoMovimiento in (235,163) and YEAR(Fecha) = @ejercicio and MONTH(Fecha) =@periodo and idCHEQUESAGRUPADOR = 0 and status <> 'N' and status <> 'C' and status <> 'G')
+(Select isnull(SUM(ImporteCheque),0) From T_Cheques Where IdTipoMovimiento in (235,163) and YEAR(Fecha) = @ejercicio and MONTH(Fecha) = @periodo and idCHEQUESAGRUPADOR = 0 and month(fecha) <> month(fechacancelacion) and status <> 'C' and status <> 'G')
-(select ISNULL(sum(importecargo),0) from d_polizas where idpoliza in (select idpoliza from t_polizas where MONTH(Fecha)= @periodo and YEAR(Fecha) = @ejercicio and IdTipoMovimiento in (235,163)) and idcuentacontable in ( select idcuentacontable from  c_contable where numerocuenta like '82700-5%'))),
(Select isnull(SUM(ImporteCheque),0) From T_Cheques Where IdTipoMovimiento in (235,163) and YEAR(Fecha) = @ejercicio-1 and MONTH(Fecha) = @periodo and idCHEQUESAGRUPADOR = 0 and status <> 'N' and status <> 'C' and status <> 'G'),
0, 'X', 23
UNION ALL
Select 'TRANSFERENCIAS INTERNAS Y ASIGNACIONES AL SECTOR PÚBLICO',
(SELECT isnull(SUM(ImporteCargo),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @periodo AND Ejercicio = @ejercicio  and nopoliza <> 0) AND 
IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '82700-41%')),
(SELECT isnull(SUM(ImporteCargo),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @periodo AND Ejercicio = @ejercicio-1 and nopoliza <> 0) AND 
IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '82700-41%')), 
0, 'X', 25
UNION ALL
...
(select(select ISNULL(sum(importeabono),0) from d_polizas where idpoliza in ( select idpoliza from t_polizas where tipopoliza in('I','D','E') and Periodo = @PERIODO and Ejercicio = @EJERCICIO and idtipomovimiento <> 404 and NoPoliza <> 0 ) and idcuentacontable in (select idcuentacontable from c_contable where numerocuenta like '111%')and ImporteAbono <> 0)
-(Select isnull(SUM(ImporteCheque),0) from T_Cheques where IdTipoMovimiento in (415,140,143,408) and YEAR(Fecha) = @ejercicio and MONTH(Fecha) = @periodo and status <> 'N' and status <> 'C' and IdChequesAgrupador =0 and status <> 'G')
-(Select isnull(SUM(ImporteCheque),0) from T_Cheques where IdTipoMovimiento = 146 and YEAR(Fecha) = @ejercicio and MONTH(Fecha) = @periodo and idCHEQUESAGRUPADOR = 0 and status <> 'N' and status <> 'C')
-(Select isnull(SUM(ImporteCheque),0) From T_Cheques Where IdTipoMovimiento in (235,163) and YEAR(Fecha) = @ejercicio and MONTH(Fecha) = @periodo and idCHEQUESAGRUPADOR = 0 and status <> 'N' and status <> 'C' and status <> 'G')
-(Select isnull(SUM(ImporteCheque),0) From T_Cheques Where IdTipoMovimiento in (235,163) and YEAR(Fecha) = @ejercicio and MONTH(Fecha) = @periodo and idCHEQUESAGRUPADOR = 0 and month(fecha) <> month(fechacancelacion) and status <> 'C' and status <> 'G')
-(SELECT isnull(SUM(ImporteCargo),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @periodo AND Ejercicio = @ejercicio and nopoliza <> 0) AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '82700-4%'))
-(SELECT isnull (SUM(IMPORTEcargo),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @periodo AND Ejercicio = @ejercicio and nopoliza <> 0) AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '82700-5%'))
-(SELECT isnull (SUM(IMPORTEcargo),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE MONTH(Fecha) = @periodo AND Ejercicio = @ejercicio and nopoliza <> 0 ) AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '82700-6%'))
+(select isnull (sum(ImporteCargo),0) from d_polizas where idpoliza in (select idpoliza from T_Polizas where IdTipoMovimiento = 404 and ejercicio = @ejercicio and Periodo = @periodo and nopoliza <> 0) and IdCuentaContable = 1501)),
--año anterior--
(select(select ISNULL(sum(importeabono),0) from d_polizas where idpoliza in ( select idpoliza from t_polizas where tipopoliza in('I','D','E') and Periodo = @PERIODO and Ejercicio = @EJERCICIO-1 and idtipomovimiento <> 404 and NoPoliza <> 0  ) and idcuentacontable in (select idcuentacontable from c_contable where numerocuenta like '111%')and ImporteAbono <> 0)
-(Select isnull(SUM(ImporteCheque),0) from T_Cheques where IdTipoMovimiento in (415,140,143,408) and YEAR(Fecha) = @ejercicio-1 and MONTH(Fecha) = @periodo and status <> 'N' and status <> 'C' and IdChequesAgrupador =0 and status <> 'G')
-(Select isnull(SUM(ImporteCheque),0) from T_Cheques where IdTipoMovimiento = 146 and YEAR(Fecha) = @ejercicio-1 and MONTH(Fecha) = @periodo and idCHEQUESAGRUPADOR = 0 and status <> 'N' and status <> 'C')
-(Select isnull(SUM(ImporteCheque),0) From T_Cheques Where IdTipoMovimiento in (235,163) and YEAR(Fecha) = @ejercicio-1 and MONTH(Fecha) = @periodo and idCHEQUESAGRUPADOR = 0 and status <> 'N' and status <> 'C' and status <> 'G')
-(SELECT isnull(SUM(ImporteCargo),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @periodo AND Ejercicio = @ejercicio-1) AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '827104-0%')and iddpoliza <>109815 and iddpoliza <>109823)
-(Select isnull(SUM(ImporteCheque),0) From T_Cheques Where IdTipoMovimiento in (235,163) and YEAR(Fecha) = @ejercicio-1 and MONTH(Fecha) = @periodo and idCHEQUESAGRUPADOR = 0 and fecha <> fechacancelacion and status <> 'C' and status <> 'G')
-(SELECT isnull (SUM(IMPORTEcargo),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @periodo AND Ejercicio = @ejercicio-1 and nopoliza <> 0) AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '827105-5%'))),
0, 'X', 37.1
insert into @report 
...
Select 'BIENES MUEBLES',
--Cambio a acumulado
(SELECT SUM(IMPORTEcargo) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @periodo AND Ejercicio = @ejercicio and nopoliza <> 0) AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '82700-5%')),
(SELECT SUM(IMPORTEcargo) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @periodo AND Ejercicio = @ejercicio-1) AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '82700-5%'))
, 0, 'X', 45
--(Select SUM(TotalCargos) from @eAcumuladoActual 
--Where SUBSTRING(nocuenta ,1,4) In ('8271') And(
...
--'0511', '0512', '0515', '0521', '0522', '0529', '0519', '0531', '0532', '0541', '0542', '0543', '0544', '0545', '0549', '0551', 
...
-(SELECT isnull (SUM(IMPORTEcargo),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE MONTH(Fecha) = @periodo  AND Ejercicio = @ejercicio and nopoliza <> 0) AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '82700-06%')),
--Cambio a acumulado
(Select SUM(TotalCargos) from @eAcumuladoAnterior 
Where SUBSTRING(nocuenta ,1,4) In ('8270') And
SUBSTRING(nocuenta ,CHARINDEX('-', nocuenta) + 1 ,3) In ('611','612','613','614','615','616','617','618','619','620','621', '622','623','624','625','626','627','628','629','630','631')),
...
(Select SUM(TotalCargos) from @eAcumuladoActual 
Where SUBSTRING(nocuenta ,1,4) In ('8270') And
SUBSTRING(nocuenta ,CHARINDEX('-', nocuenta) + 1 ,4) = '589'),
--Cambio a acumulado
(Select SUM(TotalCargos) from @eAcumuladoAnterior 
Where SUBSTRING(nocuenta ,1,4) In ('8270') And
SUBSTRING(nocuenta ,CHARINDEX('-', nocuenta) + 1 ,4) = '589'), 0, 'X', 46
Insert Into @report
...
--Cambio a acumulado
(Select SUM(TotalCargos) From @eAcumuladoActual  
Where SUBSTRING(nocuenta ,1,4) In ('2170')),
--Cambio a acumulado
(Select SUM(TotalCargos) From @eAcumuladoAnterior 
Where SUBSTRING(nocuenta ,1,4) In ('2170')), 0, 'X', 59
...
-- DECLARE @report TABLE (nombre varchar(255), SaldoActual decimal(15,2), SaldoAnterior decimal(15,2), negritas tinyint, secciongroup char(1), orden decimal(15,2))
------ BR 20150814 -------------------------------------
UPDATE @report set SaldoActual=  (SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO) AND 
IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '81500-1%')
...
UPDATE @report set SaldoActual= ((SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO) 
AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '81500-5%'))
...
UPDATE @report set SaldoAnterior=  (SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO-1) AND 
IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '81500-1%')
) where nombre='IMPUESTOS' 
...
UPDATE @report set SaldoAnterior= ((SELECT isnull(SUM(IMPORTEABONO),0) FROM D_POLIZAS WHERE IDPOLIZA IN (SELECT IdPoliza FROM T_Polizas WHERE Periodo = @PERIODO AND Ejercicio = @EJERCICIO-1) 
AND IDCUENTACONTABLE IN (SELECT IDCUENTACONTABLE FROM C_CONTABLE WHERE NumeroCuenta LIKE '81500-5%'))
...
--EXEC sp_rpt_flujo_de_efectivoRedondeo 2017,3,0,1,0