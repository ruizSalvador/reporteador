...
--Exec SP_RPT_ConsultaEstadodelEjerciciodelPresupuesto 1,12,1,2018,'','','','',1,1
...
END
	...
	BEGIN
		...
		CASE @AmpRedAnual
		WHEN 1 THEN (ISNULL(A.Autorizado,0) + (ISNULL(A.Ampliaciones,0) + ISNULL(A.TransferenciaAmp,0)) - (ISNULL(A.Reducciones,0) + ISNULL(A.TransferenciaRed,0)))
	...
	BEGIN
		...
		ISNULL(T.TransferenciaAmp,0) as TransferenciaAmp, ISNULL(T.TransferenciaRed,0) as TransferenciaRed, 
		CASE @AmpRedAnual
		WHEN 1 THEN (ISNULL(T.Autorizado,0) + (ISNULL(A.Ampliaciones,0) + ISNULL(A.TransferenciaAmp,0)) - (ISNULL(A.Reducciones,0) + ISNULL(A.TransferenciaRed,0)))
...
END
GO
Exec SP_CFG_LogScripts 'SP_RPT_ConsultaEstadodelEjerciciodelPresupuesto','2.29.1'
GO