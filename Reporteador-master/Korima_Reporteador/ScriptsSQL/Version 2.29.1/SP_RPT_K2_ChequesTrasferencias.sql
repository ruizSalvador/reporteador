...
-- Exec SP_RPT_K2_ChequesTrasferencias '20190101', '20190330','', '', '', 0
...
--IF @Tipo=1 BEGIN---------------------------------------------------------
	...
	Update @TablaResultado Set TipoMovimiento='Transferencia Electrónica' Where TipoMovimiento <> 'Cheque'
	UPDATE @TablaResultado Set Estatus= 'Pendientes' Where TipoMovimiento <> 'Cheque'
	--Select * from @TablaResultado 
	...
	Update @TablaResultado Set TipoMovimiento='Transferencia Electrónica' Where TipoMovimiento <> 'Cheque'
	UPDATE @TablaResultado Set Estatus= 'Aplicados' Where TipoMovimiento <> 'Cheque'
	--Select * from @TablaResultado
	...
	INSERT INTO @TablaResultado Select * from @tabla where status= 'N' and Foliocheque=0 order by CuentaBancaria, Fecha
	Update @TablaResultado Set TipoMovimiento='Transferencia Electrónica' Where TipoMovimiento <> 'Cheque'
	UPDATE @TablaResultado Set Estatus= 'Cancelados' Where TipoMovimiento <> 'Cheque'
	--Select * from @TablaResultado 
