...
Public Class CtrlNotas_FETA_Movimiento_de_Personal
    'Dim strFirmas
    'Dim strTitulo
    'Public strReporte
    ...
    Function TrimesteRango() As String
        If RadioButton1.Checked = True Then
            Return "Enero - Marzo " + TimeEdit1.Text
        End If
        If RadioButton2.Checked = True Then
            Return "Abril - Junio " + TimeEdit1.Text
        End If
        If RadioButton3.Checked = True Then
            Return "Julio - Septiembre " + TimeEdit1.Text
        End If
        If RadioButton4.Checked = True Then
            Return "Octubre - Diciembre " + TimeEdit1.Text
        End If
    End Function

    Dim reporte As NOTA_FETA_Movimiento_de_Personal

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_FETA_Movimiento_de_Personal()
        Dim printTool As New ReportPrintTool(reporte)

        Dim conection As New SqlConnection(cnnString)
        Dim prmEjercicio As New SqlParameter("Columnas", 7)
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Movimientos de Personal por Centro de Trabajo' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            '.lblRptNombreReporte.Text = "Movimientos de Personal por Centro de Trabajo"
            ...
            .lblRptRangoTrimestre.Text = TrimesteRango()
            ...
            .lblTitulo.Text = "Personal Registrado en la Nómina Federalizada"
            '.lblSubtitulo.Text = ""
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= 'Movimientos de Personal por Centro de Trabajo'", New SqlConnection(cnnString))
            cmd.Connection.Open()
