...
Public Class CtrlNotas_FETA_Pagos_Retroactivos
    'Dim strFirmas
    'Dim strTitulo
    'Public strReporte
    ...
    Function TrimesteLetra() As String
        ...
        End If
    End Function
    Dim reporte As NOTA_FETA_Pagos_Retroactivos

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_FETA_Pagos_Retroactivos()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Pagos Retroactivos' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            '.lblRptEntidadFederativa.Text = "Entidad Federativa: " + pRPTCFGDatosEntes.Nombre
            ...
            .lblTitulo.Text = "Registro Federal de Contribuyentes de Trabajadores con Pagos Retroactivos con un Período Mayor a 45 días"
            '.lblSubtitulo.Text = ""
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= 'Pagos Retroactivos'", New SqlConnection(cnnString))
            cmd.Connection.Open()
