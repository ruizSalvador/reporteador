...
Public Class CtrlNotas_PersonalHonorarios
    'Dim TipoReporte
    'Dim strFirmas
    'Dim strTitulo
    'Public strReporte
    ...
    Private Function MesLetra(ByVal Mes As Integer) As String
        ...
        End Select
    End Function
    Dim reporte As NOTA_PersonalHonorarios

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_PersonalHonorarios()
        Dim printTool As New ReportPrintTool(reporte)

        Dim conection As New SqlConnection(cnnString)
        'Dim prmEjercicio As New SqlParameter("Columnas", 6)
        'Dim prmPeriodo As New SqlParameter("Renglones", SE_Filas.Value)
        Dim command As New SqlCommand("SP_RPT_K2_Personal_Honorarios", conection)
        ...
        adapter.Fill(ds, "SP_RPT_K2_Personal_Honorarios")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_Personal_Honorarios"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Personal por Honorarios' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Personal por Honorarios"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= 'Personal por Honorarios'", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        AddHandler ctrl.PreviewMouseMove, AddressOf ctrlMouseUp
        ctrl = reporte.FindControl("lbl_Nota4", False)
        AddHandler ctrl.PreviewMouseMove, AddressOf ctrlMouseUp
