...
Public Class CtrlNota_IndiceNotasGestionAdmtva
    Dim reporte As NOTA_INDICE_NOTAS_GESTION_ADMTIVA
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        reporte = New NOTA_INDICE_NOTAS_GESTION_ADMTIVA()
        ...
        With reporte
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='NOTAS A LOS ESTADOS FINANCIEROS (Gestion Administrativa)' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
