...
Public Class CtrlNota_NOTAS_DE_GESTION_ADMTIVA
    Dim reporte As NOTAS_DE_GESTION_ADMTIVA
    Public notas2 As New Dictionary(Of String, String)
    Public nota1 As New Dictionary(Of String, String)
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        reporte = New NOTAS_DE_GESTION_ADMTIVA()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'NOTAS DE GESTIÓN ADMINISTRATIVA' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "NOTAS DE GESTIÓN ADMINISTRATIVA"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='NOTAS DE GESTIÓN ADMINISTRATIVA' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
