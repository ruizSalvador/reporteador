...
Public Class CtrlNotas_Trabajadores_Licencia
    'Dim strFirmas
    'Dim strTitulo
    'Public strReporte
    ...
    Private Function MesLetra(ByVal Mes As Integer) As String
        ...
        End Select
    End Function
    Dim reporte As NOTA_Trabajadores_Licencia

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_Trabajadores_Licencia()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Trabajadores con Licencia' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Trabajadores con Licencia"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= 'Trabajadores con Licencia'", New SqlConnection(cnnString))
            cmd.Connection.Open()
