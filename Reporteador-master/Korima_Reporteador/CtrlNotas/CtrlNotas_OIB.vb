...
Public Class CtrlNotas_OIB
    Public reporte As NOTA_OIB
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim command As New SqlCommand("sp_nota_oib", conection)
        ...
        adapter.Fill(ds, "sp_nota_oib")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "sp_nota_oib"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Otros Ingresos y Beneficios' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            Else
                .XrLabel1.Text = ""
            End If
            .lblTitulo.Text = "Otros Ingresos y Beneficios"
            .lblSubtitulo.Text = ""
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Otros Ingresos y Beneficios' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
