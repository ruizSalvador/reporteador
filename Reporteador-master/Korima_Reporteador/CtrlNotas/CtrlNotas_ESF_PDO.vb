...
Public Class CtrlNotas_ESF_PDO
    Dim TipoReporte
    Dim strFirmas
    Dim strTitulo
    Public strReporte
    ...
    Public Sub New(Tipo As Integer)
        TipoReporte = Tipo
        If Tipo = 1 Then
            strFirmas = "Pasivos Diferidos Y Otros"
            strReporte = "Notas al Estado de Situación Financiera"
            strTitulo = "Pasivos diferidos y otros"
        End If
        If Tipo = 2 Then
            strFirmas = "Patrimonio Contribuido"
            strReporte = "Notas al Estado de Variaciones en la Hacienda Pública / Patrimonio"
            strTitulo = "Modificaciones al patrimonio contribuido"
        End If
    ...
    Dim reporte As NOTA_ESF_PDO

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_ESF_PDO()
        ...
        Dim command As New SqlCommand("SP_NOTA_ESF_PDO", conection)
        ...
        adapter.Fill(ds, "SP_NOTA_ESF_PDO")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_NOTA_ESF_PDO"
