...
Public Class CtrlNotas_InvFinan_SPyAC
    Public reporte As NOTA_InvFinan_SPyAC
    
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_InvFinan_SPyAC()
        ...
        Dim command As New SqlCommand("sp_nota_InvFinan_SPyAC", conection2)
        ...
        adapter2.Fill(dsB, "sp_nota_InvFinan_SPyAC")
        reporte.DataSource = dsB

        reporte.DataAdapter = adapter2
        reporte.DataMember = "sp_nota_InvFinan_SPyAC"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Inversiones Financieras/Participaciones y Aportaciones' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            Else
                .XrLabel1.Text = ""
            End If
            .lblTitulo.Text = "Inversiones financieras"
            .lblSubtitulo.Text = "Saldos de las participaciones y aportaciones de capital"
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Inversiones Financieras/Participaciones y Aportaciones' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
