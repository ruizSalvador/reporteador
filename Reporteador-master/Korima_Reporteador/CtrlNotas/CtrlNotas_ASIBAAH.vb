...
Public Class CtrlNotas_ASIBAAH
    'Dim TipoReporte
    'Dim strFirmas
    'Dim strTitulo
    'Public strReporte
    ...
    Private Function MesLetra(ByVal Mes As Integer) As String
        ...
        End Select
    End Function
    Dim reporte As NOTA_ASIBAAH

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_ASIBAAH()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Auxiliar Sujeto a Inventario de Bienes Arqueológicos, Artísticos e Históricos' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= 'Auxiliar Sujeto a Inventario de Bienes Arqueológicos, Artísticos e Históricos'", New SqlConnection(cnnString))
            cmd.Connection.Open()
