...
Public Class CtrlNotas_FETA_Doble_Asignacion
    'Dim strFirmas
    'Dim strTitulo
    'Public strReporte
    ...
    Function TrimesteLetra() As String
        ...
        End If
    End Function
    Dim reporte As NOTA_FETA_Doble_Asignacion

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_FETA_Doble_Asignacion()
        Dim printTool As New ReportPrintTool(reporte)

        Dim conection As New SqlConnection(cnnString)
        Dim prmEjercicio As New SqlParameter("Columnas", 17)
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Trabajadores con Doble Asignación Salarial' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblTitulo.Text = "Trabajadores con Doble Asignación Salarial en Municipios no Colindantes Geográficamente"
            '.lblSubtitulo.Text = ""
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= 'Trabajadores con Doble Asignación Salarial'", New SqlConnection(cnnString))
            cmd.Connection.Open()
