...
Public Class CtrlNotas_EE_IF
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim command As New SqlCommand("sp_nota_ee_if", conection2)
        ...
        adapter2.Fill(dsB, "sp_nota_ee_if")
        reporte.DataSource = dsB

        reporte.DataAdapter = adapter2
        reporte.DataMember = "sp_nota_ee_if"


        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Efectivo y Equivalentes/Inversiones' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblSubtitulo.Text = "Inversiones Financieras"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Efectivo y Equivalentes/Inversiones' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
    ...
    Private Sub ChkSaldos_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
