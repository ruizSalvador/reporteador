...
Public Class CtrlNotas_FETA_Personal_Comisionado
    'Dim strFirmas
    'Dim strTitulo
    'Public strReporte
    ...
    Function TrimesteLetra() As String
        If RadioButton1.Checked = True Then
            Return "No. Trimestre y año: Trimestre 1 del Ejercicio " + TimeEdit1.Text
        End If
        If RadioButton2.Checked = True Then
            Return "No. Trimestre y año: Trimestre 2 del Ejercicio " + TimeEdit1.Text
        End If
        If RadioButton3.Checked = True Then
            Return "No. Trimestre y año: Trimestre 3 del Ejercicio " + TimeEdit1.Text
        End If
        If RadioButton4.Checked = True Then
            Return "No. Trimestre y año: Trimestre 4 del Ejercicio " + TimeEdit1.Text
        End If
    End Function
    Dim reporte As NOTA_FETA_Personal_Comisionado

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_FETA_Personal_Comisionado()
        Dim printTool As New ReportPrintTool(reporte)

        Dim conection As New SqlConnection(cnnString)
        Dim prmEjercicio As New SqlParameter("Columnas", 23)
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Personal Comisionado' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblTitulo.Text = "Personal Comisionado"
            '.lblSubtitulo.Text = ""
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= 'Personal Comisionado'", New SqlConnection(cnnString))
            cmd.Connection.Open()
