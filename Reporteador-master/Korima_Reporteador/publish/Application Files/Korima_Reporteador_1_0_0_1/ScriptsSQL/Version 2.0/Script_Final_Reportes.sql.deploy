...
declare @TamañoCadenaDos as bigint
declare @TamañoCadenaDerecha as bigint
declare @PosicionComodin as bigint
declare @Sangria as varchar(max)
 
 set @Cadena= left(@CadenaBruta,60)
 set @TamañoCadenaDos = len(@CadenaBruta)
...
begin
	 ...
	 set @TamañoCadenaDerecha = @TamañoCadenaDos-@ValorPosicion
	 set @CadenaFinalB=right(@CadenaBruta,@TamañoCadenaDerecha)
...
CREATE FUNCTION [dbo].[Saldo_Cuenta](@Cuenta varchar(max),@mes int,@año int)
