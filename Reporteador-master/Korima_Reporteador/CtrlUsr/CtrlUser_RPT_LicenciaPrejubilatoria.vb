...
Public Class CtrlUser_RPT_LicenciaPrejubilatoria
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_LicenciaPrejubilatoria()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Trabajadores que Tramitaron Licencia Prejubilatoria en el Periodo"
            '.lblFechaRango.Text = ""
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= '" & "Licencia Prejubilatoria FONE" & "'", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = " & "'" & "Licencia Prejubilatoria FONE" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
