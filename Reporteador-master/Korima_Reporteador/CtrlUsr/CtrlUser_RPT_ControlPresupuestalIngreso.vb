...
Public Class CtrlUser_RPT_ControlPresupuestalIngreso
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_ControlPresupuestalIngreso
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Control Presupuestal Ingreso' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblTitulo.Text = "Control Presupuestal del Ingreso"
            ...
            'Else
            .lblRptDescripcionFiltrado.Text = "Periodo: del 1/" & filterPeriodoIni.Time.Month.ToString & "/" & filterEjercicio.Time.Year.ToString & " Al " & DateTime.DaysInMonth(filterEjercicio.Time.Year, filterPeriodoIni.Time.Month).ToString & "/" & filterPeriodoIni.Time.Month.ToString & "/" & filterEjercicio.Time.Year.ToString
            'End If
