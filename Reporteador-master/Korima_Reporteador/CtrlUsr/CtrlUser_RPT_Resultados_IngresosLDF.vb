...
Public Class CtrlUser_RPT_Resultados_IngresosLDF
    Dim TipoReporte
    ...
    Public reporte As RPT_Resultado_IngresosLDF
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        reporte = New RPT_Resultado_IngresosLDF()
        ...
        Dim command As New SqlCommand("SP_Resultado_Ingresos", conection)
        ...
        adapter.Fill(ds, "SP_Resultado_Ingresos")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_Resultado_Ingresos"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = '" & "LDF Resultado Ingresos" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Resultados de Ingresos-LDF"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='LDF Resultado Ingresos' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
    ...
    Private Sub BarLargeButtonItem1_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs)
        ...
        dlg.Title = "Exporta Resultados de Ingresos"
    ...
    Public Sub BarButtonItem4_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs)
        ...
        frm.Text = "Resultados de Ingresos"
            ...
            For Each dr As DataRow In frm.dsNotas.Tables(0).Rows
                For j As Integer = i To ds.Tables(0).Rows.Count
                    If ds.Tables(0).Rows(j)("Concepto") = dr("Concepto") Then
                        ds.Tables(0).Rows(j)("AñoVigente") = dr("AñoVigente")
