...
Public Class CtrlUser_RPT_Estado_Situacion_FinancieraV2

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        Dim reporte As New RPT_EstadoSituacionFinancieraV2
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_Estado_Situacion_Financiera", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_K2_Estado_Situacion_Financiera")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_Estado_Situacion_Financiera"


        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Estado de Cambios en la Situación Financiera' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptDescripcionFiltrado.Text = "Del 01/01/" + filterPeriodoAl.Time.Year.ToString + " Al " + lastDay.AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") '"Ejercicio " + filterPeriodoAl.Text + " Período " + filterPeriodoDe.Text
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Estado de Cambios en la Situación Financiera' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
