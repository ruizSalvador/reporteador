...
Public Class CtrlUser_RPT_FacturasRecibidas
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_Facturasrecibidas
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_FacturasRecibidas", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_K2_FacturasRecibidas")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_FacturasRecibidas"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Facturas Recibidas"
            .lblTitulo.Text = ""
