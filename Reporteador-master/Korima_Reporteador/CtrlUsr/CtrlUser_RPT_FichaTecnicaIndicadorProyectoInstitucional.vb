...
Public Class CtrlUser_RPT_FichaTecnicaIndicadorProyectoInstitucional
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_FichaTecnicaIndicadorProyectoInstitucional
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("RPT_FichaTecnicaIndicadorProyectoInstitucional", SQLConexion)
        ...
        adapter.Fill(ds, "RPT_FichaTecnicaIndicadorProyectoInstitucional")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "RPT_FichaTecnicaIndicadorProyectoInstitucional"
