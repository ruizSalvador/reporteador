...
Public Class CtrlUser_RPT_AnaliticodelactivoPorRangoRepFed
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        adapter.Fill(ds, "SP_RPT_K2_AnaliticoActivoPorRango")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_AnaliticoActivoPorRango"

        'subreporte 

        Dim SQLComando2 As New SqlCommand("SP_RPT_K2_AnaliticoActivoPorRango", SQLConexion)
        SQLComando2.CommandType = CommandType.StoredProcedure
        SQLComando2.Parameters.Add(New SqlParameter("@Miles", ChkMiles.Checked))
        SQLComando2.Parameters.Add(New SqlParameter("@Totales", 0))
        SQLComando2.Parameters.Add(New SqlParameter("@PeriodoFinal", filterPeriodoAl.Time.Month))
        ...
        SQLComando2.Parameters.Add(New SqlParameter("@PeriodoInicial", filterPeriodoDe.Time.Month))
        ...
        adapterB.Fill(dsB, "SP_RPT_K2_AnaliticoActivoPorRango")
        reporte.subreport1.ReportSource.DataSource = dsB
        reporte.subreport1.ReportSource.DataAdapter = adapterB
        reporte.subreport1.ReportSource.DataMember = "SP_RPT_K2_AnaliticoActivoPorRango"
