...
Public Class CtrlUser_RPT_PolizasFuenteFinanciamiento
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_PolizasFuenteFinanciamiento()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_PolizasFuenteFinanciamiento", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_PolizasFuenteFinanciamiento")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_PolizasFuenteFinanciamiento"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "REPORTE DE POLIZAS"
            '.lblFechaRango.Text = ""
