...
Public Class CtrlUser_RPT_EstadodelEjerciciodelPresupuestoGral4
    ...
    Public Function AsignaReporte() As Object
        ...
        Select Case REPORTE
            ...
            Case 1
                Me.nomREPORTE = "Estado del Ejercicio del Presupuesto de Ingresos"
                ...
                rpt = New RPT_EstadodelEjerciciodelPresupuestoGral2()
                Return rpt
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_EstadoEjercicioPresupuestoING", SQLConexion)
        ...
        If ChkAnual.Checked = True Then
            ...
            SQLComando.Parameters.Add(New SqlParameter("@Todo", chkAll.Checked))
        ...
        adapter.Fill(ds, "SP_RPT_EstadoEjercicioPresupuestoING")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_EstadoEjercicioPresupuestoING"
        SQLComando.Dispose()
        SQLConexion.Close()
