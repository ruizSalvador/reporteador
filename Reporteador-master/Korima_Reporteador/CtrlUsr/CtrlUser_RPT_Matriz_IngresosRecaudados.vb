...
Public Class CtrlUser_RPT_Matriz_IngresosRecaudados
    Dim TipoReporte
    ...
    Public reporte As RPT_MatrizIngresosRecaudados
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_MatrizIngresosRecaudados
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_MatrizIngresosRecaudados", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_MatrizIngresosRecaudados")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_MatrizIngresosRecaudados"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "B2 Matriz de ingresos recaudados"
            .lblTitulo.Text = ""
