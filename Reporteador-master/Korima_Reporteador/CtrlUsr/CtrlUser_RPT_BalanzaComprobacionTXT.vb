...
Public Class CtrlUser_RPT_BalanzaComprobacionTXT
    ...
    Private Sub SimpleButton4_Click(sender As System.Object, e As System.EventArgs) Handles SimpleButton4.Click
        ...
        Try
            ...
            If FolderBrowserDialog1.SelectedPath <> "" And d = DialogResult.OK Then
                ...
                PathArchivo = FolderBrowserDialog1.SelectedPath + "\CP01" + Año + IdMunicipio + ".txt"
                ...
                Dim SP As String = "SP_BalanzaComprobaciónTXT"
                ...
                For Each curr As DataRow In tbl.Rows
                    ...
                    strStreamWriter.WriteLine(IdMunicipio + ";" + curr(0).ToString + ";" + curr(1).ToString + ";" + curr(2).ToString + ";" + curr(3).ToString + ";" + curr(5).ToString + ";" + curr(6).ToString + ";" + curr(7).ToString + ";" + curr(8).ToString)
                Next
