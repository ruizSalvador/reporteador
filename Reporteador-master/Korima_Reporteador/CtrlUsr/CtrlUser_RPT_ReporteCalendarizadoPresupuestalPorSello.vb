...
Public Class CtrlUser_RPT_ReporteCalendarizadoPresupuestalPorSello
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_ReporteCalendarizadoPresupuestalPorSello()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_ReporteCalendarizadoPresupuestalPorSello", SQLConexion)
        ...
        If filterUnidadResponsable2.Text = "" Then
            SQLComando.Parameters.Add(New SqlParameter("@ClaveUR2", 100000))
        ...
        adapter.Fill(ds, "SP_RPT_ReporteCalendarizadoPresupuestalPorSello")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_ReporteCalendarizadoPresupuestalPorSello"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = txtTitle.Text '"REPORTE CALENDARIZADO PRESUPUESTAL (HASTA 4° NIVEL)"
            .XrLabel1.Text = "" '"Fuente de Financiamiento: " + filterFuenteFinanciamiento.Text
            '.lblFechaRango.Text = ""
            .lblTitulo.Text = cmbPresupuesto.Text '"Clasificación por Objeto del Gasto (Capitulo y Concepto)"
