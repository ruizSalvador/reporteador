...
Public Class CtrlUser_RPT_ClasifFuncFinalidadFuncion
    Dim TipoReporte
    ...
    Public reporte As RPT_ClasifFuncionalFinalidadFuncion
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim command As New SqlCommand("SP_RPT_ClasificacionFuncional_finalidadFuncion", conection)
        ...
        adapter.Fill(ds, "SP_RPT_ClasificacionFuncional_finalidadFuncion")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_ClasificacionFuncional_finalidadFuncion"
