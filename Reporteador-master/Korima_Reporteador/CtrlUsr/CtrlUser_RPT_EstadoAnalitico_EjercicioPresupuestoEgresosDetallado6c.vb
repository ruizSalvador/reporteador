...
Public Class CtrlUser_RPT_EstadoAnalitico_EjercicioPresupuestoEgresosDetallado6c
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_EstadoAnalitico_EjercicioPresupuestoEgresosDetallado6c
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_ClasificacionFuncional_finalidadFuncion", SQLConexion)
        ...
        With reporte
            ...
            If ChkAnual.Checked = True Then
                .lblRptDescripcionFiltrado.Text = "Del 1 de Enero" & " Al " + ultimo.Day.ToString + " de Diciembre" & filterEjercicio.Time.Year.ToString
            Else
                '.lblRptDescripcionFiltrado.Text = "Del 1 de enero" & " Al 31 de " & filterPeriodoFin.Time.Month.ToString & " de " & filterEjercicio.Time.Year.ToString
