...
Public Class CtrlUser_RPT_AnaliticodelPasivo
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_AnaliticoPasivo", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_K2_AnaliticoPasivo")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_AnaliticoPasivo"

        'subreporte 

        Dim SQLComando2 As New SqlCommand("SP_RPT_K2_AnaliticoPasivo", SQLConexion)
        ...
        adapterB.Fill(dsB, "SP_RPT_K2_AnaliticoPasivo")
        reporte.subreport1.ReportSource.DataSource = dsB
        reporte.subreport1.ReportSource.DataAdapter = adapterB
        reporte.subreport1.ReportSource.DataMember = "SP_RPT_K2_AnaliticoPasivo"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Analitico del pasivo' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Estado Analitico del Pasivo"
            ...
            '.lblRptDescripcionFiltrado.Text = "Del " + lastDay.ToString("dd/MM/yyyy") + " Al " + lastDay.AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") '"Periodo: " & MesLetra(Month(filterPeriodoDe.EditValue)) & " Del " & Year(FilterEjercicio.EditValue).ToString
            .lblRptDescripcionFiltrado.Text = "Del 01/01/" + FilterEjercicio.Time.Year.ToString + " Al " + lastDay.AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") '"Periodo: " & MesLetra(Month(filterPeriodoDe.EditValue)) & " Del " & Year(FilterEjercicio.EditValue).ToString

            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Analitico del pasivo' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
