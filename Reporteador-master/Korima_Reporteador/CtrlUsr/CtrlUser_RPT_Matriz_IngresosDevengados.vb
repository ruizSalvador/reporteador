...
Public Class CtrlUser_RPT_Matriz_IngresosDevengados
    Dim TipoReporte
    ...
    Public reporte As RPT_MatrizIngresosDevengados
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_MatrizIngresosDevengados
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_MatrizIngresosDevengados", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_MatrizIngresosDevengados")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_MatrizIngresosDevengados"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "B1 Matriz de ingresos devengados"
            .lblTitulo.Text = ""
