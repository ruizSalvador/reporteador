...
Public Class CtrlUser_RPT_FlujoDeEfectivo_EF

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        Dim reporte As New RPT_FlujoDeEfectivo_EF()
        ...
        If CheckBox1.Checked = True Then
            SP = "SP_RPT_Flujo_de_Efectivo_2_EF"
        Else
        ...
        With reporte
            ...
            Else
                .lblRptDescripcionFiltrado.Text = "Del 01/01/" & filterPeriodoAl.Text & " al " & lastDay.AddMonths(1).AddDays(-1) '"Del " & lastDay & " al " & lastDay.AddMonths(1).AddDays(-1)
            End If
