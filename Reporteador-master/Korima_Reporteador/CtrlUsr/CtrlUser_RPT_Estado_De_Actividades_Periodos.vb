...
Public Class CtrlUser_RPT_Estado_De_Actividades_Periodos

    Dim reporte As RPT_Estado_De_Actividades_Periodos
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim SP As String = "REPORTE_Estado_De_ActividadesRedondeo_Periodos"
        reporte = New RPT_Estado_De_Actividades_Periodos()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Estado de actividades' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
        ...
        Ultimo = Date.DaysInMonth((CDate(filterPeriodoAl.EditValue)).Year, (CDate(filterPeriodo2.EditValue)).Month) & "/" & Format((CDate(filterPeriodo2.EditValue)).Month, "0#") & "/" & (CDate(filterPeriodoAl.EditValue)).Year
        'Dim reporte = New Object()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Estado De Actividades por Periodos"
