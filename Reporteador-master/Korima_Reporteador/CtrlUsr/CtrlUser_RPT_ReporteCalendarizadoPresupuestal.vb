...
Public Class CtrlUser_RPT_ReporteCalendarizadoPresupuestal
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_ReporteCalendarizadoPresupuestal()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_ReporteCalendarizadoPresupuestal", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_ReporteCalendarizadoPresupuestal")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_ReporteCalendarizadoPresupuestal"
        SQLComando.Dispose()
        SQLConexion.Close()
