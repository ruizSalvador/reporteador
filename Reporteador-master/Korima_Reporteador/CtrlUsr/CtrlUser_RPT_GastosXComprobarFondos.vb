...
Public Class CtrlUser_RPT_GastosXComprobarFondos
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_GastosXComprobarFondos()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_GastosXComprobar_FondosRevolventes", SQLConexion)
        ...
        SQLComando.Parameters.Add(New SqlParameter("@Tipo", cmbTipo.SelectedIndex))
        

        Dim adapter As New SqlDataAdapter(SQLComando)
        Dim ds As New DataSet()
        ds.EnforceConstraints = False
        adapter.Fill(ds, "SP_RPT_GastosXComprobar_FondosRevolventes")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_GastosXComprobar_FondosRevolventes"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "COMPROBACIÓN DE GASTOS"
            '.lblFechaRango.Text = ""
