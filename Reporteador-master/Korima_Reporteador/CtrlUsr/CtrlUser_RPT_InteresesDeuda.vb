...
Public Class CtrlUser_RPT_InteresesDeuda

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        ErrorProvider1.Clear()
        Dim reporte As New RPT_InteresesDeuda
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_InteresesDeuda", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_K2_InteresesDeuda")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_InteresesDeuda"
        ...
        With reporte
            ...
            .lblTitulo.Text = ""
            .lblRptNombreReporte.Text = "Intereses de la Deuda"
