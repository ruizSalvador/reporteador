...
Public Class CtrlUser_RPT_Relacion_Analitica_De_Terrenos

    Dim reporte As RPT_Relacion_Analitica_De_Terrenos
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim SP As String = "SP_RPT_Relacion_Analitica_Terrenos_ISAF"
        reporte = New RPT_Relacion_Analitica_De_Terrenos()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Relacion Analitica de Terrenos ISAF' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Relación Analítica de Terrenos"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Relacion Analitica de Terrenos ISAF' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
