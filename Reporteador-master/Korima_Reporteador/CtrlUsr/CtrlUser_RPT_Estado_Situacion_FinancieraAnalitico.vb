...
Public Class CtrlUser_RPT_Estado_Situacion_FinancieraAnalitico
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_Estado_Situacion_FinancieraAnalitico
        SPTotales = "SP_RPT_K2_Estado_Situacion_FinancieraAnalitico"
        SP = "SP_RPT_K2_Estado_Situacion_FinancieraAnalitico"
        ...
        SQLComando.Parameters.Add(New SqlParameter("@Año2", Year(filterPeriodoAl2.EditValue)))
        ...
        SQLComandoA.Parameters.Add(New SqlParameter("@Mes2", Month(filterPeriodoDe2.EditValue)))
        SQLComandoA.Parameters.Add(New SqlParameter("@Año2", Year(filterPeriodoAl2.EditValue)))
        ...
        SQLComandoB.Parameters.Add(New SqlParameter("@Mes2", Month(filterPeriodoDe2.EditValue)))
        SQLComandoB.Parameters.Add(New SqlParameter("@Año2", Year(filterPeriodoAl2.EditValue)))
        ...
        adapterD = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Estado de Situación Financiera Analítico' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Estado de Situación Financiera Analítico"
            .lblFechaRango.Text = ""
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Estado de Situación Financiera Analítico' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
