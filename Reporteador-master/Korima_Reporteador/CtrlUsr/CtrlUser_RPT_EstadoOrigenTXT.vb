...
Public Class CtrlUser_RPT_EstadoOrigenTXT
    ...
    Private Sub SimpleButton4_Click(sender As System.Object, e As System.EventArgs) Handles SimpleButton4.Click
        ...
        Try
            ...
            If FolderBrowserDialog1.SelectedPath <> "" And d = DialogResult.OK Then
                ...
                PathArchivo = FolderBrowserDialog1.SelectedPath + "\" + Nomenclatura + "ESTADO" + Mes + Año + ".txt"
                ...
                For Each curr As DataRow In tbl.Rows
                    strStreamWriter.WriteLine(IdMunicipio + "|" + Año + "|" + Mes + "|" + curr(0).ToString + "|" + curr(1).ToString + "|" + curr(2).ToString)
                Next
