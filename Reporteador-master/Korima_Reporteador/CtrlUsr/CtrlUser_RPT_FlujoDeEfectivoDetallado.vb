...
Public Class CtrlUser_RPT_FlujoDeEfectivoDetallado

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        Dim reporte As New RPT_FlujoDeEfectivoDetallado()
        ...
        Else
            SP = "sp_rpt_flujo_de_efectivoRedondeoDetallado"
        End If
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Estado de Flujos de Efectivo Detallado"
