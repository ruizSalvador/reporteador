...
Public Class CtrlUser_RPT_AplicacionRecursosFORTAMUN_Detallado
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_AplicaciónRecursosFORTAMUNDetallado
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_AplicaciónRecursosFORTAMUNDetallado", SQLConexion)
        SQLComando.CommandType = CommandType.StoredProcedure
        SQLComando.Parameters.Add(New SqlParameter("@Mes", MesInicio))
        SQLComando.Parameters.Add(New SqlParameter("@Mes2", MesFin))
        ...
        SQLComando.Parameters.Add(New SqlParameter("@IdFF", FilterCuentaAfectable.EditValue))
        'SQLComando.Parameters.Add(New SqlParameter("@ClaveFF", ""))
        SQLComando.Parameters.Add(New SqlParameter("@IdArea", 0))
        SQLComando.Parameters.Add(New SqlParameter("@AmpRedAnual", 0))
        ...
        adapter.Fill(ds, "SP_RPT_AplicaciónRecursosFORTAMUNDetallado")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_AplicaciónRecursosFORTAMUNDetallado"
