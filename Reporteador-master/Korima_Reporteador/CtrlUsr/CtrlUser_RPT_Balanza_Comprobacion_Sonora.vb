...
Public Class CtrlUser_RPT_Balanza_Comprobacion_Sonora

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        Dim reporte As New RPT_Balanza_Comprobacion_Sonora()
        ...
        FiltroSQL2 &= "    Mes = " & Month(filterPeriodoDe.EditValue) & " And [Year] = " & Year(filterPeriodoAl.EditValue) & ""
        ...
        Dim strFiltroSubreporte = "SELECT SUM(CargosSinFlujo) as CargosSinFlujo ,SUM(AbonosSinFlujo)as AbonosSinFlujo ,SUM(totalcargos) as TotalCargos, SUM(TotalAbonos) as TotalAbonos,SUM(SaldoDeudor)as SaldoDeudor,SUM(SaldoAcreedor)as SaldoAcreedor, " _
                                  & "(Select SUM(TotalCargos) FROM VW_RPT_K2_Balanza_De_Comprobacion WHERE  " & FiltroSQL2 & " and Afectable=1 and " _
                                  & "([NumeroCuenta] like '4%'  Or [NumeroCuenta] like '5%' Or [NumeroCuenta] like '6%' Or [NumeroCuenta] like '7%' Or [NumeroCuenta] like '8%' Or [NumeroCuenta] like '9%')) as TotalCargosIngEgr, " _
                                  & "(Select SUM(TotalAbonos) FROM VW_RPT_K2_Balanza_De_Comprobacion WHERE  " & FiltroSQL2 & " and Afectable=1 and" _
                                  & "([NumeroCuenta] like '4%'  Or [NumeroCuenta] like '5%' Or [NumeroCuenta] like '6%' Or [NumeroCuenta] like '7%' Or [NumeroCuenta] like '8%' Or [NumeroCuenta] like '9%')) as TotalAbonosIngEgr, " _
                                  & "(Select SUM(SaldoDeudor) FROM VW_RPT_K2_Balanza_De_Comprobacion WHERE  " & FiltroSQL2 & " and Afectable=1 and " _
                                  & "([NumeroCuenta] like '1%'  Or [NumeroCuenta] like '2%' Or [NumeroCuenta] like '3%')) as SaldoDeudorPrevia, " _
                                  & "(Select SUM(SaldoAcreedor) FROM VW_RPT_K2_Balanza_De_Comprobacion WHERE  " & FiltroSQL2 & " and Afectable=1 and " _
                                  & "([NumeroCuenta] like '1%'  Or [NumeroCuenta] like '2%' Or [NumeroCuenta] like '3%')) as SaldoAcreedorPrevia " _
                                  & "FROM VW_RPT_K2_Balanza_De_Comprobacion WHERE " & FiltroSQL2 & " and Afectable=1 "
        ...
        With reporte
            ...
            .lblSaldos.Text = "01 DE ENERO DE " + filterPeriodoAl.Text
            .lblMovimientos.Text = "ANUAL " + filterPeriodoAl.Text
            .lblSaldos2.Text = "31 DE DICIEMBRE DE " + filterPeriodoAl.Text
