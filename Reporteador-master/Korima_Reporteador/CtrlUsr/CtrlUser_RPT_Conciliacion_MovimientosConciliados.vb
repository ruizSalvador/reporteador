...
Public Class CtrlUser_RPT_Conciliacion_MovimientosConciliados
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_Conciliacion_MovimientosConciliados
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_Conciliacion_MovimientosConciliados", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_K2_Conciliacion_MovimientosConciliados")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_Conciliacion_MovimientosConciliados"
        ...
        With reporte
            ...
            .lblTitulo.Text = "Movimientos Conciliados"

            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Movimientos Conciliados' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
