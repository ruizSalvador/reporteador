...
Public Class CtrlUser_RPT_InformacionProgramaticaPresupuestalAnualTXT
    ...
    Private Sub SimpleButton4_Click(sender As System.Object, e As System.EventArgs) Handles SimpleButton4.Click
        ...
        Try
            ...
            If FolderBrowserDialog1.SelectedPath <> "" And d = DialogResult.OK Then
                ...
                PathArchivo = FolderBrowserDialog1.SelectedPath + "\CP17" + Año + IdMunicipio + ".txt"
                ...
                SQLComando.Parameters.Add(New SqlParameter("@Trimestre", 0))
                ...
                For Each curr As DataRow In tbl.Rows
                    strStreamWriter.WriteLine(IdMunicipio + ";" + IdDependencia + ";" + curr(0).ToString + ";" + curr(1).ToString)
                Next
