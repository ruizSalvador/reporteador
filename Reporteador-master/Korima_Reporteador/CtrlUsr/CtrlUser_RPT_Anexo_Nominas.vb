...
Public Class CtrlUser_RPT_Anexo_Nominas
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        'ErrorProvider1.Clear()
        Dim reporte As New RPT_Anexo_Nominas
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("RPT_SP_Anexo_Nominas", SQLConexion)
        ...
        adapter.Fill(ds, "RPT_SP_Anexo_Nominas")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "RPT_SP_Anexo_Nominas"
