...
Public Class CtrlUser_RPT_Formato_Gral_SP
    'Dim strFirmas
    'Dim strTitulo
    'Public strReporte
    ...
    Dim reporte As RPT_Formato_Gral_SP

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New RPT_Formato_Gral_SP()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_Formato_Gral_SP", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_Formato_Gral_SP")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_Formato_Gral_SP"
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Formato Gral. de Aplicación de Recursos a Seguridad Pública' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            .lblRptEntidadFederativa.Text = "Formato General"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= 'Formato Gral. de Aplicación de Recursos a Seguridad Pública'", New SqlConnection(cnnString))
            cmd.Connection.Open()
