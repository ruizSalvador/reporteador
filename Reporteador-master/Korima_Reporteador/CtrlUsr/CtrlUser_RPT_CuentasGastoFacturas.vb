...
Public Class CtrlUser_RPT_CuentasGastoFacturas
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_CuentasGastoFactura
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_CuentasGastoFactura", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_CuentasGastoFactura")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_CuentasGastoFactura"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Cuentas de Gasto por Factura"
            ...
            adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = " & "'" & "Cuentas de Gasto por Factura" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Cuentas de Gasto por Factura' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
