...
Public Class CtrlUser_RPT_EstadoEjercicio_PresupuestoEgresoDetallado
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_EstadoEjercicio_PresupuestoDetallado
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_EstadoEjercicio_PresupuestoEgresosDetallado", SQLConexion)
        ...
        With reporte
            ...
            .lblTitulo.Text = "Clasificacion de Servicios Presupuestales por Categoria"
            .lblRptNombreReporte.Text = "Estado Analitico del Ejercicio de Egresos Detallado -LDF"
            ...
            'Dim primero As Date = New DateTime(filterPeriodoIni.Time.Year, filterEjercicio.Time.Month, 1)
            ' Dim ultimo As Date = New DateTime(filterPeriodoFin.Time.Year, filterEjercicio.Time.Month, 1)
            ...
            If ChkAnual.Checked = True Then
                .lblRptDescripcionFiltrado.Text = "Del 1 de enero" & " Al " + ultimo.Day.ToString + " de diciembre del " & filterEjercicio.Time.Year.ToString
            Else
                '.lblRptDescripcionFiltrado.Text = "Del 1 de  enero" & " Al 31 del " & filterPeriodoFin.Time.Month.ToString & " del " & filterEjercicio.Time.Year.ToString
