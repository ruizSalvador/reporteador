...
Public Class CtrlUser_RPT_Relacion_Analitica_Bancos_Tesoreria

    Dim reporte As RPT_Relacion_Analitica_Banco_Tesoreria
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim SP As String = "SP_RPT_Relacion_Analitica_Bancos_Tesoreria_ISAF"
        reporte = New RPT_Relacion_Analitica_Banco_Tesoreria()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Relacion Analitica Bancos y Tesoreria ISAF' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "RELACIÓN ANALÍTICA DE BANCOS/TESORERÍA"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Relacion Analitica Bancos y Tesoreria ISAF' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
