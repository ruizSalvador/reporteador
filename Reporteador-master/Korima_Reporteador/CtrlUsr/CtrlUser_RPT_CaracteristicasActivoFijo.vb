...
Public Class CtrlUser_RPT_CaracteristicasActivoFijo
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_CaracteristicasActivoFijo()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_ConsultaActivos", SQLConexion)
        SQLComando.CommandType = CommandType.StoredProcedure
        SQLComando.CommandTimeout = 0

        '--- Parametros IN

        If FilterTipoBien.Text = "" Then
            SQLComando.Parameters.Add(New SqlParameter("@IdTipoBien", 0))
        Else
            SQLComando.Parameters.Add(New SqlParameter("@IdTipoBien", FilterTipoBien.EditValue))
        End If
        ...
        adapter.Fill(ds, "SP_ConsultaActivos")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_ConsultaActivos"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "CARACTERÍSTICAS ACTIVO FIJO"
            '.lblFechaRango.Text = ""
            .lblSubtitulo.Text = ""
            .lblRptDescripcionFiltrado.Text = "Características de Activo Fijo hasta " + MesLetra(Month(DateTime.Now)) + " del " + Year(DateTime.Now).ToString()
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= '" & "Caracteristicas Activo Fijo" & "'", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = " & "'" & "Caracteristicas Activo Fijo" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
    ...
    Private Sub CtrlUser_RPT_Adquisiciones_OrdenCompraPartida_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With FilterTipoBien.Properties
            .DataSource = ObjTempSQL.List("", 0, "C_TipoBien", " Order by IdTipoBien ")
    ...
    Private Sub FilterTipoBien_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles FilterTipoBien.GotFocus
    ...
    Private Sub SimpleButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton2.Click
        FilterTipoBien.Properties.DataSource = Nothing
        FilterTipoBien.Properties.NullText = ""
    End Sub
