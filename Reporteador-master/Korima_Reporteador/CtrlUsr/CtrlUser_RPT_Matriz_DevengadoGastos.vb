...
Public Class CtrlUser_RPT_Matriz_DevengadoGastos
    Dim TipoReporte
    ...
    Public reporte As RPT_MatrizDevengadoGastos
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_MatrizDevengadoGastos
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_MatrizDevengadoGastos", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_MatrizDevengadoGastos")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_MatrizDevengadoGastos"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "A1 Matriz de Devengado de Gastos"
            .lblTitulo.Text = ""
