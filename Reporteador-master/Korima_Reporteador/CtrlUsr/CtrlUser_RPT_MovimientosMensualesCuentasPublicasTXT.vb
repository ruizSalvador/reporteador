...
Public Class CtrlUser_RPT_MovimientosMensualesCuentasPublicasTXT
    ...
    Private Sub SimpleButton4_Click(sender As System.Object, e As System.EventArgs) Handles SimpleButton4.Click
        ...
        Try
            ...
            If FolderBrowserDialog1.SelectedPath <> "" And d = DialogResult.OK Then
                ...
                PathArchivo = FolderBrowserDialog1.SelectedPath + "\" + Nomenclatura + "MOV" + Mes + Año + ".txt"
                ...
                adapter = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_MovimientosMensualesCuentasPublicasTXT WHERE Mes= " + Mes + "AND Year=" + Año + " Order By NumeroCuenta ", cnnString)
                Dim ds As New DataSet()
                ds.EnforceConstraints = False
                adapter.FillSchema(ds, SchemaType.Source, "VW_RPT_K2_MovimientosMensualesCuentasPublicasTXT")
                adapter.Fill(ds, "VW_RPT_K2_MovimientosMensualesCuentasPublicasTXT")
                Dim tbl As DataTable
                tbl = ds.Tables(0)
                For Each curr As DataRow In tbl.Rows
                    strStreamWriter.WriteLine(IdMunicipio + "|" + Año + "|" + Mes + "|" + curr(0).ToString + "|" + curr(1).ToString + "|" + curr(2).ToString + "|" + curr(3).ToString + "|" + curr(4).ToString)
                Next
