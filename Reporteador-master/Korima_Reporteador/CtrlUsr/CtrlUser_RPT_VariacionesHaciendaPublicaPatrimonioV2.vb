...
Public Class CtrlUser_RPT_VariacionesHaciendaPublicaPatrimonioV2
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        SP = "SP_RPT_K2_VariacionesHaciendaPublicaPatrimonioV2"
        ...
        '******* Firmas ******
        Dim adapterC As New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Estado de Variación en la Hacienda Pública' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptDescripcionFiltrado.Text = "Del 01/01/" & filterPeriodoAl.Time.Year.ToString & " al " & Ultimo
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Estado de Variación en la Hacienda Pública' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
