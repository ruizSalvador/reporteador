...
Public Class CtrlUser_RPT_IngresosPorRecaudar
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_IngresosXRecaudar()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_IngresosXRecaudar", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_IngresosXRecaudar")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_IngresosXRecaudar"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "INGRESOS POR RECAUDAR"
            '.lblFechaRango.Text = ""
