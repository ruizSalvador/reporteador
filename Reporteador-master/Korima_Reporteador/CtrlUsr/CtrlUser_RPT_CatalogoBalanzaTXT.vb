...
Public Class CtrlUser_RPT_CatalogoBalanzaTXT
    ...
    Private Sub SimpleButton4_Click(sender As System.Object, e As System.EventArgs) Handles SimpleButton4.Click
        ...
        Try
            ...
            If FolderBrowserDialog1.SelectedPath <> "" And d = DialogResult.OK Then
                ...
                PathArchivo = FolderBrowserDialog1.SelectedPath + "\A1" + trimestre + Año + IdMunicipio + ".txt"
                ...
                Dim SP As String = "SP_CatalogoBalanzaTXT"
                ...
                For Each curr As DataRow In tbl.Rows
                    'strStreamWriter.WriteLine(IdMunicipio + ";" + Año + ";" + Mes + ";" + curr(0).ToString + ";" + curr(1).ToString + ";" + curr(2).ToString + ";" + curr(3).ToString + ";" + curr(4).ToString + ";" + curr(5).ToString + ";" + curr(6).ToString + ";" + curr(7).ToString + ";" + curr(8).ToString + ";" + curr(9).ToString + ";" + curr(10).ToString + ";" + curr(11).ToString + ";" + curr(12).ToString + ";" + curr(13).ToString + ";" + curr(14).ToString)
                    strStreamWriter.WriteLine(IdMunicipio + ";" + curr(0).ToString + ";" + curr(1).ToString + ";" + curr(2).ToString + ";" + curr(3).ToString + ";" + curr(5).ToString + ";" + curr(6).ToString + ";" + curr(7).ToString + ";" + curr(8).ToString + ";" + curr(9).ToString + ";" + curr(10).ToString + ";" + curr(11).ToString + ";" + curr(12).ToString)
                Next
