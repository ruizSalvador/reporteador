...
Public Class CtrlUser_RPT_EgresosClasificacionAdministrativaParaestatal
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_EgresosClasificacionAdministrativaParaestatal
...
#End If
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_EgresosClasificacionAdministrativaParaestatal", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_K2_EgresosClasificacionAdministrativaParaestatal")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_EgresosClasificacionAdministrativaParaestatal"
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Estado Analítico del Ejercicio del Presupuesto de Egresos Sector Paraestatal' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        'adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Clasificacion Administrativa-Sector Paraestatal' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Estado Analítico del Ejercicio del Presupuesto de Egresos Sector Paraestatal' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
