...
Public Class CtrlUser_RPT_CategoriasTabuladores
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_CategoriasTabuladores()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_CategoriasTabuladores", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_CategoriasTabuladores")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_CategoriasTabuladores"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Catálogo de Categorías y Tabuladores"
            '.lblFechaRango.Text = ""
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= '" & "Catálogo de Categorías y Tabuladores FONE" & "'", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = " & "'" & "Catálogo de Categorías y Tabuladores FONE" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
