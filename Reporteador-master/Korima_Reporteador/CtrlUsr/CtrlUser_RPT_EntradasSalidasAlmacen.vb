...
Public Class CtrlUser_RPT_EntradasSalidasAlmacen
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_EntradasSalidasAlmacen
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_EntradaSalidasAlmacen", SQLConexion)
        ...
        SQLComando.Parameters.Add(New SqlParameter("@IdPartida", IIf(ComboSubClases.Text = "", DBNull.Value, ComboSubClases.EditValue)))
        ...
        adapter.Fill(ds, "SP_RPT_EntradaSalidasAlmacen")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_EntradaSalidasAlmacen"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Entradas/Salidas de Almacén"
