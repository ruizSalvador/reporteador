...
Public Class CtrlUser_RPT_EstadoEjercicioIngresos_CE_Rubro_Tipo_Clase_Concepto
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_EstadoEjercicioIngresos_CE_Rubro_Tipo_Clase_Concepto
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_EstadoEjercicioIngresos_CE_Rubro_Tipo_Clase_Concepto", SQLConexion)
        ...
        'SQLComando.Parameters.Add(New SqlParameter("@RedAmpAcum", chkAmpRed.Checked))
        ...
        adapter.Fill(ds, "SP_EstadoEjercicioIngresos_CE_Rubro_Tipo_Concepto")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_EstadoEjercicioIngresos_CE_Rubro_Tipo_Concepto"
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Por Clasificación Economica/Rubro/Tipo/Clase/Concepto' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblTitulo.Text = "Clasificación económica / Rubro / Tipo / Clase / Concepto"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Por Clasificación Economica/Rubro/Tipo/Clase/Concepto' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
