...
Public Class CtrlUser_RPT_Padron_Proveedores
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_Padron_Proveedores
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("RPT_SP_Padron_Proveedores", SQLConexion)
        ...
        adapter.Fill(ds, "RPT_SP_Padron_Proveedores")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "RPT_SP_Padron_Proveedores"
        ...
        With reporte
            ...
            .lblSubtitulo.Text = "Ejercicio: " & filterEjercicio.Time.Year.ToString
