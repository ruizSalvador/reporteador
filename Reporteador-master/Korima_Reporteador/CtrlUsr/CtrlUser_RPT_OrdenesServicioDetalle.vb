...
Public Class CtrlUser_RPT_OrdenesServicioDetalle
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_OrdenesServicioDetalle
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_OrdenesServicioDetalle", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_OrdenesServicioDetalle")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_OrdenesServicioDetalle"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Órdenes de Servicio Detalle' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Órdenes de Servicios"
            .lblTitulo.Text = ""
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Órdenes de Servicio Detalle' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
    ...
    Private Sub filterProveedor_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles FilterProv.GotFocus
        ...
        With FilterProv.Properties
            .DataSource = ObjTempSQL2.List(" Periodo = " & FilterYear.Text, 0, " T_OrdenServicio ", " Order by Folio ")
            .DisplayMember = "Folio"
            .ValueMember = "Folio"
