...
Public Class CtrlUser_RPT_EndeudamientoNeto

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        ErrorProvider1.Clear()
        Dim reporte As New RPT_EndeudamientoNeto
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_EndeudamientoNeto", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_K2_EndeudamientoNeto")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_EndeudamientoNeto"
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Endeudamiento Neto' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblTitulo.Text = ""
            .lblRptNombreReporte.Text = "Endeudamiento Neto"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Endeudamiento Neto' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
