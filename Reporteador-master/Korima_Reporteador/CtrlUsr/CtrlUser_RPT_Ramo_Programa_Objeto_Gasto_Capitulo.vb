...
Public Class CtrlUser_RPT_Ramo_Programa_Objeto_Gasto_Capitulo
    ...
    Public Function AsignaReporte() As Object
        ...
        Select Case REPORTE
            ...
            Case 14
                Me.nomREPORTE = "Informe Administrativo sobre el Ejercicio del Presupuesto de Egresos"
                Me.TITULO = "Ramo - Programa - Objeto del gasto por Capítulo"
                Me.SUBTITULO = filterRamoDependencia.Text & "-" & filterUnidadResponsable.Text
                Me.nomTipoReporte = "Ejercicio del Presupuesto  "
                Me.nomTipoClaves = "Capítulo"
                Me.nomTipoClaves2 = "Concepto"
                Me.FIRMAS = "Por Ramo/Programa/Objeto del Gasto por Capitulo"
                rpt = New RPT_Ramo_Programa_Objeto_Gasto_Capitulo()
                Me.filterUnidadResponsable.Enabled = True
                Me.CleanUnidadResponsable.Enabled = True
                Me.filterUnidadResponsable.Visible = True
                Me.CleanUnidadResponsable.Visible = True
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_Ramo_Programa_Objeto_Gasto_Capitulo", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_Ramo_Programa_Objeto_Gasto_Capitulo")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_Ramo_Programa_Objeto_Gasto_Capitulo"
        SQLComando.Dispose()
        SQLConexion.Close()
    ...
    Private Sub CtrlUser_RPT_Adquisiciones_OrdenCompraPartida_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With filterPartida.Properties
            .DataSource = ObjTempSQL3.List("", 0, "C_PartidasPres", " Order by ClavePartida ")
