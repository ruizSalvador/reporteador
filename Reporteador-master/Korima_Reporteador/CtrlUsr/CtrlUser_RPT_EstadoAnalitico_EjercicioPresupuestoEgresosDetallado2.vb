...
Public Class CtrlUser_RPT_EstadoAnalitico_EjercicioPresupuestoEgresosDetallado2
    ...
    Private Function MesLetra(ByVal Mes As Integer) As String
        ...
        End Select
    End Function
    Public reporte As RPT_EstadoAnalitico_EjercicioPresupuestoEgresosDetallado2
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        ErrorProvider1.Clear()

        reporte = New RPT_EstadoAnalitico_EjercicioPresupuestoEgresosDetallado2
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_EstadoAnalitico_PresupuestoEgresosDetallado", SQLConexion)
        ...
        adapter.Fill(ds, "SP_EstadoAnalitico_PresupuestoEgresosDetallado")
        'adapter.Fill(ds, "SP_EstadoEjercicio_PresupuestoEgresosDetallado")

        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_EstadoAnalitico_PresupuestoEgresosDetallado"
