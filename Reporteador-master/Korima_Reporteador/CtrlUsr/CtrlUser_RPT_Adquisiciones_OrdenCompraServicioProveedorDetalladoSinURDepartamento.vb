...
Public Class CtrlUser_RPT_Adquisiciones_OrdenCompraServicioProveedorDetalladoSinURDepartamento
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_Adquisiciones_OrdenCompraServicioProveedorDetalladoSinURDepartamento()
        ...
        Dim adapter As New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Adquisiciones_OrdenesCompraServicioDependenciaPartidaProveedor Where " & FiltroSQL & " ORDER BY IdProveedor,PedidosDetalle_OrdenCompra,PedidosDetalle_Fecha,ClavePartida ", cnnString)
        '" ORDER BY IdProveedor,UnidadResponsable_Clave,PedidosDetalle_Fecha,Folio,ClavePartida ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "OC/OS Detallado Por Proveedor"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='OC/OS Detallado Por Proveedor/Unidad Reponsable' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
