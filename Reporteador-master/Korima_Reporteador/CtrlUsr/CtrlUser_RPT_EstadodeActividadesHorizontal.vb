...
Public Class CtrlUser_RPT_EstadodeActividadesHorizontal
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim subrpt As New SUBRPT_EdoActividades
        Dim reporte As New RPT_EstadodeActividadesHorizontal
        SPTotales = "REPORTE_Estado_De_ActividadesRedondeoHor"
        SP = "REPORTE_Estado_De_ActividadesRedondeoHor"
        ...
        reporte.XrSubreport4.ReportSource.FindControl("year2", False).Text = filterPeriodoAl2.Text
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        reporte.XrSubreport1.ReportSource.FindControl("year2", False).Text = filterPeriodoAl2.Text
        ...
        reporte.XrSubreport2.ReportSource.FindControl("year2", False).Text = filterPeriodoAl2.Text
        '---Fin de llenado de reporte
