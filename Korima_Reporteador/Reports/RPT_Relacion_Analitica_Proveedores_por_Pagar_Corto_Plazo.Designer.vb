...
Partial Public Class RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo
    ...
    Private Sub InitializeComponent()
        ...
        Me.label1.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.NumeroCuenta")})
        Me.label1.Dpi = 254.0!
    ...
    "NumeroCuenta] like '5_000-000000'" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10)
        ...
        Me.XrLabel17.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.SaldoFinal", "{0:n2}")})
        ...
        Me.XrLabel16.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.TotalAbonos", "{0:n2}")})
        ...
        Me.XrLabel15.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.TotalCargos", "{0:n2}")})
        ...
        Me.XrLabel10.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.SaldoInicial", "{0:n2}")})
        ...
        Me.label10.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.Fecha_Ult_Mov", "{0:dd/MM/yyyy}")})
        ...
        Me.label9.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.NombreCuenta", "{0:n2}")})
        Me.label9.Dpi = 254.0!
        ...
        Me.XrLabel19.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.SaldoFinal")})
        ...
        Me.XrLabel1.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.SaldoInicial")})
        ...
        Me.XrLabel18.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.TotalAbonos")})
        ...
        Me.label8.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF.TotalCargos")})
        Me.label8.Dpi = 254.0!
    ...
    "ngresos Financieros"
        ...
        Me.XrLabel2.Text = "NOMBRE DE LA CUENTA"
    ...
    "oDeudorAnt]  ,0 ) ))"
        ...
        '
        'RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo
        '
        ...
        Me.DataMember = "SP_RPT_Relacion_Analitica_Proveedores_por_Pagar_Corto_Plazo_ISAF"
