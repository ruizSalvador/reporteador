...
Partial Public Class RPT_ClasificacionServiciosPresCat
    ...
    Private Sub InitializeComponent()
        ...
        Me.XrLabel21.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_EstadoEjercicio_PresupuestoEgresosDetallado.Subejercicio", "{0:n2}")})
        ...
        Me.XrLabel20.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_EstadoEjercicio_PresupuestoEgresosDetallado.Pagado", "{0:n2}")})
        ...
        Me.XrLabel19.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_EstadoEjercicio_PresupuestoEgresosDetallado.Devengado", "{0:n2}")})
        ...
        Me.lbl_XrLabel18.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_EstadoEjercicio_PresupuestoEgresosDetallado.Modificado", "{0:n2}")})
        ...
        Me.lbl_prmNaturaleza.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_EstadoEjercicio_PresupuestoEgresosDetallado.AmpRed", "{0:n2}")})
        ...
        Me.lbl_prmTipo.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_EstadoEjercicio_PresupuestoEgresosDetallado.Aprobado", "{0:n2}")})
        ...
        Me.XrLabel8.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "SP_EstadoEjercicio_PresupuestoEgresosDetallado.Concepto")})
        ...
        Me.PICEnteLogoSecundario.LocationFloat = New DevExpress.Utils.PointFloat(2377.539!, 66.14583!)
        ...
        Me.pageInfo2.LocationFloat = New DevExpress.Utils.PointFloat(2655.575!, 173.4142!)
        ...
        Me.pageInfo1.LocationFloat = New DevExpress.Utils.PointFloat(2655.575!, 109.9141!)
        ...
        Me.pageInfo3.LocationFloat = New DevExpress.Utils.PointFloat(2655.575!, 46.41423!)
    ...
    "Espacio asignado para notas%' "
        ...
        '
        'RPT_ClasificacionServiciosPresCat
        '
        ...
        Me.DataMember = "SP_EstadoEjercicio_PresupuestoEgresosDetallado"
