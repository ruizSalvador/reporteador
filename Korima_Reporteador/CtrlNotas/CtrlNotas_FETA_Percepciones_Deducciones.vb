...
Public Class CtrlNotas_FETA_Percepciones_Deducciones
    'Dim strFirmas
    'Dim strTitulo
    'Public strReporte
    ...
    Function TrimesteLetra() As String
        ...
        End If
    End Function
    Dim reporte As NOTA_FETA_Percepciones_Deducciones

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_FETA_Percepciones_Deducciones()
        ...
        With reporte
            ...
            .lblTitulo.Text = "Catálogo de Percepciones y Deducciones"
            '.lblSubtitulo.Text = ""
