...
Public Class CtrlNotas_EA_GOP
    Public reporte As NOTA_EA_GOP
    Public notas As New Dictionary(Of String, String)

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_EA_GOP()
        ...
        Dim command As New SqlCommand("sp_nota_ea_gop", conection)
        ...
        adapter.Fill(ds, "sp_nota_ea_gop")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "sp_nota_ea_gop"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Gastos y Otras Pérdidas' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Notas al Estado de Actividades"
            ...
            .lblTitulo.Text = "Gastos y Otras Pérdidas"
            .lblSubtitulo.Text = ""
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Gastos y Otras Pérdidas' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        ctrl = reporte.FindControl("lbl_Notas", False)
        AddHandler ctrl.PreviewClick, AddressOf CapturaNota
        AddHandler ctrl.PreviewMouseMove, AddressOf ctrlMouseUp
        AddHandler ctrl.EvaluateBinding, AddressOf EvaluateBinding
    ...
    Private Sub BarLargeButtonItem2_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs)
