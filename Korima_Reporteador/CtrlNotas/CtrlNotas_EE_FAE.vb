...
Public Class CtrlNotas_EE_FAE
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        'reporte.Parameters.Add(param1)
        'reporte.FilterString = "[Monto] / [Parameters.miles]"
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Efectivo y Equivalentes/Fondos' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Efectivo y Equivalentes/Fondos' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
    ...
    Private Sub BarButtonItem3_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs)
        ...
        dlg.Filter = "Archivo de Hoja de Cálculo|*.csv"
        If dlg.ShowDialog(Me) = DialogResult.OK Then
            reporte.ExportToCsv(dlg.FileName)
        End If
    End Sub
End Class
