...
Public Class CtrlNotas_ESF_BMII_BMI
    Dim TipoReporte
    ...
    Public reporte As NOTA_ESF_BMII_BMI

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_ESF_BMII_BMI()
        ...
        Dim command As New SqlCommand("SP_NOTA_ESF_BMII_BMI", conection)
        ...
        adapter.Fill(ds, "SP_NOTA_ESF_BMII_BMI")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_NOTA_ESF_BMII_BMI"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        'adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = '" & "Notas al Estado de Situacion Financiera Bienes Inmuebles, Inmuebles e Intangibles - Bienes Inmuebles, Inmuebles e Intangibles" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = '" & "Bienes Muebles,Inm e Int/Bienes Muebles e Inmuebles" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblSubtitulo.Text = "Bienes Muebles e Inmuebles"
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Notas al Estado de Situacion Financiera Bienes Inmuebles, Inmuebles e Intangibles - Bienes Inmuebles, Inmuebles e Intangibles' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        AddHandler ctrl.PreviewMouseMove, AddressOf ctrlMouseUp
        ctrl = reporte.FindControl("lbl_prmFecha", False)
        AddHandler ctrl.PreviewMouseMove, AddressOf ctrlMouseUp
