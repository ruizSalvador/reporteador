...
Public Class CtrlNotas_FETA_Salario_Superior
    'Dim strFirmas
    'Dim strTitulo
    'Public strReporte
    ...
    Function TrimesteLetra() As String
        ...
        End If
    End Function
    Dim reporte As NOTA_FETA_Salario_Superior

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_FETA_Salario_Superior()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Trabajadores Cuyo Salario Supere los Ingresos Promedio' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblTitulo.Text = "Trabajadores Cuyo Salario Básico Supere los Ingresos Promedio de un Docente en la Categoría más Alta del Tabulador Salarial Correspondiente a Cada Entidad"
            '.lblSubtitulo.Text = ""
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= 'Trabajadores Cuyo Salario Supere los Ingresos Promedio'", New SqlConnection(cnnString))
            cmd.Connection.Open()
