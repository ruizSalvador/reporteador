...
Public Class CtrlNotas_ESF_ED_OA
    Dim TipoReporte
    Dim strFirmas
    Dim strTitulo
    Dim strReporte
    ...
    Public reporte As NOTA_ESF_ED_OA

    Public Sub New(Tipo As Integer)
        TipoReporte = Tipo
        If Tipo = 1 Then
            strFirmas = "Estimaciones y Deterioros"
            strReporte = "Notas al Estado de Situación Financiera"
            strTitulo = "Estimaciones y Deterioros"
            strColumna = "CRITERIO UTILIZADO"
        End If
        If Tipo = 2 Then
            strFirmas = "Otros Activos"
            strReporte = "Notas al Estado de Situación Financiera"
            strTitulo = "Otros Activos"
            strColumna = "CARACTERÍSTICAS CUALITATIVAS"
        End If
        If Tipo = 3 Then
            strFirmas = "Fondos"
            strReporte = "Notas al Estado de Situación Financiera"
            strTitulo = "Fondos de Bienes de Terceros en Administracón y/o en garantía a corto y largo plazo"
            strColumna = "NATURALEZA"
        End If
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim command As New SqlCommand("SP_NOTA_ESF_ED_OA", conection)
        ...
        adapter.Fill(ds, "SP_NOTA_ESF_ED_OA")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_NOTA_ESF_ED_OA"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = '" & strFirmas & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
