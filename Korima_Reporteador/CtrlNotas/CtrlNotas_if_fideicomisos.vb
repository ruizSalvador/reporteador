...
Public Class CtrlNotas_if_fideicomisos
    Public reporte As NOTA_if_fideicomisos
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        reporte = New NOTA_if_fideicomisos()
        ...
        Dim command As New SqlCommand("sp_nota_if_fideicomisos", conection2)
        ...
        adapter2.Fill(dsB, "sp_nota_if_fideicomisos")
        reporte.DataSource = dsB

        reporte.DataAdapter = adapter2
        reporte.DataMember = "sp_nota_if_fideicomisos"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Inversiones Financieras/Fideicomisos' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblSubtitulo.Text = "Inversiones financieras, que considera los fideicomisos"
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Inversiones Financieras/Fideicomisos' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
