...
Public Class CtrlNotas_EA_IG
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim command As New SqlCommand("sp_nota_ea_ig", conection)
        ...
        adapter.Fill(ds, "sp_nota_ea_ig")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "sp_nota_ea_ig"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Ingresos de Gestión' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblTitulo.Text = "Ingresos de Gestión"
            .lblSubtitulo.Text = ""
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Ingresos de Gestión' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
