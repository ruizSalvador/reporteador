...
Public Class CtrlNotas_dreoe_dreeybsrv
    Public reporte As NOTA_dreoe_dreeybsrv


    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_dreoe_dreeybsrv()
        ...
        Dim command As New SqlCommand("sp_nota_dreoe_dreeybsrv", conection2)
        ...
        adapter2.Fill(dsB, "sp_nota_dreoe_dreeybsrv")
        reporte.DataSource = dsB

        reporte.DataAdapter = adapter2
        reporte.DataMember = "sp_nota_dreoe_dreeybsrv"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Derecho a Recibir Efvo y Eq/Derechos,Bienes y Servicios' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblSubtitulo.Text = "Derechos a recibir efectivo y equivalentes, y bienes o servicios a recibir por vencimiento"
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Derecho a Recibir Efvo y Eq/Derechos,Bienes y Servicios' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
