...
Public Class CtrlNota_IndiceDesgloseNotas
    Dim reporte As NOTA_IndiceDesgloseNotas

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_IndiceDesgloseNotas()
        ...
        With reporte
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='NOTAS A LOS ESTADOS FINANCIEROS (Desglose)' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
