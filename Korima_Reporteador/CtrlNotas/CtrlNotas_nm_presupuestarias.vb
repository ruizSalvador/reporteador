...
Public Class CtrlNotas_nm_presupuestarias
    Dim reporte As NOTA_nm_presupuestarias
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        reporte = New NOTA_nm_presupuestarias()
        ...
        Dim command As New SqlCommand("sp_nota_nm_presupuestarias", conection2)
        ...
        adapter2.Fill(dsB, "sp_nota_nm_presupuestarias")
        reporte.DataSource = dsB

        reporte.DataAdapter = adapter2
        reporte.DataMember = "sp_nota_nm_presupuestarias"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Notas Presupuestarias' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblTitulo.Text = "Notas Presupuestarias"
            '.lblSubtitulo.Text = "Notas Presupuestarias"
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Notas Presupuestarias' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
