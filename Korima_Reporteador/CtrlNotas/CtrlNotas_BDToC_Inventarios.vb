...
Public Class CtrlNotas_BDToC_Inventarios
    Public reporte As NOTA_BDToC_Inventarios
    
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        reporte = New NOTA_BDToC_Inventarios()
        ...
        Dim command As New SqlCommand("sp_nota_BDToC_Inventarios", conection2)
        ...
        adapter2.Fill(dsB, "sp_nota_BDToC_Inventarios")
        reporte.DataSource = dsB

        reporte.DataAdapter = adapter2
        reporte.DataMember = "sp_nota_BDToC_Inventarios"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Bienes Disp Transf o Consumo/Inventarios' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblSubtitulo.Text = "Inventarios"
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Bienes Disp Transf o Consumo/Inventarios' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
