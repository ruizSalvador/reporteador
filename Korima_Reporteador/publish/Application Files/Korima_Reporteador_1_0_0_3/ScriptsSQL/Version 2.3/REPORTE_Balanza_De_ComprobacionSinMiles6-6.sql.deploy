/****** Object:  StoredProcedure [dbo].[REPORTE_Balanza_De_ComprobacionSinMiles6-6]    Script Date: 07/24/2013 10:05:30 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[REPORTE_Balanza_De_ComprobacionSinMiles6-6]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[REPORTE_Balanza_De_ComprobacionSinMiles6-6]
GO
...
CREATE PROCEDURE [dbo].[REPORTE_Balanza_De_ComprobacionSinMiles6-6]
...
AND LEFT(dbo.C_Contable.NumeroCuenta, 1)='1'
ORDER BY dbo.C_Contable.NumeroCuenta
...
END
--OBTIENE LOS SALDOS ESTRUCTURA 6-6
...
select @Var11310 = dbo.Saldo_Cuenta ('113100-000000', @Mes,@Año)
select @Var11320 = dbo.Saldo_Cuenta ('113200-000000', @Mes,@Año)
select @Var11330 = dbo.Saldo_Cuenta ('113300-000000', @Mes,@Año)
select @Var11340 = dbo.Saldo_Cuenta ('113400-000000', @Mes,@Año)
select @Var11390 = dbo.Saldo_Cuenta ('113900-000000', @Mes,@Año)
...
select @Var11310Ant = dbo.Saldo_Cuenta ('113100-000000', @Mes,@Año-1)
select @Var11320Ant = dbo.Saldo_Cuenta ('113200-000000', @Mes,@Año-1)
select @Var11330Ant = dbo.Saldo_Cuenta ('113300-000000', @Mes,@Año-1)
select @Var11340Ant = dbo.Saldo_Cuenta ('113400-000000', @Mes,@Año-1)
select @Var11390Ant = dbo.Saldo_Cuenta ('113900-000000', @Mes,@Año-1)
...
--UPDATE @Tmp_BalanzaDeComprobacion Set SaldoDeudor=SaldoDeudor - @Var11610 , SaldoDeudorAnt=SaldoDeudorAnt - @Var11610Ant  where NumeroCuenta='112200-00000'
...
UPDATE @Tmp_BalanzaDeComprobacion Set SaldoDeudor=SaldoDeudor - (@Var12810+@Var12820+@Var12830+@Var12840+@Var12890) , SaldoDeudorAnt=SaldoDeudorAnt - (@Var12810Ant+@Var12820Ant+@Var12830Ant+@Var12840Ant+@Var12890Ant)  where NumeroCuenta='122000-000000'--Misma afectacion a cuenta padre
...
UPDATE @Tmp_BalanzaDeComprobacion Set MaskNombreCuenta='                  DEUDA PÚBLICA INTERNA'  where NumeroCuenta='223300-000000' 
UPDATE @Tmp_BalanzaDeComprobacion Set MaskNombreCuenta='                  DEUDA PÚBLICA EXTERNA'  where NumeroCuenta='223400-000000' 
DELETE from @Tmp_BalanzaDeComprobacion where NumeroCuenta='223100-000000' 
DELETE from @Tmp_BalanzaDeComprobacion where NumeroCuenta='223200-000000' 
UPDATE @Tmp_BalanzaDeComprobacion Set SaldoDeudor=@Var11310 + @Var11320 + @Var11330 + @Var11340 + @Var11390, SaldoDeudorAnt= @Var11310Ant + @Var11320Ant + @Var11330Ant + @Var11340Ant + @Var11390Ant  where NumeroCuenta='113100-000000'
UPDATE @Tmp_BalanzaDeComprobacion Set MaskNombreCuenta='                  ANTCIPOS A CORTO PLAZO'  where NumeroCuenta='113100-000000' 
DELETE from @Tmp_BalanzaDeComprobacion where NumeroCuenta='113200-000000' 
DELETE from @Tmp_BalanzaDeComprobacion where NumeroCuenta='113300-000000' 
DELETE from @Tmp_BalanzaDeComprobacion where NumeroCuenta='113400-000000' 
DELETE from @Tmp_BalanzaDeComprobacion where NumeroCuenta='113900-000000' 
--total activo circulante
INSERT INTO @Tmp_BalanzaDeComprobacion select top(1)
 '11990A-000000' as NumeroCuenta,
 '' as NombreCuenta,
 cargossinflujo,
 abonossinflujo,
 TotalCargos,
...
tipocuenta,
 ...
 '' as numerocuentaant,
  ...
  AñoAnt,
  agrupador
  from @Tmp_BalanzaDeComprobacion where MaskNumeroCuenta= '110000'
  --Activo No circulante
INSERT INTO @Tmp_BalanzaDeComprobacion select top(1)
 '12990A-000000' as NumeroCuenta,
 '' as NombreCuenta,
 cargossinflujo,
 abonossinflujo,
 TotalCargos,
...
tipocuenta,
 ...
 '12990A' as numerocuentaant,
  saldodeudorAnt,
  SaldoAcreedorAnt,
  MesAnt,
  AñoAnt,
  agrupador
  from @Tmp_BalanzaDeComprobacion where MaskNumeroCuenta= '120000'  
--total Pasivo circulante
INSERT INTO @Tmp_BalanzaDeComprobacion select top(1)
 '21990A-000000' as NumeroCuenta,
 '' as NombreCuenta,
 cargossinflujo,
 abonossinflujo,
 TotalCargos,
...
tipocuenta,
 ...
 '' as numerocuentaant,
  ...
  AñoAnt,
  agrupador
  from @Tmp_BalanzaDeComprobacion where MaskNumeroCuenta= '210000'
--total Pasivo No circulante
INSERT INTO @Tmp_BalanzaDeComprobacion select top(1)
 '22990A-000000' as NumeroCuenta,
 '' as NombreCuenta,
 cargossinflujo,
 abonossinflujo,
 TotalCargos,
...
tipocuenta,
 ...
 '' as numerocuentaant,
  ...
  AñoAnt,
  agrupador
  from @Tmp_BalanzaDeComprobacion where MaskNumeroCuenta= '220000'
...
isnull((SaldoAcreedorAnt),0) as SaldoAcreedorAnt,
MesAnt,
AñoAnt,
Agrupador 
