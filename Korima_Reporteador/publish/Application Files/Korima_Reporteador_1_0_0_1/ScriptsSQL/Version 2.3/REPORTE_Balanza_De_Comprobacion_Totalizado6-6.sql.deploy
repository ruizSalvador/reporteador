/****** Object:  StoredProcedure [dbo].[REPORTE_Balanza_De_Comprobacion_Totalizado6-6]    Script Date: 07/24/2013 10:13:57 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[REPORTE_Balanza_De_Comprobacion_Totalizado6-6]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[REPORTE_Balanza_De_Comprobacion_Totalizado6-6]
GO
...
CREATE PROCEDURE [dbo].[REPORTE_Balanza_De_Comprobacion_Totalizado6-6]
