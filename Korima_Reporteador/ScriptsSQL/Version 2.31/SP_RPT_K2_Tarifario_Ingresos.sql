...
--Exec SP_RPT_Tarifario_Ingresos 4,'20211001','20211030',1,99999,0
...
Insert @TablaTodos 
Select Tf.Folio , Tf.Fecha , CC.RazonSocial as Cliente, df.Importe ,C_PartidasGastosIngresos.Descripcion as Descripcion,df.Concepto  as Concepto, 'Por Recaudar-Recaudados' as Tipo,df.IdTarifa, C_PartidasGastosIngresos.Clave AS CLAVE, Tf.[status], idpoliza
FROM c_clientes as cc
JOIN T_Facturas as TF 
ON cc.IdCliente = tf.IdCliente 
JOIN D_Facturas as DF 
