...
--EXEC SP_RPT_K2_AuxiliarMayor '','',2019,1,1,1,'11110-00001','11110-00003',0,0
--EXEC SP_RPT_K2_AuxiliarMayor '','',2019,1,12,0,'11110-00001','93000-00000',0,0
--EXEC SP_RPT_K2_AuxiliarMayor '','',2021,12,12,1,'','',0,1286
...
set @iCuentaFin= CONVERT(bigint,REPLACE(@CuentaFin,'-',''))    
 ...
 Declare @tabla as table (    
  Fecha datetime    
      ...
      ,IdDPoliza int    
      ,ImporteCargo decimal (15,4)    
      ,ImporteAbono decimal (15,4)    
      ,SaldoFila decimal (19,4)    
  ...
  Fecha datetime    
   ...
   ,Afectable int     
      ,NumeroxCuenta int    
      ,TotalGral decimal(18,4) 
	  ,CtaSaldoInicial decimal(18,4)
	  ,CtaMayor varchar(50)
