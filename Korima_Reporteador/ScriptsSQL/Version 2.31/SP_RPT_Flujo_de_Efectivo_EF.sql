...
-- EXEC SP_RPT_Flujo_de_Efectivo_EF 2021,12,0,1,0
...
Union All
Select 'Origen',SUM(a.SaldoAcreedor-a.SaldoDeudor), SUM(b.SaldoAcreedor-b.SaldoDeudor), 1, 'A', 1
...
Union All
Select 'Impuestos', (a.SaldoAcreedor-a.SaldoDeudor), (b.SaldoAcreedor-b.SaldoDeudor), 0, 'X',2
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta = '411'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura
--Agrgegado para la version 2.9
Union All
Select 'Cuotas y Aportaciones de Seguridad Social', (a.SaldoAcreedor-a.SaldoDeudor), (b.SaldoAcreedor-b.SaldoDeudor), 0, 'X',2.1
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta = '412'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura
--Agregado Fin
Union All
Select 'Contribuciones de Mejoras', (a.SaldoAcreedor-a.SaldoDeudor),(b.SaldoAcreedor-b.SaldoDeudor), 0, 'X',3
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('413'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura)
Union All
Select 'Derechos', (a.SaldoAcreedor-a.SaldoDeudor), (b.SaldoAcreedor-b.SaldoDeudor), 0, 'X',4
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('414'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura)
Union All
Select 'Productos', (a.SaldoAcreedor-a.SaldoDeudor),(b.SaldoAcreedor-b.SaldoDeudor), 0, 'X',5
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('415'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura)
Union All
Select 'Aprovechamientos', (a.SaldoAcreedor-a.SaldoDeudor), (b.SaldoAcreedor-b.SaldoDeudor), 0, 'X',6
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('416'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura)
Union All
Select 'Ingresos por Venta de Bienes y Prestación de Servicios', (a.SaldoAcreedor-a.SaldoDeudor), (b.SaldoAcreedor-b.SaldoDeudor), 0, 'X',7
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
...
(a.SaldoAcreedor-a.SaldoDeudor), (b.SaldoAcreedor-b.SaldoDeudor), 0, 'X',9
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
...
(a.SaldoAcreedor-a.SaldoDeudor), (b.SaldoAcreedor-b.SaldoDeudor), 0, 'X',13
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
...
SUM(a.SaldoAcreedor-a.SaldoDeudor), SUM(b.SaldoAcreedor-b.SaldoDeudor), 0, 'X', 19
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
...
(a.SaldoDeudor-a.SaldoAcreedor), (b.SaldoDeudor-b.SaldoAcreedor), 0, 'X',21
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('511'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura)
UNION ALL
Select 'Materiales y Suministros',
(a.SaldoDeudor-a.SaldoAcreedor), (b.SaldoDeudor-b.SaldoAcreedor), 0, 'X',22
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('512'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura)
UNION ALL
Select 'Servicios Generales',
(a.SaldoDeudor-a.SaldoAcreedor), (b.SaldoDeudor-b.SaldoAcreedor), 0, 'X',23
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
...
--ELSE ABS(Anterior-AnteAnterior) END FROM @AplicacionesOperacion 
--Where nocuenta IN ('128'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura)), 
SUM(a.SaldoDeudor-a.SaldoAcreedor), SUM(b.SaldoDeudor-b.SaldoAcreedor),
0, 'X', 37.1
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('541'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'542'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'543'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'544'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'545'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '546'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,
'547'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'548'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '549'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura)
...
SUM(a.TotalCargos), SUM(b.TotalCargos),
0, 'X', 39.3
FROM @eAcumuladoActual a inner join @eAcumuladoAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('114'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'115'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'121'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'125'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'129'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '311'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,
'312'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'313'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '323'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '324'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,
'325'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '331'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '332'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura)
...
--Cambio a acumulado
SUM(a.TotalAbonos), SUM(b.TotalAbonos),
0, 'X', 46
FROM @eAcumuladoActual a inner join @eAcumuladoAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('114'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'115'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'121'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'125'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'129'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '311'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,
'312'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'313'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '323'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '324'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,
...
SUM(a.TotalCargos), SUM(b.TotalCargos),
	0, 'X', 51
FROM @eAcumuladoActual a inner join @eAcumuladoAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('2132'+Replicate('0',@Estructura1-4)+'-'+@cerosEstructura,'2142'+Replicate('0',@Estructura1-4)+'-'+@cerosEstructura,'2232'+Replicate('0',@Estructura1-4)+'-'+@cerosEstructura,'2234'+Replicate('0',@Estructura1-4)+'-'+@cerosEstructura)
--(Select Isnull(ABS(SUM(Actual-Anterior)),0)
--(Select Isnull(ABS(SUM(Actual-Anterior)),0)
--From @ActividadesFinanciamiento Where Actual > Anterior AND
...
SUM(a.TotalCargos), SUM(b.TotalCargos),
	0, 'X', 52
FROM @eAcumuladoActual a inner join @eAcumuladoAnterior b on a.nocuenta = b.nocuenta
Where a.nocuenta IN ('112'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'113'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'119'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'122'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,'211'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,
'212'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '215'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '216'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '217'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '219'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '221'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura,
'222'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '224'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '225'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura, '226'+Replicate('0',@Estructura1-3)+'-'+@cerosEstructura)
--ABS((Select Isnull(SUM(Actual-Anterior),0)
--From @ActividadesFinanciamiento Where Actual < Anterior AND
...
(Select isnull(SaldoDeudor,0) From VW_RPT_K2_Balanza_De_Comprobacion Where [Year] = @ejercicio-2 and Mes = @periodo and SUBSTRING(NumeroCuenta ,1,4) = '1110')
, 1, 'X', 62
insert into @report 
--Union All
...
UPDATE @report set SaldoActual = (Select isnull(SaldoDeudor,0) From @eActual Where SUBSTRING(nocuenta ,1,4) = '1110') 
Where Orden = 63

UPDATE @report set SaldoAnterior = (Select isnull(SaldoDeudor,0) From @eAnterior Where SUBSTRING(nocuenta ,1,4) = '1110') 
Where Orden = 63
