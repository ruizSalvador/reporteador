...
--Exec SP_RPT_SolicitudesPago '20210101','20211231',0,1
...
Select * From @Reporte Where (IdCheque not in (Select Distinct IdChequesAgrupador From @Reporte Where IdChequesAgrupador <> 0)
						OR IdCheque is null)
						AND EstatusOrden = CASE WHEN @Estatus = 0 THEN EstatusOrden
						WHEN @Estatus = 1 THEN 'Pagado'
						WHEN @Estatus = 2 THEN 'Pendiente' END
		
End

EXEC SP_FirmasReporte 'Reporte de Solicitudes de Pago'
GO
Exec SP_CFG_LogScripts 'SP_RPT_SolicitudesPago','2.31'
GO