...
--Exec SP_CalendarioMensualIngresos '20160714',1
...
MovimientosPresupuesto.Ejercidio, MovimientosPresupuesto.MedDestino,  MovimientosPresupuesto.Estimado
UNION
...
--Order by Clave,Grupo3
 ...
 Update @Tabla set Orden='0' where Orden='10'
 --Update @Tabla set Orden='0' where Orden='99'
...
--update @Tabla2 set Orden = 99.5 where Clave = '01100'
select * from @Tabla2  order by orden
END 
GO
