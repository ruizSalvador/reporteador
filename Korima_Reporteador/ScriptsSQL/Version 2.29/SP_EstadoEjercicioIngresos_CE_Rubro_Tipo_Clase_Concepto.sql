...
-- EXEC SP_EstadoEjercicioIngresos_CE_Rubro_Tipo_Clase_Concepto 3,1,6,2019,1
...
IF @RedAmpAcum = 1
	BEGIN
		...
		INSERT INTO @AcumAnual (Clave, Clasificacion ,Estimado, Modificado)
		...
		(Select SUM (Modificado) from @AcumAnual where Clave in ('50000','60000')) as Total_Modificado;
		 ...
		 UPDATE A SET A.Total_Estimado = B.Estimado, A.Total_Modificado = B.Modificado FROM @Resultado A INNER JOIN @AcumAnual B ON A.Grupo1 = B.Clave;
