...
If @AmpRedAnual = 1
	Begin
		update r set r.AmpliacionesReducciones = a.AmpliacionesReducciones FROM @Anual2 a, @Titulos r Where substring(a.Clave,1,3)=substring(r.Clave,2,3)
	End
...
GO
Exec SP_CFG_LogScripts 'SP_RPT_K2_EgresosClasificacionAdministrativaParaestatal','2.29'
GO
