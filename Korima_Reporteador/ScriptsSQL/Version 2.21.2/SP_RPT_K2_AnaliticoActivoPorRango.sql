/****** Object:  StoredProcedure [dbo].[SP_RPT_K2_AnaliticoActivoPorRango]    Script Date: 10/28/2014 13:47:41 ******/
...
where substring(NumeroCuenta,1,3) in ('126','128')

update @Reporte set SaldoFinal= (CargosSinFlujo+TotalCargos-TotalAbonos)/@division
where substring(NumeroCuenta,1,3) not in ('126','128')
----
...
GO
EXEC SP_FirmasReporte 'Analitico del activo por Rango'
GO
--EXEC SP_RPT_K2_AnaliticoActivoPorRango
--0,--@Miles Bit,
--0,--@Totales Bit,
--3,--@PeriodoFinal int,
--2015,--@Ejercicio int,
--1,--@MostarSinSaldo bit,
--1,--@PeriodoInicial int
--1
--GO

--cargos sin flujo y abonos in flujo: mes inicial

--total cargos y total abonos: acumulado
--saldo deudor y saldo acreedor: mes final