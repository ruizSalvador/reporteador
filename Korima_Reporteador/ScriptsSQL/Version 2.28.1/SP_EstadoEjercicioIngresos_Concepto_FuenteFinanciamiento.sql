...
-- Exec SP_EstadoEjercicioIngresos_Concepto_FuenteFinanciamiento 10,10,0,2018,'',1
...
If @AmpRedAnual = 1
	 BEGIN
		 ...
		 A.Excedentes,
         A.SumaGrupos
		 FROM @Resultado2 A LEFT JOIN @Resultado2Anual B On A.Clave = B.Clave and A.FuenteFinanciamiento = B.FuenteFinanciamiento 
	 END
 Else
	 BEGIN
		 INSERT INTO @Vaciado
