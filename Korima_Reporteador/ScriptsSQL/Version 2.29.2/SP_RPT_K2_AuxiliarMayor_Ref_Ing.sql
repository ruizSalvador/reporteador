...
=======================================================================================================  
*/      
 /****** Object:  StoredProcedure [dbo].[SP_RPT_K2_AuxiliarMayor_Ref_Ing] ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_RPT_K2_AuxiliarMayor_Ref_Ing]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_RPT_K2_AuxiliarMayor_Ref_Ing]
GO
/****** Object:  StoredProcedure [dbo].[SP_RPT_K2_AuxiliarMayor_Ref_Ing]   ******/
SET ANSI_NULLS ON
GO
...
SET NOCOUNT ON
GO
--EXEC SP_RPT_K2_AuxiliarMayor_Ref_Ing '11120-02001','',2020,5,5,1,'','',1,0

Create PROCEDURE [dbo].[SP_RPT_K2_AuxiliarMayor_Ref_Ing]     
...
LEFT JOIN T_Facturas ON T_Facturas.IdPoliza = T_Polizas.IdPoliza   
 ...
 and( T_Cheques.Status= 'D' or ((T_Cheques.Status='I'OR T_Cheques.Status='N')))and T_Polizas.NoPoliza>0))    
  ...
  AND T_SaldosInicialesCont.[year] = @Ejercicio
