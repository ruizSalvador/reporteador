...
INSERT INTO @SaldosIniciales 
	...
	And Mes = @mes1  And [Year] = @Ejercicio And TipoCuenta <> 'X' and SUBSTRING(NumeroCuenta,1,1) <= 5
	AND Nivel>=0 
...
CASE WHEN (SUBSTRING(I.NumeroCuenta,5,1) = 0 and SUBSTRING(I.NumeroCuenta,6,1) =0)
	 THEN SUBSTRING(I.NumeroCuenta,1,1) + '.' + SUBSTRING(I.NumeroCuenta,2,1) + '.' + SUBSTRING(I.NumeroCuenta,3,1) + '.' + SUBSTRING(I.NumeroCuenta,4,1) + '.' + SUBSTRING(I.NumeroCuenta,5,1)
