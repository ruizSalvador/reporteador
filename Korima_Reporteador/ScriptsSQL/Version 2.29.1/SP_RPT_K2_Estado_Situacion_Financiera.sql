/****** Object:  StoredProcedure [dbo].[SP_RPT_K2_Estado_Situacion_Financiera]    Script Date: 01/21/2014 16:04:50 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_RPT_K2_Estado_Situacion_Financiera]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_RPT_K2_Estado_Situacion_Financiera]
GO
...
--Exec SP_RPT_K2_Estado_Situacion_Financiera 2019,12,1,1
CREATE PROCEDURE [dbo].[SP_RPT_K2_Estado_Situacion_Financiera]
@Año int,
@Mes int,
@Miles bit,
@MostrarVacios bit
...
EXEC SP_FirmasReporte 'Estado de Cambios en la Situación Financiera'
GO

--  exec SP_RPT_K2_Estado_Situacion_Financiera 2015,7,0,1