...
where  (Mes BETWEEN  @Mes AND @Mes2) AND LYear=@Ejercicio AND  CR.CLAVE = CASE WHEN @Clave = '' THEN CR.CLAVE else @Clave end
...
where  (Mes BETWEEN  @Mes AND @Mes2) AND LYear=@Ejercicio  and CR.CLAVE =CASE WHEN @Clave = '' THEN CR.CLAVE else @Clave end AND CA.Clave = CASE WHEN @ClaveUR = '' THEN CA.Clave ELSE @ClaveUR END 
...
Where   (Mes BETWEEN  @Mes AND @Mes2) AND LYear=@Ejercicio  AND CR.CLAVE = CASE WHEN @Clave = '' THEN CR.CLAVE else @Clave end  AND CEPR.Nivel = '5' 
...
Where  (Mes BETWEEN  @Mes AND @Mes2) AND LYear=@Ejercicio  AND CR.CLAVE = CASE WHEN @Clave = '' THEN CR.CLAVE else @Clave end AND CA.Clave = CASE WHEN @ClaveUR = '' THEN CA.Clave ELSE @ClaveUR END   AND CEPR.Nivel = '5' 
...
where  (Mes BETWEEN  @Mes AND @Mes2) AND LYear=@Ejercicio and CR.CLAVE = CASE WHEN @Clave = '' THEN CR.CLAVE else @Clave end AND CA.Clave = CASE WHEN @ClaveUR = '' THEN CA.Clave ELSE @ClaveUR END   AND CEPR.Id = CASE WHEN @IdEP = '' THEN CEPR.ID ELSE @IdEP END  AND CEPR.Nivel = '5' 
