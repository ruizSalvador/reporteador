...
---------------------------------------------------81100--------------------------------------------------------
	...
	Where IdCuenta = 819
				...
				UPDATE [dbo].[C_BalanzaASEJ] SET
	CargosSinFlujo = (Select ISNULL(SUM(CargosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81100-61%' OR NumeroCuenta = '81100-06101'),
	AbonosSinFlujo = (Select ISNULL(SUM(AbonosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81100-61%' OR NumeroCuenta = '81100-06101'),
	TotalCargos = (Select ISNULL(SUM(TotalCargos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81100-61%' OR NumeroCuenta = '81100-06101'),
	TotalAbonos = (Select ISNULL(SUM(TotalAbonos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81100-61%' OR NumeroCuenta = '81100-06101')
	Where IdCuenta = 824
...
-----81200-10
	...
	Where IdCuenta = 886
				...
				UPDATE [dbo].[C_BalanzaASEJ] SET
	CargosSinFlujo = (Select ISNULL(SUM(CargosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81200-61%' OR NumeroCuenta = '81200-06101'),
	AbonosSinFlujo = (Select ISNULL(SUM(AbonosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81200-61%' OR NumeroCuenta = '81200-06101'),
	TotalCargos = (Select ISNULL(SUM(TotalCargos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81200-61%' OR NumeroCuenta = '81200-06101'),
	TotalAbonos = (Select ISNULL(SUM(TotalAbonos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81200-61%' OR NumeroCuenta = '81200-06101')
	Where IdCuenta = 891
...
---------------------------------------------------------81300--------------------------------------------------------
	...
	Where IdCuenta = 953
				...
				UPDATE [dbo].[C_BalanzaASEJ] SET
	CargosSinFlujo = (Select ISNULL(SUM(CargosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81300-61%' OR NumeroCuenta = '81300-06101'),
	AbonosSinFlujo = (Select ISNULL(SUM(AbonosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81300-61%' OR NumeroCuenta = '81300-06101'),
	TotalCargos = (Select ISNULL(SUM(TotalCargos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81300-61%' OR NumeroCuenta = '81300-06101'),
	TotalAbonos = (Select ISNULL(SUM(TotalAbonos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81300-61%' OR NumeroCuenta = '81300-06101')
	Where IdCuenta = 958
...
-----81300-70
	...
	Where IdCuenta = 977
				...
				UPDATE [dbo].[C_BalanzaASEJ] SET
	CargosSinFlujo = 0,--(Select ISNULL(SUM(CargosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81300-85%'),
	AbonosSinFlujo = 0,--(Select ISNULL(SUM(AbonosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81300-85%'),
	TotalCargos = 0,--(Select ISNULL(SUM(TotalCargos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81300-85%'),
	TotalAbonos = 0--(Select ISNULL(SUM(TotalAbonos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81300-85%')
	Where IdCuenta = 976
...
-----81400-50
	...
	Where IdCuenta = 1042
					...
					UPDATE [dbo].[C_BalanzaASEJ] SET
	CargosSinFlujo = 0,--(Select ISNULL(SUM(CargosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81400-85%'),
	AbonosSinFlujo = 0,--(Select ISNULL(SUM(AbonosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81400-85%'),
	TotalCargos = 0,--(Select ISNULL(SUM(TotalCargos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81400-85%'),
	TotalAbonos = 0--(Select ISNULL(SUM(TotalAbonos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81400-85%')
	Where IdCuenta = 1043
...
---------------------------------------------------------81500--------------------------------------------------------
	...
	Where IdCuenta = 1109
					...
					UPDATE [dbo].[C_BalanzaASEJ] SET
	CargosSinFlujo = 0,--(Select ISNULL(SUM(CargosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81500-85%'),
	AbonosSinFlujo = 0,--(Select ISNULL(SUM(AbonosSinFlujo),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81500-85%'),
	TotalCargos = 0,--(Select ISNULL(SUM(TotalCargos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81500-85%'),
	TotalAbonos = 0--(Select ISNULL(SUM(TotalAbonos),0) FROM #BalanzaAcu  Where  NumeroCuenta like '81500-85%')
	Where IdCuenta = 1110
...
---------------------------------------------------------
	UPDATE [dbo].[C_BalanzaASEJ] SET
	AbonosSinFlujo =(Select ISNULL(SUM(SaldoInicial),0) from @Extras Where ClavePartida in (2910,2920,2930,2940,2950,2960,2970,2980,2990) and ClaveFF in (11,12,13,14,15,16,17) AND NumeroCuenta like '821%'),
	...
	UPDATE [dbo].[C_BalanzaASEJ] SET
	AbonosSinFlujo =(Select ISNULL(SUM(SaldoInicial),0) from @Extras Where ClavePartida in (2910,2920,2930,2940,2950,2960,2970,2980,2990) and ClaveFF in (25,26,27) AND NumeroCuenta like '821%'),
...
---------------------------------------------------------
	UPDATE [dbo].[C_BalanzaASEJ] SET
	AbonosSinFlujo =(Select ISNULL(SUM(SaldoInicial),0) from @Extras Where ClavePartida in (2910,2920,2930,2940,2950,2960,2970,2980,2990) and ClaveFF in (11,12,13,14,15,16,17) AND NumeroCuenta like '822%'),
	...
	UPDATE [dbo].[C_BalanzaASEJ] SET
	AbonosSinFlujo =(Select ISNULL(SUM(SaldoInicial),0) from @Extras Where ClavePartida in (2910,2920,2930,2940,2950,2960,2970,2980,2990) and ClaveFF in (25,26,27) AND NumeroCuenta like '822%'),
...
---------------------------------------------------------
	UPDATE [dbo].[C_BalanzaASEJ] SET
	AbonosSinFlujo =(Select ISNULL(SUM(SaldoInicial),0) from @Extras Where ClavePartida in (2910,2920,2930,2940,2950,2960,2970,2980,2990) and ClaveFF in (11,12,13,14,15,16,17) AND NumeroCuenta like '823%'),
	...
	UPDATE [dbo].[C_BalanzaASEJ] SET
	AbonosSinFlujo =(Select ISNULL(SUM(SaldoInicial),0) from @Extras Where ClavePartida in (2910,2920,2930,2940,2950,2960,2970,2980,2990) and ClaveFF in (25,26,27) AND NumeroCuenta like '823%'),
...
---------------------------------------------------------
	...
	Where IdCuenta = 2065
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--Update C_Contable Set TipoCuenta = 'I' where NumeroCuenta like '811%'
...
--Update C_Contable Set TipoCuenta = 'I' where NumeroCuenta like '825%'
--Update C_Contable Set TipoCuenta = 'I' where NumeroCuenta like '826%'
--Update C_Contable Set TipoCuenta = 'I' where NumeroCuenta like '827%'
...
--Update [dbo].[C_BalanzaASEJ] set SaldoDeudor =
--			CASE 
--				WHEN NumeroCuenta Like '811%' THEN isnull(CargosSinFlujo,0) - isnull(AbonosSinFlujo,0) + isnull(TotalCargos,0) - isnull(TotalAbonos,0)
--				WHEN NumeroCuenta Like '812%' THEN 0
--				WHEN NumeroCuenta Like '813%' THEN 0
--				WHEN NumeroCuenta Like '814%' THEN 0
--				WHEN NumeroCuenta Like '815%' THEN 0
--				WHEN NumeroCuenta Like '821%' THEN 0
--				WHEN NumeroCuenta Like '822%' THEN CargosSinFlujo - AbonosSinFlujo + TotalCargos - TotalAbonos
--				WHEN NumeroCuenta Like '823%' THEN CargosSinFlujo - AbonosSinFlujo + TotalCargos - TotalAbonos
--				WHEN NumeroCuenta Like '824%' THEN CargosSinFlujo - AbonosSinFlujo + TotalCargos - TotalAbonos
--				WHEN NumeroCuenta Like '825%' THEN CargosSinFlujo - AbonosSinFlujo + TotalCargos - TotalAbonos
--				WHEN NumeroCuenta Like '826%' THEN CargosSinFlujo - AbonosSinFlujo + TotalCargos - TotalAbonos
--				WHEN NumeroCuenta Like '827%' THEN CargosSinFlujo - AbonosSinFlujo + TotalCargos - TotalAbonos
--			END

--Update [dbo].[C_BalanzaASEJ] set SaldoAcreedor =
--			CASE 
--				WHEN NumeroCuenta Like '811%' THEN 0
--				WHEN NumeroCuenta Like '812%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
--				WHEN NumeroCuenta Like '813%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
--				WHEN NumeroCuenta Like '814%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
--				WHEN NumeroCuenta Like '815%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
--				WHEN NumeroCuenta Like '821%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
--				WHEN NumeroCuenta Like '822%' THEN 0
--				WHEN NumeroCuenta Like '823%' THEN 0
--				WHEN NumeroCuenta Like '824%' THEN 0
--				WHEN NumeroCuenta Like '825%' THEN 0
--				WHEN NumeroCuenta Like '826%' THEN 0
--				WHEN NumeroCuenta Like '827%' THEN 0
--			END
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--Update [dbo].[C_BalanzaASEJ] set SaldoAcreedor = AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos Where NumeroCuenta not like '8%' or NumeroCuenta not like '5%'
--Update [dbo].[C_BalanzaASEJ] set SaldoDeudor = AbonosSinFlujo - CargosSinFlujo + TotalCargos - TotalAbonos Where NumeroCuenta like '8%'

Update [dbo].[C_BalanzaASEJ] set SaldoDeudor =
			CASE 
				WHEN NumeroCuenta Like '8000%' THEN isnull(CargosSinFlujo,0) - isnull(AbonosSinFlujo,0) + isnull(TotalCargos,0) - isnull(TotalAbonos,0)
				WHEN NumeroCuenta Like '8100%' THEN 0
				WHEN NumeroCuenta Like '811%' THEN isnull(CargosSinFlujo,0) - isnull(AbonosSinFlujo,0) + isnull(TotalCargos,0) - isnull(TotalAbonos,0)
				WHEN NumeroCuenta Like '812%' THEN 0
				WHEN NumeroCuenta Like '813%' THEN 0
				WHEN NumeroCuenta Like '814%' THEN 0
				WHEN NumeroCuenta Like '815%' THEN 0
				WHEN NumeroCuenta Like '8200%' THEN CargosSinFlujo - AbonosSinFlujo + TotalCargos - TotalAbonos
				WHEN NumeroCuenta Like '821%' THEN 0
				WHEN NumeroCuenta Like '822%' THEN CargosSinFlujo - AbonosSinFlujo + TotalCargos - TotalAbonos
				--WHEN NumeroCuenta Like '823%' THEN 0
				WHEN NumeroCuenta Like '823%' THEN CargosSinFlujo - AbonosSinFlujo + TotalCargos - TotalAbonos
...
Update [dbo].[C_BalanzaASEJ] set SaldoAcreedor =
			CASE
				WHEN NumeroCuenta Like '8000%' THEN 0
				WHEN NumeroCuenta Like '8100%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
				WHEN NumeroCuenta Like '811%' THEN 0
				WHEN NumeroCuenta Like '812%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
				WHEN NumeroCuenta Like '813%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
				WHEN NumeroCuenta Like '814%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
				WHEN NumeroCuenta Like '815%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
				WHEN NumeroCuenta Like '8200%' THEN 0
				WHEN NumeroCuenta Like '821%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
				WHEN NumeroCuenta Like '822%' THEN 0
				WHEN NumeroCuenta Like '823%' THEN 0
				--WHEN NumeroCuenta Like '823%' THEN AbonosSinFlujo - CargosSinFlujo + TotalAbonos - TotalCargos
				WHEN NumeroCuenta Like '824%' THEN 0
				WHEN NumeroCuenta Like '825%' THEN 0
				WHEN NumeroCuenta Like '826%' THEN 0
				WHEN NumeroCuenta Like '827%' THEN 0
