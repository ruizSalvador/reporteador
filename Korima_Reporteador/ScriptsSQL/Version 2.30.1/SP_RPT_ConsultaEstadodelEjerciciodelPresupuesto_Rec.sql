/****** Object:  StoredProcedure [dbo].[SP_RPT_ConsultaEstadodelEjerciciodelPresupuesto_Rec]    Script Date: 07/22/2013 15:39:06 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_RPT_ConsultaEstadodelEjerciciodelPresupuesto_Rec]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_RPT_ConsultaEstadodelEjerciciodelPresupuesto_Rec]
GO
...
--Exec SP_RPT_ConsultaEstadodelEjerciciodelPresupuesto_Rec 1,12,1,2020,'','','','',1,1,1
CREATE PROCEDURE [dbo].[SP_RPT_ConsultaEstadodelEjerciciodelPresupuesto_Rec] 
...
Ejercido  decimal(18,4),Pagado  decimal(18,4),PresDispComp  decimal(18,4), Recalendarizaciones decimal(18,2), Compensada decimal(18,2))
...
ISNULL((Select SUM(Importe) from T_MovimientosPresupuesto Where IdSelloPresupuestalOrigen <> IdSelloPresupuestalDestino and IdSelloPresupuestalOrigen= TP.IdSelloPresupuestal and T_MovimientosPresupuesto.Estatus='A' and Ejercidio=@Ejercicio and IdSelloPresupuestalOrigen <>0),0) as Compensada
...
ISNULL((Select SUM(Importe) from T_MovimientosPresupuesto Where IdSelloPresupuestalOrigen <> IdSelloPresupuestalDestino and IdSelloPresupuestalOrigen= TP.IdSelloPresupuestal and T_MovimientosPresupuesto.Estatus='A' and Ejercidio=@Ejercicio and IdSelloPresupuestalOrigen <>0 and (MedDestino Between @Mes and @Mes2)),0) as Compensada
