...
--Exec REPORTE_Estado_De_ActividadesRedondeo_Periodos 1,8,2020,2021,1,1,0
...
Insert Into @TablaTitulos values('500'+REPLICATE('0',@Estructura1-3),'    GASTOS Y OTRAS PÉRDIDAS',4)
...
Insert Into @TablaTitulos values('550'+REPLICATE('0',@Estructura1-3),'          OTROS GASTOS Y PÉRDIDAS EXTRAORDINARIAS',3)
...
2000,--RPT_Balanza_Comprobacio_Anterior_1.Year AS AñoAnt, 
1 as Agrupador 
FROM         dbo.C_Contable 
INNER JOIN dbo.T_SaldosInicialesCont 
ON dbo.C_Contable.IdCuentaContable = dbo.T_SaldosInicialesCont.IdCuentaContable 
LEFT OUTER JOIN dbo.RPT_Balanza_Comprobacio_Anterior_2( @mes2, @año2) AS RPT_Balanza_Comprobacio_Anterior_1 
...
0,
0,
0,convert(int,SUBSTRING(NumeroCuenta,1,1)),NumeroCuenta,Total,@Mes,@Año,Nombre,NumeroCuenta,0,0,0,0,@Mes,@año2,1
