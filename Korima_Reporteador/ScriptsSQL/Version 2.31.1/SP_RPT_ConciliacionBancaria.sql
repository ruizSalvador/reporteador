...
-- Exec SP_RPT_ConciliacionBancaria '0117461852','20220301','20220330'
...
IF NOT EXISTS (SELECT * FROM @tablaTodo)
BEGIN

	INSERT INTO @tablaTodo 
	VALUES (null, null, null, null, null, null, null, null, 0, 0, 0, 0, 0, 0, 0, 0, 0, null)
...
Select * from @tablaTodo Where Importe >=0 OR SaldoInicial != 0 order by Orden asc

END
GO

EXEC SP_FirmasReporte 'Conciliación Bancaria'
GO

Exec SP_CFG_LogScripts 'SP_RPT_ConciliacionBancaria','2.31.1'
GO