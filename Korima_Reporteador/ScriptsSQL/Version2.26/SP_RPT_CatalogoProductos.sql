...
@Estatus varchar(max)
as
DECLARE @Tabla TABLE (Gpo int,SubGpo int,Clase int,SubClase int,Consecutivo int,Descripcion varchar(max),Tipo varchar(max),Partida int, Medida varchar(max), Estatus varchar(max), Almacen varchar(max), CodigoCambs varchar(20))
