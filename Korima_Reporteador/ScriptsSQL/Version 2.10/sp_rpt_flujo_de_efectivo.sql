...
,'41100-000000','41300-000000','41400-000000','41500-000000','41600-000000','41720-000000','41900-000000','42100-000000','42200-000000','43000-000000','41200-00000')
Union All
...
Union All
Select 'OTROS ORIGENES DE OPERACIÓN', a.SaldoAcreedor, b.SaldoAcreedor, 1, 'X',19
FROM @eActual a inner join @eAnterior b on a.nocuenta = b.nocuenta
...
(Select SUM(TotalAbonos) From @eAcumuladoActual  
Where SUBSTRING(nocuenta ,1,5) In ('21500','21600', '22400', '22500')),
(Select SUM(TotalAbonos) From @eAcumuladoAnterior  
Where SUBSTRING(nocuenta ,1,5) In ('21500','21600', '22400', '22500')), 0, 'X', 52
...
Where SUBSTRING(nocuenta ,1,5) In ('21500','21600', '22400', '22500')),
(Select SUM(TotalCargos) From @eAcumuladoAnterior 
Where SUBSTRING(nocuenta ,1,5) In ('21500','21600', '22400', '22500')), 0, 'X', 59
