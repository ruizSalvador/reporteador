...
update @Tmp_BalanzaDeComprobacion set MaskNombreCuenta=t.Nombre  from @TablaTitulos t join @Tmp_BalanzaDeComprobacion b on t.Numerocuenta=b.MaskNumeroCuenta 
