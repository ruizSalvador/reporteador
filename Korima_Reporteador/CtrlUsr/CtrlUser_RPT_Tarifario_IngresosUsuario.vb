...
Public Class CtrlUser_RPT_Tarifario_IngresosUsuario
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_Tarifario_IngresosUsuario
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_TarifarioIngresosUsuario", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_TarifarioIngresosUsuario")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_TarifarioIngresosUsuario"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Reporte Tarifario de Ingresos por Usuario"
