...
Public Class CtrlUser_RPT_Relacion_Analitica_Mobiliario_Equipo_Admon

    Dim reporte As RPT_Relacion_Analitica_De_Mobiliario_Equipo_Admin
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim SP As String = "SP_RPT_Relacion_Analitica_Mobiliario_Equipo_Admon_ISAF"
        reporte = New RPT_Relacion_Analitica_De_Mobiliario_Equipo_Admin()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Relacion Analitica de Mobiliarios y Equipos de Admon ISAF' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Relación Analítica de Mobiliario y Equipo Administración"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Relacion Analitica de Mobiliarios y Equipos de Admon ISAF' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
