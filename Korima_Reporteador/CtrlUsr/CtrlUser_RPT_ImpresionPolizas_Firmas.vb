...
Public Class CtrlUser_RPT_ImpresionPolizas_Firmas
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_ImpresionPolizas_Firmas()
        ...
        SQLComando.Parameters.Add(New SqlParameter("@FolioDel", nmrDel.Text))
        SQLComando.Parameters.Add(New SqlParameter("@FolioAl", nmrAl.Text))
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas3 where Formato = " & "'" & "Impresión de Polizas" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
        Dim dsC As New DataSet()
        dsC.EnforceConstraints = False
        adapterC.Fill(dsC, "VW_RPT_K2_Firmas3")
        reporte.XrSubreport1.ReportSource.DataSource = dsC
        reporte.XrSubreport1.ReportSource.DataAdapter = adapterC
        reporte.XrSubreport1.ReportSource.DataMember = "VW_RPT_K2_Firmas3"
