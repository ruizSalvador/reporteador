...
Public Class CtrlUser_RPT_CategoriasPlazasAutorizadas
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_CategoriasPlazasAutorizadas()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_CategoriasPlazasAutorizadas", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_CategoriasPlazasAutorizadas")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_CategoriasPlazasAutorizadas"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Analítico de Categorías / Plazas Autorizadas con su Tabulador"
            '.lblFechaRango.Text = ""
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= '" & "Analítico de Categorías Plazas Autorizadas con su Tabulador FONE" & "'", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = " & "'" & "Analítico de Categorías Plazas Autorizadas con su Tabulador FONE" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
