...
Public Class CtrlUser_RPT_LibroMayor
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_LibroMayor
        ...
        'If (FilterCuenta.Text <> "" Or FilterCuentaAfectable.Text <> "") Then
        ...
        ''Se limita funcionalidad a un solo mes solo por esta version
        ...
        '    FiltroSQL &= " AND NumeroCuentaContable = '" & FilterCuentaAfectable.Text & "'" '& " OR CuentaAcumulacion LIKE " & "'" & strFiltro & "%')"
        'End If
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_LibroMayor", SQLConexion)
        ...
        'adapter = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_LibroMayor " & FiltroSQL & " ORDER BY NumeroCuentaContable, Fecha", cnnString)

        Dim ds As New DataSet()
        ds.EnforceConstraints = False
        adapter.Fill(ds, "SP_RPT_K2_LibroMayor")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_LibroMayor"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Libro Mayor"
            ...
            'Se limita la funcionalidad a un solo mes por esta version
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Libro Mayor' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
