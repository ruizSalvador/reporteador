...
Public Class CtrlUser_RPT_EstadodelEjerciciodelPresupuesto4Niveles
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_EstadoEjercicioPresupuestoEGR4Niveles", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_EstadoEjercicioPresupuestoEGR4Niveles")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_EstadoEjercicioPresupuestoEGR4Niveles"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            If ChkAnual.Checked = False Then
                .lblRptDescripcionFiltrado.Text = "Del " + primero.Day.ToString + " " + MesLetra(primero.Month) + " al " + ultimo.Day.ToString + " " + MesLetra(ultimo.Month) + " del " + Year(filterPeriodoAl.EditValue).ToString
