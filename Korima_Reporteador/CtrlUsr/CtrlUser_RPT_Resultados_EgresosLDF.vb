...
Public Class CtrlUser_RPT_Resultados_EgresosLDF
    Dim TipoReporte
    ...
    Public reporte As RPT_Resultado_EgresosLDF
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        reporte = New RPT_Resultado_EgresosLDF()
        ...
        Else
            command.Parameters.Add(New SqlParameter("@IdArea", 0))
        End If
        ...
        adapter.Fill(ds, "SP_Resultados_Egresos")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_Resultados_Egresos"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = '" & "LDF Resultados Egresos" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Resultados de Egresos-LDF"
    ...
    Public Sub BarButtonItem4_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs)
        ...
        frm.Text = "Resultados de Egresos"
