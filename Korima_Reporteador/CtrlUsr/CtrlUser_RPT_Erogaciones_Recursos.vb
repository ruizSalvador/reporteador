...
Public Class CtrlUser_RPT_Erogaciones_Recursos
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_Erogaciones_de_Recursos()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("RPT_SP_Erogaciones_Recursos", SQLConexion)
        ...
        SQLComando.Parameters.Add(New SqlParameter("@IdFF", IIf(filterFuenteFinanciamiento.Text = "", 0, Convert.ToInt32(filterFuenteFinanciamiento.EditValue))))
        ...
        adapter.Fill(ds, "RPT_SP_Erogaciones_Recursos")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "RPT_SP_Erogaciones_Recursos"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "INTEGRACIÓN DE LOS EGRESOS DEL PARTICIPACIONES FEDERALES A MUNICIPIOS (PARTICIPACIONES A MUN)"
            '.lblFechaRango.Text = ""
            .lblRptDescripcionFiltrado.Text = ""
            .lblTitulo.Text = "" '"Ejercicio " + Year(filterPeriodoAl.EditValue).ToString
            '.lblDiciembre.Text = "" '"Polizas de la Fuente de Financiamiento: " + filterFuenteFinanciamiento.Text
            ...
            .lblRptDescripcionFiltrado.Text = "Período de " & MesLetra(filterPeriodoDe.EditValue.Month) & " a " & MesLetra(filterPeriodoHasta.EditValue.Month) & " del " & filterPeriodoAl.EditValue.Year.ToString()    '"Del " & Primer & " al " & Ultimo
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= '" & "Erogaciones de Recursos Recibidos" & "'", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = " & "'" & "Erogaciones de Recursos Recibidos" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
