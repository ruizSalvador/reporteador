...
Public Class CtrlUser_RPT_ClasificacionServiciosPresCat
    Dim TipoReporte
    ...
    Public reporte As RPT_ClasificacionServiciosPresCat
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        reporte = New RPT_ClasificacionServiciosPresCat()
        ...
        Dim command As New SqlCommand("SP_EstadoEjercicio_PresupuestoEgresosDetallado", conection)
        command.CommandType = CommandType.StoredProcedure
        command.Parameters.Add(New SqlParameter("@Mes", Month(filterPeriodoDe.EditValue)))
        command.Parameters.Add(New SqlParameter("@Mes2", Month(filterPeriodoDe2.EditValue)))
        command.Parameters.Add(New SqlParameter("@Ejercicio", Year(filterPeriodoAl.EditValue)))
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = '" & "LDF Clasificación de servicios personales por categoría" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .XrLabel1.Text = "(PESOS)"
            .lblTitulo.Text = "Clasificacion de Servicios Personales por Categoria"
            .lblSubtitulo.Text = ""
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='LDF Clasificación de servicios personales por categoría' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
