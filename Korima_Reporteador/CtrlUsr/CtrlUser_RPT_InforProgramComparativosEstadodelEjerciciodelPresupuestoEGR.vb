...
Public Class CtrlUser_RPT_InforProgramComparativosEstadodelEjerciciodelPresupuestoEGR
    ...
    Public Function AsignaReporte() As Object
        ...
        Select Case REPORTE
            ...
            Case 1
                ...
                Me.FIRMAS = "IPComp:Ramo o Dependencia / Función / Programa Presupuestario / Actividad Institucional"
                rpt = New RPT_InfProgramComparativosEdoEjercicioPresupuestal4Colum3Niveles()
                Return rpt


            Case 2
                Me.nomREPORTE = "Informe Programático"
                Me.TITULO = "Ramo o Dependencia / UR / Programa Presupuestario / Actividad Institucional / Objeto del Gasto por Capítulo"
                ...
                Me.FIRMAS = "IPComp:Ramo o Dependencia / UR / Programa Presupuestario / Actividad Institucional / Objeto del Gasto por Capítulo"
                rpt = New RPT_InfProgramComparativosEdoEjercicioPresupuestal5Colum4Niveles()
            ...
            Case 3
                Me.nomREPORTE = "Informe Programático"
                Me.TITULO = "Ramo o Dependencia /Programa Presupuestario / Actividad Institucional / Objeto del Gasto por Capítulo / Clasificación Económica"
                Me.SUBTITULO = filterRamoDependenciaDe.Text & " - " & filterRamoDependenciaA.Text
                Me.nomTipoReporte = "Ejercicio del Presupuesto"
                ...
                Me.FIRMAS = "IPComp:Ramo o Dependencia /Programa Presupuestario / Actividad Institucional / Objeto del Gasto por Capítulo / Clasificación Económica"
                rpt = New RPT_InfProgramComparativosEdoEjercicioPresupuestal5Colum4NivelesA()
                Return rpt


            Case 4
                Me.nomREPORTE = "Informe Programático"
                Me.TITULO = "Ramo o Dependencia / UR / Programa Presupuestario / Actividad Institucional / Objeto del Gasto por Partida Genérica / Fuente de Financiamiento"
                Me.SUBTITULO = filterRamoDependenciaDe.Text & " - " & filterRamoDependenciaA.Text & " - " & filterUnidadResponsable.Text
                Me.nomTipoReporte = "Ejercicio del Presupuesto"
                Me.nomTipoClaves = "UR"
                Me.nomTipoClaves1 = "Programa"
                ...
                Me.FIRMAS = "IPComp:Ramo o Dependencia / UR / Programa Presupuestario / Actividad Institucional / Objeto del Gasto por Partida Genérica / Fuente de Financiamiento"
                rpt = New RPT_InfProgramComparativosEdoEjercicioPresupuestal6Colum5Niveles()
                Me.filterUnidadResponsable.Enabled = True
                Me.SimpleButton4.Enabled = True
                Me.filterUnidadResponsable.Visible = True
                Me.SimpleButton4.Visible = True
            ...
            Case 5
                Me.nomREPORTE = "Informe Programático"
                Me.TITULO = "Ramo o Dependencia / UR / Programa Presupuestario / Actividad Institucional / Objeto del Gasto por Partida Genérica / Distribución Georgráfica"
                Me.SUBTITULO = filterRamoDependenciaDe.Text & " - " & filterRamoDependenciaA.Text & " - " & filterUnidadResponsable.Text
                Me.nomTipoReporte = "Ejercicio del Presupuesto"
                Me.nomTipoClaves = "UR"
                Me.nomTipoClaves1 = "Programa"
                ...
                Me.FIRMAS = "IPComp:Ramo o Dependencia / UR / Programa Presupuestario / Actividad Institucional / Objeto del Gasto por Partida Genérica / Distribución Georgráfica"
                rpt = New RPT_InfProgramComparativosEdoEjercicioPresupuestal6Colum5Niveles()
                Me.filterUnidadResponsable.Enabled = True
                Me.SimpleButton4.Enabled = True
                Me.filterUnidadResponsable.Visible = True
            ...
            Case 6
                ...
                Me.FIRMAS = "IPComp:Ramo o Dependencia / Función / Programas y Proyectos de Inversión"
                rpt = New RPT_InfProgramComparativosEdoEjercicioPresupuestal4Colum3NivelesProy()
                Return rpt


            Case 7
                Me.nomREPORTE = "Informe Programático"
                Me.TITULO = "Ramo o Dependencia / UR / Programas y Proyectos de Inversión / Objeto del Gasto por Capítulo / Clasificación Económica"
                Me.SUBTITULO = filterRamoDependenciaDe.Text & " - " & filterRamoDependenciaA.Text & " - " & filterUnidadResponsable.Text
                Me.nomTipoReporte = "Ejercicio del Presupuesto"
                Me.nomTipoClaves = "UR"
                Me.nomTipoClaves1 = "Programa"
                ...
                Me.FIRMAS = "IPComp:Ramo o Dependencia / UR / Programas y Proyectos de Inversión / Objeto del Gasto por Capítulo / Clasificación Económica"
                rpt = New RPT_InfProgramComparativosEdoEjercicioPresupuestal6Colum6Niveles_Proy()
                Me.filterUnidadResponsable.Enabled = True
                Me.SimpleButton4.Enabled = True
                Me.filterUnidadResponsable.Visible = True
                Me.SimpleButton4.Visible = True
            ...
            Case 8
                Me.nomREPORTE = "Informe Programático"
                Me.TITULO = "Ramo o Dependencia / UR / Programas y Proyectos de Inversión / Objeto del Gasto por Partida Genérica / Fuente de Financiamiento"
                Me.SUBTITULO = filterRamoDependenciaDe.Text & " - " & filterRamoDependenciaA.Text & " - " & filterUnidadResponsable.Text
                Me.nomTipoReporte = "Ejercicio del Presupuesto"
                Me.nomTipoClaves = "UR"
                Me.nomTipoClaves1 = "Programa"
                ...
                Me.nomTipoClaves3 = "Objeto"
                Me.nomTipoClaves4 = "Fuente Financiam"
                Me.FIRMAS = "IPComp:Ramo o Dependencia / UR / Programas y Proyectos de Inversión / Objeto del Gasto por Partida Genérica / Fuente de Financiamiento"
                rpt = New RPT_InfProgramComparativosEdoEjercicioPresupuestal6Colum5NivelesProy()
                Me.filterUnidadResponsable.Enabled = True
                Me.SimpleButton4.Enabled = True
                Me.filterUnidadResponsable.Visible = True
                Me.SimpleButton4.Visible = True
            ...
            Case 9
                Me.nomREPORTE = "Informe Programático"
                Me.TITULO = "Ramo o Dependencia / Distribución Georgáfica / Programas y Proyectos de Inversión"
                Me.SUBTITULO = filterRamoDependenciaDe.Text & " - " & filterRamoDependenciaA.Text
                Me.nomTipoReporte = "Ejercicio del Presupuesto"
                Me.nomTipoClaves = "Dist.Geog."
                Me.nomTipoClaves1 = "Programa"
                Me.nomTipoClaves2 = "Proyecto"
                Me.FIRMAS = "IPComp:Ramo o Dependencia / Distribución Geográfica / Programas y Proyectos de Inversión"
                rpt = New RPT_InfProgramComparativosEdoEjercicioPresupuestal4Colum3NivelesProy()
                Return rpt
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        If ChkRelativo.Checked = True Then
            ...
            SQLConexion.Open()
            Dim SQLComando As New SqlCommand("SP_RPT_InfProgramComparativosEstadoEjercicioPresupuestoEGR", SQLConexion)
            ...
            adapter.SelectCommand.CommandTimeout = 900 '-- Alvirde
            ds.EnforceConstraints = False
            adapter.Fill(ds, "SP_RPT_InfProgramComparativosEstadoEjercicioPresupuestoEGR")
            reporte.DataSource = ds
            reporte.DataAdapter = adapter
            reporte.DataMember = "SP_RPT_InfProgramComparativosEstadoEjercicioPresupuestoEGR"
            SQLComando.Dispose()
            SQLConexion.Close()

            '--Fin SP

        ElseIf ChkRelativo.Checked = False Then
            ...
            SQLConexion = New SqlConnection(cnnString)
            SQLConexion.Open()
            Dim SQLComando As New SqlCommand("SP_RPT_InfProgramComparativosVRelEstadoEjercicioPresupuestoEGR", SQLConexion)
            SQLComando.CommandType = CommandType.StoredProcedure
            ...
            Dim ds As New DataSet()
            ds.EnforceConstraints = False
            adapter.Fill(ds, "SP_RPT_InfProgramComparativosVRelEstadoEjercicioPresupuestoEGR")
            reporte.DataSource = ds
            reporte.DataAdapter = adapter
            reporte.DataMember = "SP_RPT_InfProgramComparativosVRelEstadoEjercicioPresupuestoEGR"
            SQLComando.Dispose()
            SQLConexion.Close()
    ...
    Private Sub ChkAnual_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkAnual.CheckedChanged
        ...
        ElseIf ChkAnual.Checked = False And filterPeriodoInicio.EditValue = "" And filterPeriodoFinal.EditValue = "" Then
            filterPeriodoInicio.EditValue = Now
            filterPeriodoFinal.EditValue = Now
        End If
