...
Public Class CtrlUser_RPT_PolizaAuxiliarMayor_Fechas
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_AuxiliarMayor_Fechas", SQLConexion)
        ...
        SQLComando.Parameters.Add(New SqlParameter("@FechaIni", dtFechaIni.DateTime))
        SQLComando.Parameters.Add(New SqlParameter("@FechaFin", dtFechaFin.DateTime))
        ...
        adapter.Fill(ds, "SP_RPT_K2_AuxiliarMayor_Fechas")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_AuxiliarMayor_Fechas"
