...
Public Class CtrlUser_RPT_RelacionBienesPatrimonioFiltrado
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_RelacionBienesPatrimonioFiltrado
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_RelacionBienesPatrimonioPeriodoFiltrado", SQLConexion)
        ...
        SQLComando.Parameters.Add(New SqlParameter("@IdTipoBien", TipoBien(cmbTipoBien.Text)))
        ...
        adapter.Fill(ds, "SP_RPT_K2_RelacionBienesPatrimonioPeriodoFiltrado")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_RelacionBienesPatrimonioPeriodoFiltrado"
        ...
        With reporte
            ...
            Else
                .lblRptDescripcionFiltrado.Text = "Cuenta Pública del 1/" + tmMesIni.Text + "/" + filterPeriodoAl.Text + " Al " + lastDay.AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") 'segundo.ToString("dd/MM/yyyy")
            End If
            ...
            .lblSubtitulo.Text = cmbTipoBien.Text
