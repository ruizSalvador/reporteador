...
Public Class CtrlUser_RPT_EstadoEjercicioIngresos_CE_Rubro_Tipo
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_EstadoEjercicioIngresos_CE_Rubro_Tipo
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_EstadoEjercicioIngresos_CE_Rubro_Tipo", SQLConexion)
        ...
        adapter.Fill(ds, "SP_EstadoEjercicioIngresos_CE_Rubro_Tipo")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_EstadoEjercicioIngresos_CE_Rubro_Tipo"
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Por Clasificación Economica/Rubro/Tipo' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblTitulo.Text = "Clasificación económica / Rubro / Tipo"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Por Clasificación Economica/Rubro/Tipo' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
