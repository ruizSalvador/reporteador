...
Public Class CtrlUser_RPT_Layout_Egresos
    Dim Año As String
    Dim Mes As String
    ...
    Private Sub SimpleButton4_Click(sender As System.Object, e As System.EventArgs) Handles SimpleButton4.Click
        ...
        If dr = DialogResult.OK Then
            If FolderBrowserDialog1.SelectedPath <> "" Then 'And dr = DialogResult.OK Then
                ...
                PathArchivo = FolderBrowserDialog1.SelectedPath + "\Formato_Layout_Egresos" + Año + Mes + ".txt"
            End If
            ...
            Try
                ...
                SQLConexion.Open()
                Dim SQLComando As New SqlCommand("SP_RPT_LayoutEgresos", SQLConexion)
                ...
                adapter.Fill(ds, "SP_RPT_LayoutEgresos")
                SQLComando.Dispose()
                SQLConexion.Close()
                '------------------------------
                ...
                For Each curr As DataRow In tbl.Rows
                    If curr(0).ToString = "MP" Then
                        strStreamWriter.WriteLine(curr(0).ToString + "|" + curr(1).ToString + "|" + curr(2).ToString + "|" + curr(3).ToString + "|" + curr(4).ToString + "|" + curr(5).ToString + "|" + curr(6).ToString + "|" + curr(7).ToString + "|" + curr(8).ToString + "|" + curr(9).ToString + "|" + curr(10).ToString + "|" + curr(11).ToString + "|" + curr(12).ToString + "|" + curr(13).ToString)
                    Else
                        strStreamWriter.WriteLine(curr(0).ToString + "|" + curr(1).ToString + "|" + curr(2).ToString + "|" + curr(3).ToString + "|" + curr(4).ToString + "|" + curr(5).ToString + "|" + curr(6).ToString + "|" + curr(7).ToString + "|" + curr(8).ToString + "|" + curr(9).ToString + "|" + curr(10).ToString + "|" + curr(11).ToString + "|" + curr(12).ToString + "|" + curr(13).ToString + "|" + curr(14).ToString +
                                                  "|" + curr(15).ToString + "|" + curr(16).ToString + "|" + curr(17).ToString + "|" + curr(18).ToString + "|" + curr(19).ToString + "|" + curr(20).ToString + "|" + curr(21).ToString + "|" + curr(22).ToString + "|" + curr(23).ToString + "|" + curr(24).ToString + "|" + curr(25).ToString + "|" + curr(26).ToString)
                    End If
                Next
