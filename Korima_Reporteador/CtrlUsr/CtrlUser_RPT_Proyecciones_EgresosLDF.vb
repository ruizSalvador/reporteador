...
Public Class CtrlUser_RPT_ProyeccionesEgresosLDF
    Dim TipoReporte
    ...
    Public reporte As RPT_Proyecciones_EgresosLDF
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        reporte = New RPT_Proyecciones_EgresosLDF()
        ...
        Dim command As New SqlCommand("SP_Proyecciones_Egresos", conection)
        ...
        adapter.Fill(ds, "SP_Proyecciones_Egresos")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_Proyecciones_Egresos"

        'Firmas 
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = '" & "LDF Proyecciones de Egresos" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Proyecciones de Egresos-LDF"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='LDF Proyecciones de Egresos' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
