...
Public Class CtrlUser_RPT__Relacion_DE_Adquisiciones_DE_Bienes_Muebles_E_Inmuebles
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT__Relacion_DE_Adquisiciones_DE_Bienes_Muebles_E_Inmuebles
        ...
        Dim SQLComando As New SqlCommand("SP_RPT__Relacion_DE_Adquisiciones_DE_Bienes_Muebles_E_Inmuebles", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT__Relacion_DE_Adquisiciones_DE_Bienes_Muebles_E_Inmuebles")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter

        reporte.DataMember = "SP_RPT__Relacion_DE_Adquisiciones_DE_Bienes_Muebles_E_Inmuebles"
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'RELACIÓN DE ADQUISICIONES DE BIENES MUEBLES E INMUEBLES' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        With reporte
            ...
            .lblTitulo.Text = ""
            .lblRptNombreReporte.Text = "RELACIÓN DE ADQUISICIONES DE BIENES MUEBLES E INMUEBLES"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='RELACIÓN DE ADQUISICIONES DE BIENES MUEBLES E INMUEBLES' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
