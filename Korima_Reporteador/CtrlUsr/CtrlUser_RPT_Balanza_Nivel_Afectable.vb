...
Public Class CtrlUser_RPT_Balanza_Nivel_Afectable
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_Balanza_Nivel_Afectable
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("RPT_SP_Balanza_Nivel_Afectable", SQLConexion)
        ...
        adapter.Fill(ds, "RPT_SP_Balanza_Nivel_Afectable")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "RPT_SP_Balanza_Nivel_Afectable"
