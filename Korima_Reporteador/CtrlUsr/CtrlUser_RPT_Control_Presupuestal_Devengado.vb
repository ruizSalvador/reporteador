...
Public Class CtrlUser_RPT_Control_Presupuestal_Devengado
    ...
    Public Function AsignaReporte() As Object
        ...
        Me.nomREPORTE = "Control Presupuestal del Egreso-Devengado"
        Me.TITULO = ""
        Me.nomTipoReporte = ""
        Me.nomTipoClaves = ""
        Me.FIRMAS = "Control Presupuestal del Egreso-Devengado"
        Me.SP = 21
        rpt = New RPT_Control_Presupuestal_Devengado()
        Return rpt
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_Control_Presupuestal_Devengado", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_Control_Presupuestal_Devengado")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_Control_Presupuestal_Devengado"
        SQLComando.Dispose()
        SQLConexion.Close()
