...
Public Class CtrlUser_RPT_Estado_De_Actividades_Detallado

    Dim reporte As RPT_Estado_De_Actividades_Detallado
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        If chkNivel.Checked = True Then
            SP = "REPORTE_Estado_De_ActividadesRedondeo_UltimoNivel"
        Else
            SP = "REPORTE_Estado_De_ActividadesRedondeo_Detallado"
        End If
        'Dim SP As String = "REPORTE_Estado_De_ActividadesRedondeo_Detallado"
        reporte = New RPT_Estado_De_Actividades_Detallado()
