...
Public Class CtrlUser_RPT_PolizaAuxiliarMayorCveIng
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_AuxiliarMayorCveIngresos
        ...
        SQLComando.Parameters.Add(New SqlParameter("@CvePres", IIf(srchSello1.Text.Length = 0, 0, Convert.ToInt32(srchSello1.EditValue))))
        SQLComando.Parameters.Add(New SqlParameter("@CvePres2", IIf(srchSello2.Text.Length = 0, 0, Convert.ToInt32(srchSello2.EditValue))))
        ...
        adapter.Fill(ds, "SP_RPT_K2_AuxiliarMayorCveIng")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_AuxiliarMayorCveIng"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "AUXILIAR DE MAYOR CLAVES DE INGRESOS."
    ...
    Private Sub CtrlUser_RPT_Adquisiciones_OrdenCompraPartida_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With srchSello1.Properties
            .DataSource = ObjTempSQL2.List(" Ejercicio = " & FilterEjercicio.Text, 0, "C_PartidasGastosIngresos", " Order by IdPartidaGI ")
            .DisplayMember = "Clave"
            .ValueMember = "IdPartidaGI"
            '.SearchMode = DevExpress.XtraEditors.Controls.SearchMode.AutoFilter
            .NullText = ""
            '.ShowHeader = True
        End With
