...
Public Class CtrlUser_RPT_PuntoRecaudacionTarifario
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_PuntoRecaudacionTarifario
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_PuntoRecaudacionTarifario", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_PuntoRecaudacionTarifario")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_PuntoRecaudacionTarifario"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Reporte Ingresos Por Punto Recaudación y Tarifario"
    ...
    Private Sub filterDelTarifario_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub filterAlTarifario_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub ChkMuestraNulos_CheckedChanged(sender As System.Object, e As System.EventArgs)
