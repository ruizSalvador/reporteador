...
Public Class CtrlUser_RPT_Anexo_1000
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_Anexo_1000_Nomina()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_Anexos_1000", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_Anexos_1000")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_Anexos_1000"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Anexo 4- 1000"
            '.lblFechaRango.Text = ""
