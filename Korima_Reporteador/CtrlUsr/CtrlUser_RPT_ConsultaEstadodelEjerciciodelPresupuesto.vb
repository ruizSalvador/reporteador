...
Public Class CtrlUser_RPT_ConsultaEstadodelEjerciciodelPresupuesto
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_ConsultaEstadodelEjerciciodelPresupuesto", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_ConsultaEstadodelEjerciciodelPresupuesto")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_ConsultaEstadodelEjerciciodelPresupuesto"
        SQLComando.Dispose()
        SQLConexion.Close()
