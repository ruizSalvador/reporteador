...
Public Class CtrlUser_RPT_Adquisiciones_OrdenCompraDependecia

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Dim reporte As New RPT_Adquisiciones_OrdenCompraDependecia()
        ...
        Dim adapter As New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Adquisiciones_OrdenesCompra_Dependencia Where " & FiltroSQL, cnnString)
        ...
        reporte.DataMember = "VW_RPT_K2_Adquisiciones_OrdenesCompra_Dependencia"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Reporte de Ordenes de Compra por Unidad Responsable y Partida "
            .lblFechaRango.Text = ""
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Reporte de Ordenes de Compra por Unidad Responsable y Partida' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
    ...
    Private Sub filterPartida_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles filterPartida.EditValueChanged
