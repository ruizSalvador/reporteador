...
Public Class CtrlUser_RPT_Matriz_RecaudadoIngresosSinDevengado
    Dim TipoReporte
    ...
    Public reporte As RPT_MatrizRecaudadoIngresosSinDev
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_MatrizRecaudadoIngresosSinDev
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_MatrizIngresosDevengadosyRecaudadoSimultaneos", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_MatrizIngresosDevengadosyRecaudadoSimultaneos")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_MatrizIngresosDevengadosyRecaudadoSimultaneos"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "B.3 Matriz de Ingresos Devengados y Recaudados Simultáneos"
            .lblTitulo.Text = ""
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Matriz Devengado Gasto' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
