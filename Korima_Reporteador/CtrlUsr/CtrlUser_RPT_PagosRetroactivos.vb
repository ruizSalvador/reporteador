...
Public Class CtrlUser_RPT_PagosRetroactivos
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_PagosRetroactivos()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_PagosRetroactivos", SQLConexion)
        ...
        If filterNomina.Text <> "" Then
            SQLComando.Parameters.Add(New SqlParameter("@Nomina", filterNomina.EditValue))
        End If

        If filterNomina.Text = "" Then
            SQLComando.Parameters.Add(New SqlParameter("@Nomina", ""))
        ...
        adapter.Fill(ds, "SP_RPT_PagosRetroactivos")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_PagosRetroactivos"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "RFC de Trabajadores con Pagos Retroactivos con un Periodo Mayor a 45 días"
            '.lblFechaRango.Text = ""
            .lblRptDescripcionFiltrado.Text = TrimesteLetra() '"Del 01/" + filterPeriodoInicio.Time.Month.ToString() + "/" + filterPeriodoAl.Time.Year.ToString() + " al " + segundo.ToString("dd/MM/yyyy") 'ultimo.ToString("dd/MM/yyyy") "Periodo: al " & ultimo.Day.ToString & " de " & MesLetra(Month(filterPeriodoDe.EditValue)) & " Del " & Year(filterPeriodoAl.EditValue).ToString
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= '" & "Pagos Retroactivos FONE" & "'", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = " & "'" & "Pagos Retroactivos FONE" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
    ...
    Private Sub CtrlUser_RPT_Adquisiciones_OrdenCompraPartida_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With filterNomina.Properties
            .DataSource = ObjTempSQL.List("", 0, "T_ImportaNomina", " Order by IdNomina ")
            .DisplayMember = "Observaciones"
            .ValueMember = "Observaciones"
            .SearchMode = DevExpress.XtraEditors.Controls.SearchMode.AutoFilter
            .NullText = ""
            .ShowHeader = True
        End With
    ...
    Private Sub filterNomina_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles filterNomina.GotFocus
        Dim ObjTempSQL As New clsRPT_CFG_DatosEntesCtrl
        With filterNomina.Properties
            .DataSource = ObjTempSQL.List("", 0, "T_ImportaNomina", " Order by IdNomina ")
            .DisplayMember = "Observaciones"
    ...
    Private Sub SimpleButton3_Click(sender As System.Object, e As System.EventArgs) Handles SimpleButton3.Click
        filterNomina.Properties.DataSource = Nothing
        filterNomina.Properties.NullText = ""
    End Sub
End Class
