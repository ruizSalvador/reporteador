...
Public Class CtrlUser_RPT_Balanza_Auditoria_ASEJ

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        Dim reporte As New RPT_Balanza_Comprobacion_ASEJ()
        ...
        Dim SQLComando As New SqlCommand("RPT_SP_K2_Balanza_Comprobacion_ASEJ", SQLConexion)
        ...
        SQLComando.Parameters.Add(New SqlParameter("@SaldoMayor0", RBTSaldoMayor0.Checked))
        SQLComando.Parameters.Add(New SqlParameter("@ConMovimientos", RBTMovimientos.Checked))
        SQLComando.Parameters.Add(New SqlParameter("@MovimientoySaldoNOcero", RBTMovimientoSaldoNOcero.Checked))
        SQLComando.Parameters.Add(New SqlParameter("@MovimientoOSaldoNOcero", RBTMovimientoOSaldoNOcero.Checked))
        SQLComando.Parameters.Add(New SqlParameter("@CuentasDeMayor", ChkMayor.Checked))
        SQLComando.Parameters.Add(New SqlParameter("@CuentasDeOrden", ChkDeOrden.Checked))
        ...
        adapter.Fill(ds, "RPT_SP_K2_Balanza_Comprobacion_ASEJ")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "RPT_SP_K2_Balanza_Comprobacion_ASEJ"
    ...
    Private Sub CtrlUser_RPT_Adquisiciones_OrdenCompraPartida_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With LUE_RangoDe.Properties
            ...
            .DataSource = ObjTempSQL2.List(" charindex('-',NumeroCuenta) = 0 and Nivel < 6", 0, "C_BalanzaASEJ", " Order by NumeroCuenta ")
            .DisplayMember = "NumeroCuenta"
            .ValueMember = "IdCuenta"
