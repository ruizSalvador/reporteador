...
Public Class CtrlUser_RPT_Guia_Cumplimiento_LDF
    Dim TipoReporte
    ...
    Public reporte As RPT_Guia_Cumplimiento_LDF
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        reporte = New RPT_Guia_Cumplimiento_LDF()
        ...
        adapter.Fill(ds, "SP_Guia_Cumplimiento_LDF")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_Guia_Cumplimiento_LDF"
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Guía de Cumplimiento de la Ley de Disciplina Financiera de las Entidades Federativas y Municipios"
            .lblRptDescripcionFiltrado.Text = "Del 1 de Enero Al 31 de Diciembre del " & filterPeriodoAl.Time.Year.ToString
