...
Public Class CtrlUser_RPT_Adquisiciones_OrdenCompraServicioProveedorDetallado

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        Dim reporte As New RPT_Adquisiciones_OrdenCompraServicioProveedorDetallado()
        ...
        Dim adapter As New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Adquisiciones_OrdenesCompraServicioDependenciaPartidaProveedor Where " & FiltroSQL & " ORDER BY IdProveedor,UnidadResponsable_Clave,Folio,PedidosDetalle_Fecha,ClavePartida ", cnnString)
        ...
        With reporte
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='OC/OS Detallado Por Proveedor' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
