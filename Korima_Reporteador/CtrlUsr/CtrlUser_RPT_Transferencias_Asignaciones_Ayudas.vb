...
Public Class CtrlUser_RPT_Transferencias_Asignaciones_Ayudas

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Me.Cursor = Cursors.WaitCursor
        SplitContainerControl1.Collapsed = True
        ErrorProvider1.Clear()
        Dim reporte As New RPT_Transferencias_Asignaciones_Ayudas
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_Transferencias_Asignaciones_Ayudas", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_Transferencias_Asignaciones_Ayudas")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_Transferencias_Asignaciones_Ayudas"
        ...
        With reporte
            ...
            .lblTitulo.Text = ""
            .lblSubtitulo.Text = ""
            .lblRptNombreReporte.Text = "DESGLOSE DE TRANSFERENCIAS, ASIGNACIONES, SUBSIDIOS Y OTRAS AYUDAS"
