...
Public Class CtrlUser_RPT_AnaliticodelPasivoPeriodos
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_AnaliticodelPasivo
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_AnaliticoPasivoPeriodos", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_K2_AnaliticoPasivoPeriodos")
        reporte.DataSource = ds

        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_K2_AnaliticoPasivoPeriodos"

        'subreporte 

        Dim SQLComando2 As New SqlCommand("SP_RPT_K2_AnaliticoPasivoPeriodos", SQLConexion)
        ...
        SQLComando2.Parameters.Add(New SqlParameter("@Periodo2", filterPeriodoAl.Time.Month))
        ...
        SQLComando2.CommandTimeout = 99999
        ...
        adapterB.Fill(dsB, "SP_RPT_K2_AnaliticoPasivoPeriodos")
        reporte.subreport1.ReportSource.DataSource = dsB
        reporte.subreport1.ReportSource.DataAdapter = adapterB
        reporte.subreport1.ReportSource.DataMember = "SP_RPT_K2_AnaliticoPasivoPeriodos"

        'Firmas Analítico del Pasivo por Periodos
        Dim adapterC As SqlClient.SqlDataAdapter
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Analítico del Pasivo por Periodos' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        Dim lastDay As DateTime = (New DateTime(Year(FilterEjercicio.EditValue), Month(filterPeriodoDe.EditValue), 1))
        Dim SecondDay As DateTime = (New DateTime(Year(FilterEjercicio.EditValue), Month(filterPeriodoAl.EditValue), 1))


        With reporte
            .lblRptNombreEnte.Text = pRPTCFGDatosEntes.Nombre
            .XrLabel1.Visible = ChkMiles.Checked
            .lblRptNombreReporte.Text = "Estado Analitico del Pasivo por Periodos"
            ...
            .lblRptDescripcionFiltrado.Text = "Del " + lastDay.ToString("dd/MM/yyyy") + " Al " + SecondDay.AddMonths(1).AddDays(-1).ToString("dd/MM/yyyy") '"Periodo: " & MesLetra(Month(filterPeriodoDe.EditValue)) & " Del " & Year(FilterEjercicio.EditValue).ToString
            .XrLblUsr.Text = "Generado por: " + MDI_Principal.strUsuario
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Analítico del Pasivo por Periodos' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
