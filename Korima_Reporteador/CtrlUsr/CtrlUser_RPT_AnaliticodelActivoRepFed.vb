...
Public Class CtrlUser_RPT_AnaliticodelactivoRepFed
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_AnaliticodelActivoRepFed
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_K2_AnaliticoActivo", SQLConexion)
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = 'Analitico del activo' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden ", cnnString)
        ...
        ElseIf filterPeriodoDe.SelectedText = "04" Or filterPeriodoDe.SelectedText = "06" Or filterPeriodoDe.SelectedText = "09" Or filterPeriodoDe.SelectedText = "11" Then
            day = 30
        ElseIf filterPeriodoDe.SelectedText = "01" Or filterPeriodoDe.SelectedText = "03" Or filterPeriodoDe.SelectedText = "07" Or filterPeriodoDe.SelectedText = "08" Or filterPeriodoDe.SelectedText = "10" Or filterPeriodoDe.SelectedText = "12" Then
            day = 31
        End If
        With reporte
            ...
            Else
                .XrLabel1.Text = "(Pesos)"
            End If
            .lblRptNombreReporte.Text = "Cuenta Pública " + filterPeriodoAl.Time.Year.ToString()
            .lblTitulo.Text = "Estado Analítico del Activo"
            ...
            'rango de Periodos queda como mejora para proxima version
            .lblRptDescripcionFiltrado.Text = " Del 1° de " & MesLetra(Month(filterPeriodoDe.EditValue)) & " al " + day.ToString() + " de " & MesLetra(Month(filterPeriodoDe.EditValue)) & " Del " & Year(filterPeriodoAl.EditValue).ToString
