...
Public Class CtrlUser_RPT_Relacion_Analitica_Vehiculos_Equipo_Transporte

    Dim reporte As RPT_Relacion_Analitica_Vehiculos_Equipo_Transporte
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim SP As String = "SP_RPT_Relacion_Analitica_Vehículos_Equipo_Transporte_ISAF"
        reporte = New RPT_Relacion_Analitica_Vehiculos_Equipo_Transporte
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas2 where Formato = 'Relacion Analitica de Vehiculos y Equipos de Transporte ISAF' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Relación Analítica de Vehículos y Equipo de Transporte"
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato='Relacion Analitica de Vehiculos y Equipos de Transporte ISAF' ", New SqlConnection(cnnString))
            cmd.Connection.Open()
