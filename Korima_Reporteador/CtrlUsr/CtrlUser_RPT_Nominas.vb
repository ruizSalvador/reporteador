...
Public Class CtrlUser_RPT_Nominas
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_Nominas", SQLConexion)
        ...
        adapter.Fill(ds, "SP_RPT_Nominas")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_Nominas"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "CONCENTRADO DE NÓMINAS"
            '.lblFechaRango.Text = ""
