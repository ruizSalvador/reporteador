...
Public Class CtrlUser_RPT_Layout_Presupuestal
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_Layout_Presupuestal()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_Layout_Presupuestal", SQLConexion)
        ...
        adapter.Fill(ds, "SP_Layout_Presupuestal")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_Layout_Presupuestal"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreEnte.Text = txtMayor.Text 'pRPTCFGDatosEntes.Nombre
            .lblRptNombreReporte.Text = txtCat.Text '"INGRESOS RECAUDADOS"
            '.lblFechaRango.Text = ""
            .lblRptDescripcionFiltrado.Text = txtDivisa.Text '"Periodo: " + MesLetra(Month(filterPeriodoDe.EditValue)) & " del " & Year(filterPeriodoAl.EditValue).ToString
            .lblTitulo.Text = txtOrigen.Text 'Ejercicio del " + Year(filterPeriodoAl.EditValue).ToString
            .XrLabel1.Text = dtFecha.Text '"Polizas de la Fuente de Financiamiento: " + filterFuenteFinanciamiento.Text
            .lblLote.Text = txtLote.Text
