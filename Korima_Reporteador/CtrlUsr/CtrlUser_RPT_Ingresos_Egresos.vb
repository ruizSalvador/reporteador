...
Public Class CtrlUser_RPT_Ingresos_Egresos
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_Ing_Egr", SQLConexion)
        ...
        adapter.Fill(ds, "SP_Ing_Egr")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_Ing_Egr"
        SQLComando.Dispose()
        SQLConexion.Close()
