...
Public Class CtrlUser_RPT_Proveedores

    Function Cmb_Local() As Integer
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte As New RPT_Proveedores
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_CatalogoProveedores", SQLConexion)
        ...
        SQLComando.Parameters.Add(New SqlParameter("@Local", Cmb_Local()))
        SQLComando.CommandTimeout = 9999999
        Dim adapter As New SqlClient.SqlDataAdapter(SQLComando)

        Dim ds As New DataSet()
        ds.EnforceConstraints = False
        adapter.Fill(ds, "SP_RPT_CatalogoProveedores")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_CatalogoProveedores"
