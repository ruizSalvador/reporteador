...
Public Class CtrlUser_RPT_CatalogoMatricesConversion
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_CatalogoMatricesConversion()
        ...
        SQLConexion.Open()
        Dim SQLComando As New SqlCommand("SP_RPT_CatalogoMatricesConversion", SQLConexion)
        ...
        SQLComando.Parameters.Add(New SqlParameter("@Tipo", cmbFilter.SelectedIndex))
        ...
        adapter.Fill(ds, "SP_RPT_CatalogoMatricesConversion")
        reporte.DataSource = ds
        reporte.DataAdapter = adapter
        reporte.DataMember = "SP_RPT_CatalogoMatricesConversion"
        SQLComando.Dispose()
        SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "CATÁLOGO MATRICES DE CONVERSIÓN"
            '.lblFechaRango.Text = ""
            .lblRptDescripcionFiltrado.Text = ""
            .lblTitulo.Text = "Al día " + Date.Now.ToString("dd/MM/yyyy")
            .XrLabel1.Text = ""
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= '" & "Catalogo Matrices de Conversión" & "'", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = " & "'" & "Catalogo Matrices de Conversión" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
