...
Public Class CtrlUser_RPT_RfcCurpFormatoIncorrecto
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        Dim reporte = New RPT_RfcCurpConFormatoIncorrecto()
        ...
        'SQLConexion.Open()
        'Dim SQLComando As New SqlCommand("SP_RPT_Plaza_Función", SQLConexion)
        ...
        'adapter.Fill(ds, "SP_RPT_Plaza_Función")
        'reporte.DataSource = ds
        'reporte.DataAdapter = adapter
        'reporte.DataMember = "SP_RPT_Plaza_Función"
        'SQLComando.Dispose()
        'SQLConexion.Close()
        ...
        With reporte
            ...
            .lblRptNombreReporte.Text = "Trabajadores que Cobran con RFC / CURP con Formato Incorrecto"
            '.lblFechaRango.Text = ""
            ...
            Dim cmd As New SqlCommand("SELECT TOP(1) T_Firmas.CodigoISO FROM C_Formatos JOIN T_Firmas ON C_Formatos.IdFormato = T_Firmas.IdFormato  Where Formato= '" & "RFC/CURP con Formato Incorrecto FONE" & "'", New SqlConnection(cnnString))
            cmd.Connection.Open()
        ...
        adapterC = New SqlClient.SqlDataAdapter("SELECT * FROM VW_RPT_K2_Firmas where Formato = " & "'" & "RFC/CURP con Formato Incorrecto FONE" & "' and (Nombre1 <>'' or Puesto1 <> '' or Nombre2 <>'' or Puesto2<>'') Order by Orden", cnnString)
